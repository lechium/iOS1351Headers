...
- (void)dialerField:(id)arg1 senderIdentityWasTapped:(id)arg2;	// IMP=0x0000000100088e34
- (void)dialerField:(id)arg1 stringWasPasted:(id)arg2;	// IMP=0x0000000100088da0
- (void)dialerLCDFieldTextDidChange:(id)arg1;	// IMP=0x0000000100088d2c
- (void)dealloc;	// IMP=0x0000000100088cd0
