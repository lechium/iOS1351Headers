...
- (void).cxx_destruct;	// IMP=0x0000000100044f8c
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x0000000100044f2c
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000100044c50
