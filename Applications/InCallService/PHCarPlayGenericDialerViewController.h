...
- (void).cxx_destruct;	// IMP=0x00000001000a8b84
...
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000a87cc
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000a8460
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000a8110
