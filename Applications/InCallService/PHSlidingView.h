...
- (void).cxx_destruct;	// IMP=0x000000010006dfbc
...
- (void)_powerOff;	// IMP=0x000000010006dcc8
- (void)_animatePowerDown;	// IMP=0x000000010006dbc8
- (void)_updatePowerOffSliderExclusionPath;	// IMP=0x000000010006d9dc
- (void)slidingButton:(id)arg1 didSlideToProportion:(double)arg2;	// IMP=0x000000010006d90c
- (void)didFinishSlideForSlidingButton:(id)arg1;	// IMP=0x000000010006d6d4
- (void)willFinishSlideForSlidingButton:(id)arg1;	// IMP=0x000000010006d6d0
- (void)updateMiddleViewSliderConstraintConstants;	// IMP=0x000000010006d61c
- (double)distanceBetweenMiddleSliders;	// IMP=0x000000010006d3cc
- (void)setUpConstraints;	// IMP=0x000000010006cf6c
- (void)updateAnimatedSliderForCountdownNumber:(unsigned long long)arg1 forTotalCount:(double)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010006ccd0
- (void)updateAnimatedSliderForCountdownNumber:(unsigned long long)arg1 forTotalCount:(unsigned long long)arg2 afterDelay:(double)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010006cafc
- (void)repeatingUpdateAnimatedSliderForCountdownNumber:(unsigned long long)arg1 forModel:(id)arg2;	// IMP=0x000000010006c5d0
- (void)invalidateCountdownAndStopSounds;	// IMP=0x000000010006c458
- (void)interactiveStop;	// IMP=0x000000010006c2b0
- (void)interactiveStartWithCountdownModel:(id)arg1;	// IMP=0x000000010006c23c
- (void)showSlidingViewModel:(id)arg1 animatedSliderCompletion:(CDUnknownBlockType)arg2 medicalIDSliderCompletion:(CDUnknownBlockType)arg3;	// IMP=0x000000010006c154
- (void)layoutSubviews;	// IMP=0x000000010006c0f4
- (void)commonInit;	// IMP=0x000000010006bd4c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010006bcf4
