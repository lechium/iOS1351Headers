...
- (void).cxx_destruct;	// IMP=0x0000000100042f3c
...
- (void)resetView;	// IMP=0x0000000100042e68
- (void)updateConstraints;	// IMP=0x00000001000429b8
- (void)setupViewWithTitle:(id)arg1;	// IMP=0x0000000100042678
- (id)initWithTitle:(id)arg1;	// IMP=0x00000001000425f0
