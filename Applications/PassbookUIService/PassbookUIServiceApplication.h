...
+ (_Bool)shouldBackgroundMainThreadOnSuspendedLaunch;	// IMP=0x0000000100004a10
- (void).cxx_destruct;	// IMP=0x0000000100004a3c
@property(retain, nonatomic) NSNumber *statusBarHeightOverride; // @synthesize statusBarHeightOverride=_statusBarHeightOverride;
- (double)statusBarHeight;	// IMP=0x00000001000049b4
