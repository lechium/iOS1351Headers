...
+ (id)_currentActivationRecordDictionary;	// IMP=0x000000010002e7f0
@property(readonly, nonatomic) _Bool impliesEarlyExit;
@property(readonly, nonatomic) _Bool impliesDemod;
- (id)initWithActivationRecordDictionary:(id)arg1;	// IMP=0x000000010002e874
- (id)init;	// IMP=0x000000010002e814
