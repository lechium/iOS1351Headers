...
- (void).cxx_destruct;	// IMP=0x00000001000e7f70
...
- (void)connectionTerminated;	// IMP=0x00000001000e7ce4
- (void)receivedBackupAction:(id)arg1;	// IMP=0x00000001000e77d8
- (void)reset;	// IMP=0x00000001000e7710
- (void)retryBackup;	// IMP=0x00000001000e7638
- (void)startBackupDevice:(id)arg1 UUID:(id)arg2;	// IMP=0x00000001000e7338
- (void)dealloc;	// IMP=0x00000001000e72c8
- (id)initWithProximitySetupController:(id)arg1;	// IMP=0x00000001000e7218
