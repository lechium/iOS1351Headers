...
+ (id)cloudConfigSkipKey;	// IMP=0x00000001000e6da4
- (void).cxx_destruct;	// IMP=0x00000001000e7208
@property(nonatomic) __weak id <BFFFlowItemDelegate> delegate; // @synthesize delegate=_delegate;
- (void)performExtendedInitializationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000e6dac
