...
- (void).cxx_destruct;	// IMP=0x00000001000b76e8
...
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x00000001000b7600
- (void)layoutSubviews;	// IMP=0x00000001000b751c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b73ac
