...
+ (_Bool)controllerNeedsToRun;	// IMP=0x000000010008862c
+ (id)cloudConfigSkipKey;	// IMP=0x000000010008861c
- (void).cxx_destruct;	// IMP=0x0000000100089430
...
- (void)setupSkipped;	// IMP=0x000000010008923c
- (void)continueSetup;	// IMP=0x000000010008922c
- (void)controllerWasPopped;	// IMP=0x00000001000891a8
- (void)setScreenTimeEnabled:(_Bool)arg1;	// IMP=0x0000000100088c1c
- (id)viewController;	// IMP=0x0000000100088c10
- (void)performExtendedInitializationWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x0000000100088724
