...
- (void).cxx_destruct;	// IMP=0x0000000100057fa4
...
- (void)runConfirmationIfNeeded;	// IMP=0x0000000100057de8
- (void)setConfirmationAlert:(id)arg1 condition:(CDUnknownBlockType)arg2;	// IMP=0x0000000100057d88
- (id)confirmationCancelActionWithTitle:(id)arg1 style:(long long)arg2 action:(CDUnknownBlockType)arg3;	// IMP=0x0000000100057be4
- (id)confirmationAcceptActionWithTitle:(id)arg1 style:(long long)arg2 action:(CDUnknownBlockType)arg3;	// IMP=0x0000000100057a00
- (id)initWithChoiceID:(id)arg1 title:(id)arg2 nextItemClass:(Class)arg3;	// IMP=0x0000000100057940
