...
- (void).cxx_destruct;	// IMP=0x00000001000629a0
...
- (void)_cancelButtonTapped:(id)arg1;	// IMP=0x00000001000621bc
- (void)_startStopButtonTapped:(id)arg1;	// IMP=0x0000000100062074
- (void)handleContentSizeChange;	// IMP=0x0000000100061fb8
- (id)initWithTarget:(id)arg1;	// IMP=0x0000000100061e44
