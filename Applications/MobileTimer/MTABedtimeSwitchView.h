...
+ (double)switchViewHeight;	// IMP=0x000000010005328c
- (void).cxx_destruct;	// IMP=0x00000001000537d4
...
- (void)updateRepeatLabelForSchedule:(unsigned long long)arg1;	// IMP=0x000000010005357c
@property(nonatomic, getter=isOn) _Bool on;
- (void)switchToggled:(id)arg1;	// IMP=0x0000000100053360
- (void)updateConstraints;	// IMP=0x000000010005301c
- (double)repeatLabelBottomPadding;	// IMP=0x0000000100052fb0
- (double)repeatLabelBaselineTopOffset;	// IMP=0x0000000100052f44
- (double)enableLabelBaselineTopOffset;	// IMP=0x0000000100052ed8
- (void)setupConstraints;	// IMP=0x00000001000521dc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100051ac8
