...
- (void).cxx_destruct;	// IMP=0x0000000100008240
@property(nonatomic) __weak id <TSSIMUnlockListFooterViewDelegate> delegate; // @synthesize delegate=_delegate;
@property(nonatomic) long long mode; // @synthesize mode=_mode;
- (void)_continueButtonPressed:(id)arg1;	// IMP=0x00000001000081b8
- (void)layoutSubviews;	// IMP=0x0000000100007bb8
- (id)initWithDelegate:(id)arg1;	// IMP=0x0000000100007b48
