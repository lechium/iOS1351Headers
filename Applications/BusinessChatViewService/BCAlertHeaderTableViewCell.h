...
+ (double)heightForActionItem:(id)arg1 forWidth:(double)arg2;	// IMP=0x0000000100004fd0
+ (id)reuseIdentifier;	// IMP=0x0000000100004fc4
- (void).cxx_destruct;	// IMP=0x00000001000065c8
...
- (void)loadContentView;	// IMP=0x00000001000051dc
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000100004f48
