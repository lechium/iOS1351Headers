...
+ (id)_exportedInterface;	// IMP=0x000000010000dcb8
+ (id)_remoteViewControllerInterface;	// IMP=0x000000010000dc6c
- (void).cxx_destruct;	// IMP=0x000000010000f098
...
- (_Bool)isAllDayDueDate;	// IMP=0x000000010000efe0
...
- (void)setTitle:(id)arg1;	// IMP=0x000000010000ed78
- (void)reminderCreationViewController:(id)arg1 didCreateReminder:(_Bool)arg2 error:(id)arg3;	// IMP=0x000000010000ec68
- (void)setCancellable:(_Bool)arg1;	// IMP=0x000000010000ebfc
- (void)adaptForPresentationInPopover:(_Bool)arg1;	// IMP=0x000000010000ebe4
- (void)prepareForAction:(id)arg1;	// IMP=0x000000010000dd04
