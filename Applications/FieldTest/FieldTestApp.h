...
- (void)navigationController:(id)arg1 willShowViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x0000000100003a54
- (void)updateViewControllerFromModel;	// IMP=0x0000000100003874
- (void)updateStatusForViewController:(id)arg1;	// IMP=0x00000001000037f8
- (void)closeSaveView;	// IMP=0x00000001000037b0
- (void)showSaveView;	// IMP=0x0000000100003710
- (void)applicationWillTerminate;	// IMP=0x0000000100003660
- (void)applicationDidFinishLaunching:(id)arg1;	// IMP=0x0000000100003438
- (void)getSaveButtonPref;	// IMP=0x00000001000033e4
- (void)_setGSMRSSI:(struct __CFBoolean *)arg1;	// IMP=0x000000010000339c
