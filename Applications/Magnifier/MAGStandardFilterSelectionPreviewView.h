...
- (void).cxx_destruct;	// IMP=0x000000010000ab58
...
- (id)currentFilterSetForUnitTesting;	// IMP=0x000000010000a9a0
- (void)scrollViewWillEndDragging:(id)arg1 withVelocity:(struct CGPoint)arg2 targetContentOffset:(inout struct CGPoint *)arg3;	// IMP=0x000000010000a94c
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x000000010000a7e8
- (void)scrollViewWillBeginDragging:(id)arg1;	// IMP=0x000000010000a750
- (void)sizeTransitionDidEnd;	// IMP=0x000000010000a520
- (void)sizeTransitionWillBeginToSize:(struct CGSize)arg1;	// IMP=0x000000010000a27c
- (void)informDelegateOfScrollWithEndingContentOffset:(struct CGPoint)arg1;	// IMP=0x000000010000a1e8
- (id)bestFilterSetForContentOffset:(struct CGPoint)arg1;	// IMP=0x0000000100009f14
- (void)centerFilterSet:(id)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100009df0
- (void)layoutSubviews;	// IMP=0x0000000100009b18
- (struct CGSize)scrollViewContentSize;	// IMP=0x0000000100009a80
- (void)positionBackdrops;	// IMP=0x000000010000916c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000088f4
