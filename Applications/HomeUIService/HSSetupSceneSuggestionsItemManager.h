...
- (id)_buildSectionsWithDisplayedItems:(id)arg1;	// IMP=0x000000010002c12c
- (id)_buildItemProvidersForHome:(id)arg1;	// IMP=0x000000010002be78
- (id)initWithDelegate:(id)arg1 serviceLikeItem:(id)arg2;	// IMP=0x000000010002bdd4
