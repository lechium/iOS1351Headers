...
- (void).cxx_destruct;	// IMP=0x00000001000470ac
...
- (void)_learnMorePressed:(id)arg1;	// IMP=0x0000000100046fc8
- (void)_continuePressed:(id)arg1;	// IMP=0x0000000100046ef8
- (void)viewDidLoad;	// IMP=0x0000000100046e90
@property(readonly, nonatomic) unsigned long long popupType;
@property(readonly, nonatomic) long long setupState;
- (id)initWithTitle:(id)arg1 detailText:(id)arg2 icon:(id)arg3 contentImage:(id)arg4;	// IMP=0x0000000100046d70
- (id)initWithSetupAccessoryDescription:(id)arg1;	// IMP=0x0000000100046d5c
- (id)initWithPopupDelegate:(id)arg1 setupAccessoryDescription:(id)arg2;	// IMP=0x00000001000469a0
