...
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x00000001000459ec
- (void).cxx_destruct;	// IMP=0x0000000100046894
...
- (void)_updateShowIdentifyButtonState;	// IMP=0x000000010004665c
- (void)updateConstraints;	// IMP=0x00000001000465ec
- (void)_createConstraintSet;	// IMP=0x0000000100045f2c
- (void)updateUIWithAnimation:(_Bool)arg1;	// IMP=0x0000000100045e64
- (void)identifyAccessory:(id)arg1;	// IMP=0x0000000100045dc0
- (id)initWithItem:(id)arg1;	// IMP=0x00000001000459f4
