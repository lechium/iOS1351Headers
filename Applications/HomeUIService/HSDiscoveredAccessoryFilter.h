...
- (void).cxx_destruct;	// IMP=0x000000010002aa78
...
- (void)_computeBlacklistedAccessoryCategories;	// IMP=0x000000010002a7cc
- (void)_computeWhitelistedAccessoryCategories;	// IMP=0x000000010002a6b0
- (_Bool)shouldShowAccessory:(id)arg1;	// IMP=0x000000010002a438
- (id)initWithEntitlementContext:(id)arg1;	// IMP=0x000000010002a294
