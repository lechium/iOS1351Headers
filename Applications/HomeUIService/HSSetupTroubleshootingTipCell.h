...
+ (_Bool)requiresConstraintBasedLayout;	// IMP=0x0000000100014ec4
- (void).cxx_destruct;	// IMP=0x0000000100015f6c
...
- (_Bool)textView:(id)arg1 shouldInteractWithURL:(id)arg2 inRange:(struct _NSRange)arg3 interaction:(long long)arg4;	// IMP=0x0000000100015db4
@property(retain, nonatomic) NSAttributedString *attributedBodyString;
@property(retain, nonatomic) NSString *titleString;
- (void)updateConstraints;	// IMP=0x0000000100015ac0
- (void)prepareForReuse;	// IMP=0x0000000100015a6c
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000100014ecc
