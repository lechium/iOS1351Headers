...
- (void).cxx_destruct;	// IMP=0x00000001000456a4
...
- (void)_learnMorePressed:(id)arg1;	// IMP=0x00000001000455c0
- (void)_cancelPressed:(id)arg1;	// IMP=0x00000001000454f0
- (void)_continuePressed:(id)arg1;	// IMP=0x0000000100045420
- (void)viewDidLoad;	// IMP=0x00000001000453b8
@property(readonly, nonatomic) unsigned long long popupType;
@property(readonly, nonatomic) long long setupState;
- (id)initWithTitle:(id)arg1 detailText:(id)arg2 icon:(id)arg3 item:(id)arg4;	// IMP=0x0000000100045298
- (id)initWithSetupAccessoryDescription:(id)arg1;	// IMP=0x0000000100045284
- (id)initWithPopupDelegate:(id)arg1 setupAccessoryDescription:(id)arg2;	// IMP=0x0000000100044da0
