...
- (void)dealloc;	// IMP=0x0000000100008bb4
- (void)applicationWillTerminate:(id)arg1;	// IMP=0x0000000100008b18
- (void)remoteAlertHandleDidDeactivate:(id)arg1;	// IMP=0x0000000100008a9c
- (_Bool)canShowAlerts;	// IMP=0x0000000100008a94
- (void)applicationDidFinishLaunching:(id)arg1;	// IMP=0x0000000100008958
