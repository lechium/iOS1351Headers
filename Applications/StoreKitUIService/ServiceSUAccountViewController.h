...
- (void).cxx_destruct;	// IMP=0x000000010000b00c
@property(nonatomic) __weak id <ServiceAccountPageEmbeddedParent> embeddedParent; // @synthesize embeddedParent=_embeddedParent;
- (void)storePage:(id)arg1 finishedWithSuccess:(_Bool)arg2;	// IMP=0x000000010000afc0
- (void)dismissViewControllerAnimated:(_Bool)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000af24
- (void)dismissAnimated:(_Bool)arg1;	// IMP=0x000000010000aea8
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010000adf0
