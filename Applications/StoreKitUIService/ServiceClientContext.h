...
- (void).cxx_destruct;	// IMP=0x000000010000addc
...
- (void)getDefaultMetricsControllerWithCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010000ac98
- (id)initWithConfigurationDictionary:(id)arg1;	// IMP=0x000000010000abd4
