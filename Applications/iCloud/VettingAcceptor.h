...
- (void).cxx_destruct;	// IMP=0x00000001000192d0
...
- (void)dealloc;	// IMP=0x0000000100019244
- (void)completeVettingWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018b60
- (void)retrievingDialogCancelled;	// IMP=0x0000000100018b04
- (_Bool)retrievingDialogShouldDisplay;	// IMP=0x0000000100018afc
- (id)initWithCloudKitURL:(id)arg1;	// IMP=0x0000000100018a20
