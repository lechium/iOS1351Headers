...
- (void).cxx_destruct;	// IMP=0x0000000100011348
@property(nonatomic) __weak id <DataActivationNoticeViewControllerDelegate> delegate; // @synthesize delegate=_delegate;
- (void)_donePressed;	// IMP=0x00000001000112d0
- (void)viewDidLoad;	// IMP=0x0000000100010cd4
- (id)initWithTitle:(id)arg1 subtitle:(id)arg2 buttonTitle:(id)arg3;	// IMP=0x0000000100010910
