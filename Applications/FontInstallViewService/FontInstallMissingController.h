...
- (void).cxx_destruct;	// IMP=0x0000000100007b14
...
- (void)doneWithMissingFonts:(id)arg1 withDismissAnimated:(_Bool)arg2;	// IMP=0x000000010000788c
- (void)prepareForActivationWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100007700
- (void)configureControllersForInput;	// IMP=0x0000000100006bbc
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001000069d4
- (void)connectToEndpoint:(id)arg1;	// IMP=0x00000001000067d4
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100006740
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000066b4
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000010000603c
