...
- (id)tableView:(id)arg1 cellForRowAtIndexPath:(id)arg2;	// IMP=0x0000000100005cdc
- (long long)tableView:(id)arg1 numberOfRowsInSection:(long long)arg2;	// IMP=0x0000000100005c6c
- (long long)numberOfSectionsInTableView:(id)arg1;	// IMP=0x0000000100005c64
- (void)dontDelete:(id)arg1;	// IMP=0x0000000100005c24
- (void)doDelete:(id)arg1;	// IMP=0x0000000100005be4
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x0000000100005bb0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100005654
- (void)viewDidLoad;	// IMP=0x0000000100005620
