...
- (void).cxx_destruct;	// IMP=0x000000010007e4a0
@property(copy, nonatomic) NSString *responseText; // @synthesize responseText=_responseText;
- (void)updateConstraints;	// IMP=0x000000010007e238
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x000000010007e1bc
- (_Bool)pointInside:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x000000010007e188
- (struct UIEdgeInsets)edgeInsets;	// IMP=0x000000010007e158
- (id)initWithTitle:(id)arg1;	// IMP=0x000000010007df9c
