...
+ (id)sirilandView;	// IMP=0x000000010007bf34
- (void).cxx_destruct;	// IMP=0x000000010007c65c
...
- (void)statusBarFrameDidChange;	// IMP=0x000000010007c4ec
- (_Bool)_keylineIsVisible;	// IMP=0x000000010007c4b4
- (void)layoutSubviews;	// IMP=0x000000010007c19c
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010007bf48
