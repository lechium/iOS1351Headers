...
- (void).cxx_destruct;	// IMP=0x000000010008938c
...
- (void)incrementNumberOfUnsuccessfullyCompletedActions;	// IMP=0x00000001000892d0
- (void)incrementNumberOfSuccessfullyCompletedActions;	// IMP=0x0000000100088e14
- (void)incrementNumberOfStoppedActions;	// IMP=0x0000000100088ddc
- (void)incrementNumberOfStartedActions;	// IMP=0x0000000100088da4
- (id)initWithAceCommand:(id)arg1 andCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100088c7c
