...
+ (id)configuration;	// IMP=0x000000010007e5e8
+ (id)new;	// IMP=0x000000010007e5e0
- (void).cxx_destruct;	// IMP=0x000000010007e754
...
- (id)identifierForService:(long long)arg1;	// IMP=0x000000010007e6a8
- (id)domainForService:(long long)arg1;	// IMP=0x000000010007e660
- (id)init;	// IMP=0x000000010007e5c8
- (id)_init;	// IMP=0x000000010007e508
