...
- (void)speechSynthesizer:(id)arg1 didFinishSynthesisRequest:(id)arg2 withInstrumentMetrics:(id)arg3 error:(id)arg4;	// IMP=0x000000010007db6c
- (_Bool)handlePreSynthesisCommandWithError:(id *)arg1;	// IMP=0x000000010007d11c
- (id)init;	// IMP=0x000000010007c6d4
