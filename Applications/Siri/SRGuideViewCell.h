...
+ (_Bool)chevronBlendEffectEnabled;	// IMP=0x0000000100034f04
+ (struct UIEdgeInsets)defaultInsets;	// IMP=0x0000000100034ea8
+ (double)heightOfCellWithName:(id)arg1 tagPhrase:(id)arg2 width:(double)arg3;	// IMP=0x0000000100034b18
+ (_Bool)placesImageAboveText;	// IMP=0x00000001000343bc
+ (_Bool)_allowsTextToWrap;	// IMP=0x0000000100034348
+ (id)_tagPhraseLabelFont;	// IMP=0x0000000100034334
+ (id)_nameLabelFont;	// IMP=0x0000000100034320
- (void).cxx_destruct;	// IMP=0x0000000100034fe4
...
- (void)updateConstraints;	// IMP=0x0000000100034430
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100033fb4
