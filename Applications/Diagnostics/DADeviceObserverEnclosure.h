...
- (void).cxx_destruct;	// IMP=0x00000001000191d8
...
- (void)oneshotWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100018f90
- (void)end;	// IMP=0x0000000100018ed0
- (void)begin;	// IMP=0x0000000100018c6c
- (id)initWithObserver:(id)arg1 delegate:(id)arg2;	// IMP=0x0000000100018ba4
