...
+ (id)queueEntryWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000027e4
- (void).cxx_destruct;	// IMP=0x0000000100002b38
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100002aa4
- (_Bool)isEqualToTestQueueEntry:(id)arg1;	// IMP=0x00000001000029bc
- (unsigned long long)hash;	// IMP=0x0000000100002948
- (id)initWithAttributes:(id)arg1 parameters:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100002874
