...
+ (id)sharedInstance;	// IMP=0x00000001000081b0
- (void).cxx_destruct;	// IMP=0x0000000100008970
...
- (void)operationFailed:(id)arg1;	// IMP=0x0000000100008888
- (void)operationCompleted;	// IMP=0x000000010000880c
- (void)didReceiveProgress:(long long)arg1;	// IMP=0x000000010000870c
- (void)didReceiveError:(id)arg1;	// IMP=0x0000000100008668
- (id)errorMessageFromErrors;	// IMP=0x0000000100008334
- (id)init;	// IMP=0x000000010000821c
