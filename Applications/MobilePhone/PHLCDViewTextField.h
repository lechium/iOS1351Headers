...
- (void).cxx_destruct;	// IMP=0x00000001000b7cdc
...
- (void)_textFieldDidUpdate:(id)arg1;	// IMP=0x00000001000b7af8
- (_Bool)canPerformAction:(SEL)arg1 withSender:(id)arg2;	// IMP=0x00000001000b7a9c
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x00000001000b79dc
- (void)deleteBackward;	// IMP=0x00000001000b775c
- (void)replaceRange:(id)arg1 withText:(id)arg2;	// IMP=0x00000001000b76e4
- (void)setText:(id)arg1;	// IMP=0x00000001000b7694
- (void)reformatText;	// IMP=0x00000001000b7444
- (void)dealloc;	// IMP=0x00000001000b73cc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000b7254
