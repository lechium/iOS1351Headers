...
- (void).cxx_destruct;	// IMP=0x00000001000a91f0
...
- (id)preferredFocusEnvironments;	// IMP=0x00000001000a9078
- (void)navigationController:(id)arg1 willShowViewController:(id)arg2 animated:(_Bool)arg3;	// IMP=0x00000001000a8f28
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000a8eb0
- (void)loadView;	// IMP=0x00000001000a89e8
- (id)initWithNibName:(id)arg1 bundle:(id)arg2;	// IMP=0x00000001000a8978
