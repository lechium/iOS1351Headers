...
+ (_Bool)isGeminiCapable;	// IMP=0x00000001000a7ca0
+ (id)currentDevice;	// IMP=0x00000001000a7c34
- (void).cxx_destruct;	// IMP=0x00000001000a8948
...
- (void)airplaneModeChanged;	// IMP=0x00000001000a88d0
- (unsigned long long)stateForNotifyToken:(int)arg1;	// IMP=0x00000001000a8894
- (void)unregisterForRingerStateNotifications;	// IMP=0x00000001000a8834
- (void)registerForRingerStateNotifications;	// IMP=0x00000001000a86d8
- (_Bool)fetchRingerSwitchEnabled;	// IMP=0x00000001000a8694
- (_Bool)fetchCellularRadioEnabled;	// IMP=0x00000001000a8670
...
- (void)dealloc;	// IMP=0x00000001000a7f6c
- (id)init;	// IMP=0x00000001000a7db4
