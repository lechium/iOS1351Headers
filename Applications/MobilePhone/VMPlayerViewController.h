...
- (void).cxx_destruct;	// IMP=0x00000001000ca1c0
...
- (void)playerControllerDidReset:(id)arg1;	// IMP=0x00000001000ca188
- (void)viewWillDisappear:(_Bool)arg1;	// IMP=0x00000001000ca0a0
- (void)viewDidLoad;	// IMP=0x00000001000c9ee4
