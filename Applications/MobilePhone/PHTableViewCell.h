...
+ (struct UIEdgeInsets)separatorInsetForContentSizeCategory:(id)arg1;	// IMP=0x000000010002756c
+ (double)titleLabelLeadingAnchorLayoutConstraintConstantForContentCategorySize:(id)arg1;	// IMP=0x00000001000273a0
+ (id)reuseIdentifier;	// IMP=0x0000000100027334
- (void).cxx_destruct;	// IMP=0x000000010002811c
...
- (void)layoutSubviews;	// IMP=0x0000000100027d70
- (struct CGSize)sizeThatFits:(struct CGSize)arg1;	// IMP=0x0000000100027cac
- (void)updateFontsAndLayoutMetrics;	// IMP=0x00000001000279cc
- (id)loadRootViewAndContentViews;	// IMP=0x00000001000278f0
- (void)commonInit;	// IMP=0x0000000100027870
- (id)initWithStyle:(long long)arg1 reuseIdentifier:(id)arg2;	// IMP=0x0000000100027818
- (void)setForegroundView:(id)arg1;	// IMP=0x0000000100027798
@property(readonly, nonatomic) UIView *foregroundView;
@property(copy, nonatomic) UIColor *foregroundColor;
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x0000000100027480
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100027448
- (void)updateFontsLayoutMetricsAndSeparatorInset;	// IMP=0x00000001000273a8
