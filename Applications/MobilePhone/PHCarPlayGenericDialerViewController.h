...
- (void).cxx_destruct;	// IMP=0x00000001000743b8
...
- (void)pressesCancelled:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100074000
- (void)pressesEnded:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100073c94
- (void)pressesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x0000000100073944
