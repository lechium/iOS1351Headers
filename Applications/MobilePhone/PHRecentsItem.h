...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000722d4
- (void).cxx_destruct;	// IMP=0x000000010007287c
...
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000727b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007277c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000724b0
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000722dc
- (id)initWithItem:(id)arg1;	// IMP=0x0000000100072110
