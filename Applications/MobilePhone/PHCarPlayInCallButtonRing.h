...
- (void).cxx_destruct;	// IMP=0x00000001000ab974
...
- (struct CGSize)intrinsicContentSize;	// IMP=0x00000001000ab914
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x00000001000ab638
