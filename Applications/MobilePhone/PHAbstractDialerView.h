...
- (void).cxx_destruct;	// IMP=0x000000010007055c
...
- (void)dialerField:(id)arg1 senderIdentityWasTapped:(id)arg2;	// IMP=0x0000000100070498
- (void)dialerField:(id)arg1 stringWasPasted:(id)arg2;	// IMP=0x0000000100070404
- (void)dialerLCDFieldTextDidChange:(id)arg1;	// IMP=0x0000000100070390
- (void)dealloc;	// IMP=0x0000000100070334
