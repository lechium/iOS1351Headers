...
+ (_Bool)shouldUseSearchFoundation;	// IMP=0x0000000100063dd4
+ (id)sharedSession;	// IMP=0x0000000100063ce4
- (void)session:(id)arg1 bag:(id)arg2 didLoadWithError:(id)arg3;	// IMP=0x0000000100063ddc
