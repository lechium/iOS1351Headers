...
- (void).cxx_destruct;	// IMP=0x000000010008cdf0
...
- (double)framesPerSecond;	// IMP=0x000000010008cc38
- (double)renderDuration;	// IMP=0x000000010008cc18
- (void)finishRenderTime:(id)arg1;	// IMP=0x000000010008cc0c
- (void)startRenderTime:(id)arg1;	// IMP=0x000000010008cbc4
- (void)finishRenderFps:(id)arg1;	// IMP=0x000000010008cb8c
- (void)startRenderFps:(id)arg1;	// IMP=0x000000010008cb38
- (void)setTimer:(id)arg1;	// IMP=0x000000010008caf4
- (id)timer;	// IMP=0x000000010008caec
- (id)statusString;	// IMP=0x000000010008ca6c
- (int)status;	// IMP=0x000000010008ca64
- (void)setStatus:(int)arg1;	// IMP=0x000000010008ca5c
- (id)description;	// IMP=0x000000010008c828
- (void)dealloc;	// IMP=0x0000000100009a00
- (id)initWithURL:(id)arg1 withProcessSwap:(_Bool)arg2;	// IMP=0x000000010008c7a4
