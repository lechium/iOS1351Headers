...
- (void).cxx_destruct;	// IMP=0x000000010016171c
@property(readonly, nonatomic) struct CGRect contentFrame; // @synthesize contentFrame=_contentFrame;
@property(readonly, nonatomic) WKWebView *webView; // @synthesize webView=_webView;
- (void)prepareForSnapshotOfSize:(struct CGSize)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x00000001001614f0
- (struct CGRect)snapshotContentRectInBounds:(struct CGRect)arg1;	// IMP=0x0000000100161434
...
- (id)initWithWebView:(id)arg1 contentFrame:(struct CGRect)arg2;	// IMP=0x00000001001612c8
