...
- (void).cxx_destruct;	// IMP=0x00000001000128fc
...
- (void)removeAllSnapshotLayerAnimations;	// IMP=0x00000001000126b0
- (void)updateSnapshot;	// IMP=0x0000000100012664
- (void)pulseDimmingView;	// IMP=0x0000000100012464
- (void)setDimmingAlpha:(double)arg1 animated:(_Bool)arg2;	// IMP=0x0000000100012374
@property(readonly, nonatomic) struct CGRect bounds;
- (void)_removeBorrowedContentView;	// IMP=0x000000010001213c
- (void)_insertBorrowedContentView;	// IMP=0x0000000100012120
- (void)updateItemView;	// IMP=0x0000000100011ea0
- (void)_updateSnapshotImage;	// IMP=0x0000000100011df0
- (void)_clearViewsIfNeeded;	// IMP=0x0000000100011db8
- (void)_clearViews;	// IMP=0x0000000100011cc8
- (void)_ensureViews;	// IMP=0x0000000100011ad8
- (void)dealloc;	// IMP=0x0000000100011a8c
- (id)initWithTabOverview:(id)arg1 item:(id)arg2;	// IMP=0x00000001000119e4
- (id)init;	// IMP=0x00000001000119cc
