...
- (void).cxx_destruct;	// IMP=0x0000000100139c90
...
- (id)_sourceInfo;	// IMP=0x0000000100139a20
- (id)initWithBrowserController:(id)arg1 barItem:(long long)arg2;	// IMP=0x0000000100139990
