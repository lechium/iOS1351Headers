...
+ (void)addSpringLoadedInteractionToTabView:(id)arg1;	// IMP=0x00000001001638ec
- (void).cxx_destruct;	// IMP=0x0000000100163c98
- (void)interaction:(id)arg1 didChangeWithContext:(id)arg2;	// IMP=0x0000000100163ba4
- (void)interactionDidFinish:(id)arg1;	// IMP=0x0000000100163b94
- (_Bool)shouldAllowInteraction:(id)arg1 withContext:(id)arg2;	// IMP=0x0000000100163a58
- (id)init;	// IMP=0x0000000100163854
