...
- (void).cxx_destruct;	// IMP=0x00000001000847f0
...
- (void)_updateWallpaperInset;	// IMP=0x0000000100084698
- (void)_setWallpaperImage:(id)arg1;	// IMP=0x00000001000845ac
- (void)_updateWallpaperImage;	// IMP=0x000000010008429c
- (void)_springBoardWallpaperDidChange:(id)arg1;	// IMP=0x0000000100084290
- (void)viewDidLayoutSubviews;	// IMP=0x0000000100083f70
- (void)viewWillLayoutSubviews;	// IMP=0x0000000100083ddc
- (void)viewDidLoad;	// IMP=0x0000000100083b68
