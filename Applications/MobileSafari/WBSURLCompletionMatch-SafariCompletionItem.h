...
- (id)reflectedStringForUserTypedString:(id)arg1;	// IMP=0x0000000100124748
- (void)auditAcceptedCompletionWithRank:(unsigned long long)arg1;	// IMP=0x00000001001246b4
- (double)completionTableViewCellCustomHeightForCompletionList:(id)arg1;	// IMP=0x0000000100124690
- (id)completionTableViewCellForCompletionList:(id)arg1;	// IMP=0x0000000100124600
- (id)completionTableViewCellReuseIdentifier;	// IMP=0x00000001001245f4
- (void)acceptCompletionWithActionHandler:(id)arg1;	// IMP=0x0000000100124560
- (void)configureCompletionTableViewCell:(id)arg1 forCompletionList:(id)arg2;	// IMP=0x0000000100124424
