...
- (void).cxx_destruct;	// IMP=0x000000010016f378
...
- (id)debugDescription;	// IMP=0x000000010016f1f8
- (id)initWithIdentifier:(id)arg1 isGroup:(_Bool)arg2;	// IMP=0x000000010016f134
