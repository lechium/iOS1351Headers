...
- (void).cxx_destruct;	// IMP=0x00000001000aeab4
...
- (void)updateBorrowedContentFrame;	// IMP=0x00000001000ae558
- (struct CGRect)_borrowedContentFrame;	// IMP=0x00000001000ae468
@property(readonly, nonatomic) struct CGRect contentClipperBounds;
- (struct CGRect)clippedContentFrame;	// IMP=0x00000001000ae2cc
- (void)pulseContentShadowView;	// IMP=0x00000001000ae074
- (void)resetToInitialCornerRadius;	// IMP=0x00000001000adf88
- (void)updateSnapshotViewAnimated:(_Bool)arg1 adjustContentsRect:(_Bool)arg2;	// IMP=0x00000001000add8c
- (void)updateSnapshotViewAnimated:(_Bool)arg1;	// IMP=0x00000001000add7c
- (void)_forgetThumbnailView;	// IMP=0x00000001000add6c
- (void)tearDownThumbnailView;	// IMP=0x00000001000adc58
- (void)setUpThumbnailView;	// IMP=0x00000001000ad874
@property(readonly, nonatomic) struct CGRect snapshotViewContentsRect;
- (struct CGSize)_sizeForSnapshot:(id)arg1;	// IMP=0x00000001000ad674
...
- (void)dealloc;	// IMP=0x00000001000ad458
- (id)initWithTiltedTabView:(id)arg1 item:(id)arg2;	// IMP=0x00000001000ad354
