...
- (id)reflectedStringForUserTypedString:(id)arg1;	// IMP=0x0000000100064888
- (void)configureCompletionTableViewCell:(id)arg1 forCompletionList:(id)arg2;	// IMP=0x00000001000647f4
- (id)completionTableViewCellReuseIdentifier;	// IMP=0x00000001000647e8
- (id)completionTableViewCellForCompletionList:(id)arg1;	// IMP=0x0000000100064778
- (void)auditAcceptedCompletionWithRank:(unsigned long long)arg1;	// IMP=0x0000000100064774
- (void)acceptCompletionWithActionHandler:(id)arg1;	// IMP=0x00000001000646dc
