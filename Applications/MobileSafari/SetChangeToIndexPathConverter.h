...
- (void).cxx_destruct;	// IMP=0x0000000100022f38
...
- (void)_addIndexPathsForItems:(id)arg1 inSection:(long long)arg2 toIndexPaths:(id)arg3;	// IMP=0x0000000100022e0c
- (void)addChange:(id)arg1 forSection:(long long)arg2;	// IMP=0x0000000100022ac4
- (id)init;	// IMP=0x00000001000229a4
