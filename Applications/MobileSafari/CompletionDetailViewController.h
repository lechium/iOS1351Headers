...
- (void).cxx_destruct;	// IMP=0x000000010007b53c
...
- (void)_dismissCompletionDetailSheet;	// IMP=0x000000010007b330
- (id)initWithRootViewController:(id)arg1;	// IMP=0x000000010007b248
