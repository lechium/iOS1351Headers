...
- (void).cxx_destruct;	// IMP=0x00000001000921ac
...
- (void)_uninstallToggleButton;	// IMP=0x000000010009206c
- (void)_updateToggleButtonFont;	// IMP=0x0000000100091ee4
- (void)_installToggleButton;	// IMP=0x0000000100091ab8
- (void)_updateToggleButtonTitle;	// IMP=0x00000001000918c8
- (void)_didSelectToggleButton;	// IMP=0x0000000100091738
@property(readonly, nonatomic) double minimumDisplayHeight;
- (void)tintColorDidChange;	// IMP=0x0000000100091510
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100090d18
