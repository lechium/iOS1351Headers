...
- (void).cxx_destruct;	// IMP=0x0000000100166b64
...
- (void)_layOutContentView;	// IMP=0x0000000100166948
- (void)_layOutHeader;	// IMP=0x0000000100166814
- (void)layoutSubviews;	// IMP=0x0000000100166768
- (void)replaceContentViewWithItsSnapshot;	// IMP=0x000000010016666c
@property(readonly, nonatomic) _Bool canShowContentView;
@property(readonly, nonatomic) double rubberBandingHeight;
@property(readonly, nonatomic) double headerHeight;
- (id)initWithContinuousReadingItem:(id)arg1 previewingNextDocument:(_Bool)arg2;	// IMP=0x0000000100165ccc
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100165cb4
