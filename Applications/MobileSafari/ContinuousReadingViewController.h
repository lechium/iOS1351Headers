...
- (void).cxx_destruct;	// IMP=0x0000000100128424
...
- (void)scrollViewDidEndDecelerating:(id)arg1;	// IMP=0x00000001001282d4
- (void)scrollViewWillEndDragging:(id)arg1 withVelocity:(struct CGPoint)arg2 targetContentOffset:(inout struct CGPoint *)arg3;	// IMP=0x0000000100128124
- (void)scrollViewDidScroll:(id)arg1;	// IMP=0x0000000100128044
- (double)_scrollOffsetYForPreviousDocument;	// IMP=0x0000000100127fec
- (double)_scrollOffsetYForNextDocument;	// IMP=0x0000000100127f94
@property(readonly, nonatomic) double scrollOffsetYForCurrentDocument;
- (void)_commitToPreviousContinuousDocument;	// IMP=0x0000000100127edc
- (void)_commitToNextContinuousDocument;	// IMP=0x0000000100127e2c
- (void)_willCommitToContinuousDocumentInPreviewView:(id)arg1;	// IMP=0x0000000100127c74
- (void)updateContinuousPreviewViewSizeAttributes;	// IMP=0x0000000100127958
- (void)innerScrollViewDidScroll:(id)arg1;	// IMP=0x00000001001277f4
- (void)didCreateWebViewForPreviousDocument:(id)arg1;	// IMP=0x0000000100127638
- (void)didCreateWebViewForNextDocument:(id)arg1;	// IMP=0x000000010012747c
...
- (void)loadNextItem;	// IMP=0x0000000100127198
- (void)loadPreviousItem;	// IMP=0x000000010012715c
- (void)updateOuterScrollView;	// IMP=0x0000000100127088
