...
- (void).cxx_destruct;	// IMP=0x000000010007762c
- (void)_readingListContentsDidChange:(id)arg1;	// IMP=0x000000010007761c
- (void)retrieveRecommendationsMatchingTopic:(id)arg1 withCompletionHandler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100076ed8
- (void)dealloc;	// IMP=0x0000000100076e60
- (id)initWithBookmarkProvider:(id)arg1 accessQueue:(id)arg2 imageCache:(id)arg3;	// IMP=0x0000000100076ca4
