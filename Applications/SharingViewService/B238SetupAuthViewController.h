...
- (void)_handlePINEntered:(id)arg1;	// IMP=0x000000010002c718
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x000000010002c444
- (void)handleDismissButton:(id)arg1;	// IMP=0x000000010002c398
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010002c2b8
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010002bf50
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x000000010002bd5c
