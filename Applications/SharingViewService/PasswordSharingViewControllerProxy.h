...
+ (_Bool)_isSecureForRemoteViewService;	// IMP=0x000000010005037c
- (void).cxx_destruct;	// IMP=0x000000010004fca0
...
- (void)handleButtonActions:(id)arg1;	// IMP=0x000000010004fa38
- (void)showAuthUIWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2 animated:(_Bool)arg3;	// IMP=0x000000010004fa18
- (void)_sessionHandleProgress:(unsigned int)arg1 info:(id)arg2;	// IMP=0x000000010004f788
- (void)_sessionStart;	// IMP=0x000000010004f2a0
- (void)_handleDeviceNoLongerNeedsPassword;	// IMP=0x000000010004f1a4
- (void)_deviceLost:(id)arg1;	// IMP=0x000000010004f084
- (void)_deviceFound:(id)arg1;	// IMP=0x000000010004ee58
- (void)_deviceDiscoveryEnsureStarted;	// IMP=0x000000010004ece4
- (void)showDoneUI:(int)arg1;	// IMP=0x000000010004e7e0
- (void)ensureStoppedWithDismiss:(_Bool)arg1 reason:(int)arg2;	// IMP=0x000000010004e4c0
- (void)ensureStoppedWithDismiss:(_Bool)arg1;	// IMP=0x000000010004e4b0
- (void)dismiss:(int)arg1;	// IMP=0x000000010004e214
- (void)invalidateTouchDelayTimer;	// IMP=0x000000010004e0dc
- (void)activateTouchDelayTimer;	// IMP=0x000000010004deb8
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010004dda8
- (void)viewDidAppear:(_Bool)arg1;	// IMP=0x000000010004daf8
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010004d5d4
- (unsigned long long)supportedInterfaceOrientations;	// IMP=0x000000010004d50c
- (void)configureWithContext:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010004cfdc
