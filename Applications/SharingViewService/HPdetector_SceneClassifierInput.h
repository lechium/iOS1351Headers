...
- (void).cxx_destruct;	// IMP=0x0000000100097b74
@property(retain, nonatomic) MLMultiArray *imageDescriptors; // @synthesize imageDescriptors=_imageDescriptors;
- (id)featureValueForName:(id)arg1;	// IMP=0x0000000100097afc
@property(readonly, nonatomic) NSSet *featureNames;
- (id)initWithImageDescriptors:(id)arg1;	// IMP=0x00000001000979f8
