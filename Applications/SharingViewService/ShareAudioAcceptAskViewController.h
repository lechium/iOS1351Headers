...
- (void).cxx_destruct;	// IMP=0x000000010007b0e8
...
- (void)updateProductID:(unsigned int)arg1;	// IMP=0x000000010007ad68
- (void)handleCancelButton:(id)arg1;	// IMP=0x000000010007ac90
- (void)handleJoinButton:(id)arg1;	// IMP=0x000000010007abb8
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x000000010007ab20
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010007a838
- (id)presentationControllerForPresentedViewController:(id)arg1 presentingViewController:(id)arg2 sourceViewController:(id)arg3;	// IMP=0x000000010007a7b0
