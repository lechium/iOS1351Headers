...
- (void).cxx_destruct;	// IMP=0x0000000100052ec0
...
- (void)insertText:(id)arg1;	// IMP=0x0000000100052cc4
- (void)deleteBackward;	// IMP=0x0000000100052c28
- (_Bool)canBecomeFirstResponder;	// IMP=0x0000000100052c20
@property(nonatomic) long long autocorrectionType;
@property(nonatomic) long long autocapitalizationType;
- (void)_updateLabels;	// IMP=0x0000000100052848
- (void)touchesBegan:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001000527c0
