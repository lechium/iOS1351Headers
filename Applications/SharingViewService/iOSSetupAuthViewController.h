...
- (void).cxx_destruct;	// IMP=0x0000000100042270
- (void)showWithFlags:(unsigned int)arg1 throttleSeconds:(int)arg2;	// IMP=0x000000010004205c
- (void)_handlePINEntered:(id)arg1;	// IMP=0x0000000100041f1c
- (void)_handleKeyboardWillShow:(id)arg1;	// IMP=0x0000000100041bf4
- (void)handleDismissButton:(id)arg1;	// IMP=0x0000000100041b40
- (_Bool)_canShowWhileLocked;	// IMP=0x0000000100041b38
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x0000000100041a58
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x000000010004177c
