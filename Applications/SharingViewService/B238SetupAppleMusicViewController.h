...
- (void)cloudServiceSetupViewControllerDidDismiss:(id)arg1;	// IMP=0x0000000100029d5c
- (void)handleDismissButton:(id)arg1;	// IMP=0x0000000100029ccc
- (void)_hideAppleMusicViewController;	// IMP=0x0000000100029c00
- (void)_showAppleMusicViewController;	// IMP=0x0000000100029aa4
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x0000000100029888
