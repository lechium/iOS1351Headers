...
- (void).cxx_destruct;	// IMP=0x0000000100054b24
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100054958
- (unsigned long long)hash;	// IMP=0x0000000100054844
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100054690
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100054518
- (void)copyTo:(id)arg1;	// IMP=0x00000001000543d0
- (void)writeTo:(id)arg1;	// IMP=0x00000001000542a4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100053cdc
- (id)dictionaryRepresentation;	// IMP=0x0000000100053a68
- (id)description;	// IMP=0x00000001000539b4
