...
- (void).cxx_destruct;	// IMP=0x0000000100042b8c
...
- (void)handleDismissButton:(id)arg1;	// IMP=0x0000000100042a6c
- (void)handleContinueButton:(id)arg1;	// IMP=0x0000000100042858
- (void)viewDidDisappear:(_Bool)arg1;	// IMP=0x00000001000427c0
- (void)viewWillAppear:(_Bool)arg1;	// IMP=0x00000001000425e4
