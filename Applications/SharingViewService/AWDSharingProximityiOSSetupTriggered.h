...
- (void).cxx_destruct;	// IMP=0x0000000100086b60
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100086a04
- (unsigned long long)hash;	// IMP=0x0000000100086930
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000867d4
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000866ac
- (void)copyTo:(id)arg1;	// IMP=0x00000001000865b4
- (void)writeTo:(id)arg1;	// IMP=0x00000001000864d0
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100086068
- (id)dictionaryRepresentation;	// IMP=0x0000000100085ea0
- (id)description;	// IMP=0x0000000100085dec
