...
- (void).cxx_destruct;	// IMP=0x0000000100014550
...
- (void)presentViewController:(id)arg1 permittedArrowDirections:(unsigned long long)arg2 animated:(_Bool)arg3;	// IMP=0x0000000100014124
- (id)initWithViewController:(id)arg1;	// IMP=0x00000001000140b8
