...
- (void).cxx_destruct;	// IMP=0x0000000100271b28
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x0000000100271acc
@property(nonatomic, readonly) _TtC8AppStore16DynamicTypeLabel *accessibilityTextLabel;
- (void)moreFrom:(id)arg1;	// IMP=0x0000000100271a20
- (void)traitCollectionDidChange:(id)arg1;	// IMP=0x00000001002719a4
- (struct JUMeasurements)measurementsWithFitting:(struct CGSize)arg1 in:(id)arg2;	// IMP=0x00000001002716d4
- (void)tintColorDidChange;	// IMP=0x00000001002714e0
- (void)layoutSubviews;	// IMP=0x00000001002714b4
@property(nonatomic, retain) UIColor *backgroundColor;
@property(nonatomic) struct CGRect frame;
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100271054
