...
- (void).cxx_destruct;	// IMP=0x0000000100014070
...
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x0000000100013e38
...
- (id)initWithEventDictionary:(id)arg1 termCollater:(id)arg2;	// IMP=0x0000000100013310
