...
@class NSObject, NSCloudKitMirroringRequest, NSMutableArray, NSUUID, NSDate, RTPersistenceMirroringPolicy;
...
@property (nonatomic,retain) NSObject*<OS_os_transaction> mirrorTransaction;                         //@synthesize mirrorTransaction=_mirrorTransaction - In the implementation block
...
-(NSObject*<OS_os_transaction>)mirrorTransaction;
-(void)setMirrorTransaction:(NSObject*<OS_os_transaction>)arg1 ;
@end
