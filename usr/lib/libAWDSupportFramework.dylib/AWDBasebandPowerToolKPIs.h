...
@interface AWDBasebandPowerToolKPIs : PBCodable <NSCopying> {
	...
	SCD_Struct_AW16* _armUtilityPDFs;
	SCD_Struct_AW16* _causeCodeBackgroundActivityARMUtilitys;
	SCD_Struct_AW16* _causeCodeBackgroundActivityDurations;
	SCD_Struct_AW16* _causeCodeCumulativeARMUtilitys;
	SCD_Struct_AW16* _causeCodeCumulativeDurations;
	SCD_Struct_AW16* _causeCodeMarginalCoverageARMUtilitys;
	SCD_Struct_AW16* _causeCodeMarginalCoverageDurations;
	SCD_Struct_AW16* _causeCodeOOSARMUtilitys;
	SCD_Struct_AW16* _causeCodeOOSDurations;
	SCD_Struct_AW16* _causeCodeRACHFailARMUtilitys;
	SCD_Struct_AW16* _causeCodeRACHFailDurations;
	SCD_Struct_AW16* _causeCodeStruckInDCHARMUtilitys;
	SCD_Struct_AW16* _causeCodeStruckInDCHDurations;
	SCD_Struct_AW16* _causeCodeTcXONotShuttingARMUtilitys;
	SCD_Struct_AW16* _causeCodeTcXONotShuttingDurations;
	SCD_Struct_AW16* _causeCodeUnknownARMUtilitys;
	SCD_Struct_AW16* _causeCodeUnknownDurations;
