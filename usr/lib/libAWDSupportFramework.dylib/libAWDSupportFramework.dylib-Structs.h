...
typedef struct {
	unsigned avgCca : 1;
	unsigned avgRssi : 1;
	unsigned avgRxRetry : 1;
	unsigned avgSnr : 1;
	unsigned avgTxAirLatency : 1;
	unsigned avgTxPacketLoss : 1;
	unsigned avgTxRetrans : 1;
	unsigned cntAwdlActive : 1;
	unsigned cntDisBtActLatHi : 1;
	unsigned cntDisBtEv3 : 1;
	unsigned cntRedBtActLatLow : 1;
	unsigned cntRedBtInactLatHi : 1;
	unsigned cntVoBadPeriods : 1;
	unsigned cntVoGoodPeriods : 1;
	unsigned durActiveMs : 1;
	unsigned durSleepMs : 1;
	unsigned durTotalMs : 1;
	unsigned durWcpsDisabled : 1;
	unsigned durWcpsEnabled : 1;
	unsigned durWcpsReduced : 1;
	unsigned endCca : 1;
	unsigned endRssi : 1;
	unsigned endRxRetry : 1;
	unsigned endSnr : 1;
	unsigned endTxAirLatency : 1;
	unsigned endTxPacketLoss : 1;
	unsigned endTxRetrans : 1;
	unsigned timestamp : 1;
} SCD_Struct_AW42;
