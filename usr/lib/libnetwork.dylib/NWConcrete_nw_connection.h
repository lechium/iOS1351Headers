...
@protocol OS_nw_endpoint, OS_nw_parameters, OS_nw_write_request, OS_nw_read_request, OS_nw_endpoint_handler, OS_nw_array, OS_dispatch_queue, OS_dispatch_group, OS_nw_establishment_report;
...
-(id)initWithEndpoint:(id)arg1 parameters:(id)arg2 identifier:(unsigned)arg3 ;
@end
