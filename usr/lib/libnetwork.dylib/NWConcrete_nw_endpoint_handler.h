...
@protocol OS_nw_object, OS_nw_endpoint, OS_nw_parameters, OS_nw_association, OS_nw_path, OS_xpc_object, OS_dispatch_queue, NWConcrete_nw_endpoint_mode_handler, OS_nw_path_evaluator;
...
-(void)dealloc;
-(id)initWithEndpoint:(id)arg1 parameters:(id)arg2 reportCallback:(/*function pointer*/void*)arg3 context:(id)arg4 parent:(id)arg5 identifier:(unsigned)arg6 ;
@end
