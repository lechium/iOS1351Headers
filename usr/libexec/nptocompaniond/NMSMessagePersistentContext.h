...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100009dcc
- (void).cxx_destruct;	// IMP=0x000000010000a244
...
- (id)description;	// IMP=0x000000010000a0ec
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100009fe0
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100009dd4
