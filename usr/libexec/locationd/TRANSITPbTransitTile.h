...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010013f4ac
- (unsigned long long)hash;	// IMP=0x000000010013f318
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013f134
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010013ef70
- (void)copyTo:(id)arg1;	// IMP=0x000000010013ede0
- (void)writeTo:(id)arg1;	// IMP=0x000000010013ec74
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010013ec6c
- (id)dictionaryRepresentation;	// IMP=0x000000010013e2fc
- (id)description;	// IMP=0x000000010013e27c
...
- (void)dealloc;	// IMP=0x000000010013df4c
