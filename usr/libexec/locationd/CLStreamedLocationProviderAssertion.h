...
- (void)releaseAssertion;	// IMP=0x0000000100cbef2c
- (void)takeAssertion;	// IMP=0x0000000100cbee40
- (void)dealloc;	// IMP=0x00000001000eaf20
- (void)invalidate;	// IMP=0x00000001000eaee8
- (id)initInUniverse:(id)arg1;	// IMP=0x00000001000eae54
