...
- (void)disableSource;	// IMP=0x00000001002007cc
- (void)enableSource;	// IMP=0x00000001002007c8
- (void)dealloc;	// IMP=0x0000000100200790
- (id)initWithUniverse:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001002006b4
