...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010019f8bc
- (unsigned long long)hash;	// IMP=0x000000010019f708
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010019f5d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010019f4dc
- (void)copyTo:(id)arg1;	// IMP=0x000000010019f41c
- (void)writeTo:(id)arg1;	// IMP=0x000000010019f320
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010019f318
- (id)dictionaryRepresentation;	// IMP=0x000000010019ec5c
- (id)description;	// IMP=0x000000010019ebdc
