...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001e00b8
...
- (id)description;	// IMP=0x00000001001e0660
- (id)jsonObject;	// IMP=0x00000001001e044c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001001e034c
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001e0220
- (void)dealloc;	// IMP=0x00000001001e01d8
- (id)initWithAccessPoint:(struct AccessPoint)arg1;	// IMP=0x00000001001e00c0
