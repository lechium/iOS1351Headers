...
- (id).cxx_construct;	// IMP=0x00000001003f35d4
...
- (void)dealloc;	// IMP=0x00000001003f3564
- (id)initWithTimestamp:(time_point_406bde99)arg1 RSSI:(int)arg2 uuid:(id)arg3 ipv4:(unsigned int)arg4 channel:(int)arg5;	// IMP=0x00000001003f34d8
- (struct CLATVAirplayDeviceInternal)cppObject;	// IMP=0x00000001003f35dc
