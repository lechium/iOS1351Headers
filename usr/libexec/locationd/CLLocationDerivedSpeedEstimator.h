...
+ (_Bool)isSupported;	// IMP=0x00000001001c0488
- (id).cxx_construct;	// IMP=0x00000001001c4bdc
- (void).cxx_destruct;	// IMP=0x00000001001c4b88
...
- (void)submitLatencyMetrics;	// IMP=0x00000001001c4230
- (void)submitFalseDetectionMetricsWithType:(unsigned long long)arg1;	// IMP=0x00000001001c3f30
- (void)logLatencyMetricsInternal;	// IMP=0x00000001001c3a4c
- (void)clearStatusBarColorAndText;	// IMP=0x00000001001c3964
- (void)setStatusBarWithLabel:(id)arg1;	// IMP=0x00000001001c3498
- (void)updateStatusBarLabel;	// IMP=0x00000001001c32c0
- (void)onMotionStateNotification:(int)arg1 data:(union NotificationData)arg2;	// IMP=0x00000001001c3184
- (void)onWifiServiceNotification:(int)arg1 data:(struct NotificationData)arg2;	// IMP=0x00000001001c2eb0
- (void)handleMotionStateNotification:(union NotificationData *)arg1;	// IMP=0x00000001001c2628
- (void)handleVehicularStateChanged;	// IMP=0x00000001001c2594
- (_Bool)_feedLocation:(id)arg1;	// IMP=0x00000001001c15b0
- (void)_invalidateSpeedEstimate;	// IMP=0x00000001001c1598
- (void)_onScanTimer;	// IMP=0x00000001001c1218
- (_Bool)feedLocation:(const struct CLDaemonLocation *)arg1;	// IMP=0x00000001001c1184
- (void)dealloc;	// IMP=0x00000001001c10dc
- (void)invalidate;	// IMP=0x00000001001c10a8
- (void)unregisterForNotifications;	// IMP=0x00000001001c1010
- (void)updateWsbClient:(_Bool)arg1;	// IMP=0x00000001001c0ff0
- (void)stopWsbClient;	// IMP=0x00000001001c0efc
- (void)startWsbClient;	// IMP=0x00000001001c0dd0
- (void)registerForNotifications;	// IMP=0x00000001001c09a8
- (id)initInUniverse:(id)arg1;	// IMP=0x00000001001c0550
- (id)init;	// IMP=0x00000001001c04b8
