...
- (void)dealloc;	// IMP=0x0000000100627354
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001006271b8
- (id)initWithState:(long long)arg1 confidence:(double)arg2 observationInterval:(id)arg3 additionalInfo:(id)arg4;	// IMP=0x0000000100627108
