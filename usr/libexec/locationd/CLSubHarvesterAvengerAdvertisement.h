...
- (void)dealloc;	// IMP=0x0000000100666898
- (id)initWithAdvertisement:(id)arg1 maxActivityBasedSpeedSinceAdvertisement:(double)arg2 observedDuringAggressiveScan:(_Bool)arg3;	// IMP=0x00000001006667d0
