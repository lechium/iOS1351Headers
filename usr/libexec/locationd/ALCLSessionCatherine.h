...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001002b5f8c
- (unsigned long long)hash;	// IMP=0x00000001002b5a04
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001002b5624
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001002b525c
- (void)copyTo:(id)arg1;	// IMP=0x00000001002b4ed0
- (void)writeTo:(id)arg1;	// IMP=0x00000001002b4b64
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001002b4b5c
- (id)dictionaryRepresentation;	// IMP=0x00000001002b34d0
- (id)description;	// IMP=0x00000001002b3450
...
- (int)StringAsOnsetReason:(id)arg1;	// IMP=0x00000001002b3290
- (id)onsetReasonAsString:(int)arg1;	// IMP=0x00000001002b31fc
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x00000001002b27a8
- (id)activityTypeAsString:(int)arg1;	// IMP=0x00000001002b24d0
