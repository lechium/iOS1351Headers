...
- (void)fire:(double)arg1 withError:(id)arg2;	// IMP=0x000000010083bd14
- (void)invalidate;	// IMP=0x000000010083bca4
- (void)dealloc;	// IMP=0x000000010083bc40
- (id)initWithDistance:(double)arg1 inUniverse:(id)arg2 handler:(CDUnknownBlockType)arg3;	// IMP=0x000000010083bb24
- (id)init;	// IMP=0x000000010083bae8
