...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000f1dd8
- (unsigned long long)hash;	// IMP=0x00000001000f1aa4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000f18cc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000f1764
- (void)copyTo:(id)arg1;	// IMP=0x00000001000f1630
- (void)writeTo:(id)arg1;	// IMP=0x00000001000f149c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000f1494
- (id)dictionaryRepresentation;	// IMP=0x00000001000f09dc
- (id)description;	// IMP=0x00000001000f095c
