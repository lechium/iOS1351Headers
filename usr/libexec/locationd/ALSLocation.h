...
- (unsigned long long)hash;	// IMP=0x000000010077b098
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010077aee0
- (void)copyTo:(id)arg1;	// IMP=0x000000010077acc8
- (void)writeTo:(id)arg1;	// IMP=0x000000010077ab04
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010077aafc
- (id)dictionaryRepresentation;	// IMP=0x0000000100779ffc
- (id)description;	// IMP=0x0000000100779f7c
...
- (void)dealloc;	// IMP=0x0000000100779cfc
