...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010085e7cc
- (unsigned long long)hash;	// IMP=0x000000010085e5b0
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010085e3fc
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010085e290
- (void)copyTo:(id)arg1;	// IMP=0x000000010085e160
- (void)writeTo:(id)arg1;	// IMP=0x000000010085e008
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010085e000
- (id)dictionaryRepresentation;	// IMP=0x000000010085d35c
- (id)description;	// IMP=0x000000010085d2dc
...
- (int)StringAsActivityType:(id)arg1;	// IMP=0x000000010085cd30
- (id)activityTypeAsString:(int)arg1;	// IMP=0x000000010085ca58
