...
- (void).cxx_destruct;	// IMP=0x000000010000c0fc
...
- (id)description;	// IMP=0x000000010000bfec
- (id)dictionaryValue;	// IMP=0x000000010000be2c
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010000bca4
