...
+ (id)startNavigationMessageWithLoadDirectionsMessage:(id)arg1;	// IMP=0x000000010001fd20
- (void).cxx_destruct;	// IMP=0x00000001000203b0
...
- (_Bool)matchesLoadDirectionsMessage:(id)arg1;	// IMP=0x000000010002021c
- (id)description;	// IMP=0x0000000100020168
- (id)dictionaryValue;	// IMP=0x000000010001ff68
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010001fd7c
