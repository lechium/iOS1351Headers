...
- (unsigned int)caps;	// IMP=0x0000000100086d84
- (void)stopEventMonitoring;	// IMP=0x0000000100086ce0
- (void)startEventMonitoring;	// IMP=0x0000000100086a48
- (void)dealloc;	// IMP=0x00000001000869f4
