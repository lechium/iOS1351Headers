...
@class NSArray, NSDictionary, NSString, NSUUID, W5DebugConfiguration, W5Peer, W5PerfConfiguration, W5WiFiChannel, W5XPCConnection;
...
- (void)xpcConnection:(W5XPCConnection *)arg1 runPerformanceTestWithConfiguration:(W5PerfConfiguration *)arg2 uuid:(NSUUID *)arg3 reply:(void (^)(NSError *, W5PerfResult *))arg4;
...
- (void)xpcConnection:(W5XPCConnection *)arg1 stopAdvertisingAndReply:(void (^)(NSError *))arg2;
- (void)xpcConnection:(W5XPCConnection *)arg1 startAdvertisingAndReply:(void (^)(NSError *))arg2;
