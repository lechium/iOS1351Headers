...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010005cda4
- (unsigned long long)hash;	// IMP=0x000000010005cd94
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010005cd2c
- (_Bool)isEqualToLogItemRequestInternal:(id)arg1;	// IMP=0x000000010005ccf0
- (id)description;	// IMP=0x000000010005cab0
- (void)dealloc;	// IMP=0x000000010005ca40
