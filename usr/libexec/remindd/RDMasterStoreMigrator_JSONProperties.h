...
- (id)reminderIDsMergeableOrderingReplicaIDSourceWithAccountID:(id)arg1 listID:(id)arg2;	// IMP=0x00000001000493dc
- (void)migrateCRDTsInList:(id)arg1;	// IMP=0x0000000100048da4
- (void)migrateCRDTsInAccount:(id)arg1;	// IMP=0x0000000100048834
- (void)migrateCRDTsInObject:(id)arg1;	// IMP=0x0000000100048790
- (void)migrateTokenResolutionMapInObject:(id)arg1;	// IMP=0x000000010004869c
- (void)migrateStore:(id)arg1;	// IMP=0x0000000100047f04
- (void)migrateStoreIfNeeded:(id)arg1 metadata:(id)arg2;	// IMP=0x0000000100047e14
