...
- (void).cxx_destruct;	// IMP=0x0000000100078394
...
- (void)setPowerState:(long long)arg1;	// IMP=0x0000000100078020
- (void)stop;	// IMP=0x0000000100077f98
- (_Bool)start;	// IMP=0x0000000100077d38
- (void)setReadyToSleep;	// IMP=0x0000000100077b44
- (_Bool)sleepPending;	// IMP=0x0000000100077b08
- (id)initWithDelegate:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100077a60
