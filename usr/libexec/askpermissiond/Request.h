...
- (void).cxx_destruct;	// IMP=0x0000000100019994
...
- (id)description;	// IMP=0x00000001000198ec
- (id)compile;	// IMP=0x00000001000195ec
- (id)initWithDictionary:(id)arg1;	// IMP=0x00000001000190fc
- (id)initWithDate:(id)arg1 identifier:(id)arg2 itemIdentifier:(id)arg3 localizations:(id)arg4 mocked:(_Bool)arg5 offerName:(id)arg6 previewURL:(id)arg7 productURL:(id)arg8 status:(long long)arg9;	// IMP=0x0000000100018f7c
