...
- (void).cxx_destruct;	// IMP=0x0000000100019eb8
...
- (id)description;	// IMP=0x0000000100019e38
- (id)compile;	// IMP=0x0000000100019d08
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100019afc
- (id)initWithApprove:(id)arg1 body:(id)arg2 decline:(id)arg3 title:(id)arg4;	// IMP=0x0000000100019a00
