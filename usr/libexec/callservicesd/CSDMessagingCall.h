...
@interface CSDMessagingCall : PBCodable <NSCopying>
{
    ...
    _Bool _protoHasSentInvitation;	// 130 = 0x82
    _Bool _protoNeedsManualInCallSounds;	// 131 = 0x83
    _Bool _protoOutgoing;	// 132 = 0x84
    _Bool _protoSOS;	// 133 = 0x85
    _Bool _protoShouldSuppressRingtone;	// 134 = 0x86
    _Bool _protoSupportsTTYWithVoice;	// 135 = 0x87
    _Bool _protoUplinkMuted;	// 136 = 0x88
    _Bool _protoVideo;	// 137 = 0x89
    _Bool _protoVoicemail;	// 138 = 0x8a
    _Bool _protoWantsHoldMusic;	// 139 = 0x8b
    struct {
...
+ (Class)remoteParticipantHandlesType;	// IMP=0x0000000100079028
- (void).cxx_destruct;	// IMP=0x000000010007cc78
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010007c450
- (unsigned long long)hash;	// IMP=0x000000010007c070
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010007baa8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007b4d0
- (void)copyTo:(id)arg1;	// IMP=0x000000010007affc
- (void)writeTo:(id)arg1;	// IMP=0x000000010007ab38
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010007ab30
- (id)dictionaryRepresentation;	// IMP=0x00000001000791bc
- (id)description;	// IMP=0x0000000100079108
...
- (id)remoteParticipantHandlesAtIndex:(unsigned long long)arg1;	// IMP=0x0000000100079010
- (unsigned long long)remoteParticipantHandlesCount;	// IMP=0x0000000100078ff8
- (void)addRemoteParticipantHandles:(id)arg1;	// IMP=0x0000000100078f84
- (void)clearRemoteParticipantHandles;	// IMP=0x0000000100078f6c
...
- (void)setTuProvider:(id)arg1 isVideo:(_Bool)arg2;	// IMP=0x00000001000be9d0
...
- (_Bool)isEqualToCall:(id)arg1;	// IMP=0x00000001000bdb24
- (void)updateRelayCall:(id)arg1;	// IMP=0x00000001000bd5f4
...
- (void)setService:(int)arg1;	// IMP=0x00000001000bd0ec
- (int)service;	// IMP=0x00000001000bd0e0
@property(nonatomic, getter=isConferenced) _Bool conferenced;
@property(nonatomic) int status;
- (id)initWithCall:(id)arg1;	// IMP=0x00000001000bcb5c
