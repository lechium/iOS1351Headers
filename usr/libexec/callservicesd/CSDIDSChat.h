...
@interface CSDIDSChat : NSObject <CSDIDSDualSessionDelegate, CSDAVConferenceDelegate, CSDIDSChat>
{
...
+ (id)faceTimeAppUUID;	// IMP=0x0000000100044730
- (void).cxx_destruct;	// IMP=0x0000000100049204
...
- (void)conference:(id)arg1 didReceiveData:(id)arg2 forCallID:(long long)arg3;	// IMP=0x0000000100048fd0
- (void)conference:(id)arg1 changedBytesOfDataUsed:(long long)arg2;	// IMP=0x0000000100048f64
- (void)conference:(id)arg1 outputLevelChangedTo:(float)arg2;	// IMP=0x0000000100048ef0
- (void)conference:(id)arg1 inputLevelChangedTo:(float)arg2;	// IMP=0x0000000100048e7c
- (void)conference:(id)arg1 outputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0000000100048dfc
- (void)conference:(id)arg1 inputFrequencyLevelChangedTo:(id)arg2;	// IMP=0x0000000100048d7c
- (void)conference:(id)arg1 remoteMediaStalled:(_Bool)arg2;	// IMP=0x0000000100048ca0
- (void)remoteVideoPausedForConference:(id)arg1;	// IMP=0x0000000100048c34
- (void)receivedFirstRemoteFrameForConference:(id)arg1;	// IMP=0x0000000100048b14
- (void)sendingAudioChangedForConference:(id)arg1;	// IMP=0x0000000100048aa8
- (void)mutedChangedForConference:(id)arg1;	// IMP=0x0000000100048a3c
- (void)conference:(id)arg1 endedWithReason:(long long)arg2 error:(id)arg3;	// IMP=0x000000010004890c
- (void)conferenceStarted:(id)arg1;	// IMP=0x0000000100048680
- (void)conferenceFinishedPreparing:(id)arg1;	// IMP=0x00000001000481fc
- (void)session:(id)arg1 receivedData:(id)arg2;	// IMP=0x0000000100048114
- (void)session:(id)arg1 receivedInvitationCancelWithData:(id)arg2;	// IMP=0x0000000100048030
- (void)session:(id)arg1 receivedInvitationDeclineWithData:(id)arg2;	// IMP=0x0000000100047f4c
- (void)session:(id)arg1 receivedInvitationAcceptWithData:(id)arg2;	// IMP=0x0000000100047734
- (void)session:(id)arg1 endedWithReason:(int)arg2;	// IMP=0x00000001000475fc
- (void)session:(id)arg1 invitationSentToPushTokens:(id)arg2 shouldBreakBeforeMake:(_Bool)arg3;	// IMP=0x00000001000474bc
- (void)sessionStarted:(id)arg1;	// IMP=0x00000001000472f4
- (void)_handlePushTokensInvited:(id)arg1 didSendInvitation:(_Bool)arg2 didCancelInvitation:(_Bool)arg3;	// IMP=0x00000001000471bc
- (void)setRemoteVideoPresentationState:(int)arg1;	// IMP=0x0000000100047168
- (void)setRemoteVideoPresentationSize:(struct CGSize)arg1;	// IMP=0x0000000100047110
- (void)prepareConference;	// IMP=0x0000000100046e48
- (void)startConnectionWithTransport:(id)arg1;	// IMP=0x0000000100046c7c
...
- (void)sendDataUnreliably:(id)arg1;	// IMP=0x00000001000465e0
- (void)cancelInvitationWithDeclinedElsewhere;	// IMP=0x00000001000464d4
- (void)cancelInvitationWithAnsweredElsewhere;	// IMP=0x00000001000463c8
- (void)end;	// IMP=0x00000001000460d4
- (void)cancelOrDeclineInvitation;	// IMP=0x0000000100045f98
- (void)answerWithVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x0000000100045e74
- (void)startWithVideoAspectRatioDescriptor:(id)arg1 inviteCompletion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100045d98
- (int)deviceRole;	// IMP=0x0000000100045d70
- (id)capabilities;	// IMP=0x0000000100045b24
- (void)_setLocalAspectRatiosForVideoAspectRatioDescriptor:(id)arg1;	// IMP=0x00000001000459b8
- (void)_setDateEndedIfNecessary;	// IMP=0x0000000100045728
...
- (id)initOutgoingWithSession:(id)arg1 UUID:(id)arg2 remoteHandle:(id)arg3 wantsVideo:(_Bool)arg4 isRelaying:(_Bool)arg5;	// IMP=0x0000000100044b94
- (id)initIncomingWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3 remoteInviteDictionary:(id)arg4;	// IMP=0x00000001000449e4
- (id)initWithSession:(id)arg1 remoteHandle:(id)arg2 wantsVideo:(_Bool)arg3;	// IMP=0x000000010004484c
