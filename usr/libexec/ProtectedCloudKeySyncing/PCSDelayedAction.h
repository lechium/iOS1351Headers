...
- (void)trigger;	// IMP=0x00000001000197b0
- (void)setHoldTransaction:(_Bool)arg1;	// IMP=0x0000000100019718
- (void)run;	// IMP=0x0000000100019708
- (void)setAction:(CDUnknownBlockType)arg1;	// IMP=0x00000001000196c4
- (id)initWithDelay:(unsigned long long)arg1 operationQueue:(id)arg2;	// IMP=0x00000001000192f0
