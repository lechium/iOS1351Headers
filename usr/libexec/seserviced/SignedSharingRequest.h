...
- (void).cxx_destruct;	// IMP=0x0000000100047bfc
...
- (_Bool)parseSignedRequestFromData:(id)arg1;	// IMP=0x000000010004763c
- (id)createdSignedRequestWithEndpointAuthResponse:(id)arg1 immobilizerTokenSlotId:(id)arg2 mailboxMappingData:(id)arg3;	// IMP=0x00000001000470e4
- (id)init;	// IMP=0x0000000100047030
