...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010001e8d4
- (void).cxx_destruct;	// IMP=0x000000010001e7c8
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010001de48
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010001dd60
