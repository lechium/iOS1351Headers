...
- (void).cxx_destruct;	// IMP=0x000000010004a798
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010004a01c
- (unsigned long long)hash;	// IMP=0x0000000100049a80
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000494e0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100049010
- (void)copyTo:(id)arg1;	// IMP=0x0000000100048bf8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100048830
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100048828
- (id)dictionaryRepresentation;	// IMP=0x000000010004758c
- (id)description;	// IMP=0x00000001000474d8
