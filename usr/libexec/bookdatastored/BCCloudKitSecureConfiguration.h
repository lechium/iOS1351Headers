...
+ (id)configuration;	// IMP=0x0000000100022b48
- (void).cxx_destruct;	// IMP=0x0000000100022dd8
...
- (_Bool)shouldPerformDatabaseSubscriptionForServiceMode:(_Bool)arg1;	// IMP=0x0000000100022d0c
- (_Bool)shouldArchiveData:(id)arg1;	// IMP=0x0000000100022d04
