...
+ (id)transactionNameForEntityName:(id)arg1;	// IMP=0x000000010001d87c
- (void).cxx_destruct;	// IMP=0x000000010001decc
...
- (void)laq_scheduleTransactionLifetime;	// IMP=0x000000010001dc40
- (void)signal;	// IMP=0x000000010001da40
- (void)clientConnected;	// IMP=0x000000010001d920
- (double)transactionLifetimeTimout;	// IMP=0x000000010001d918
- (double)coalescingDelay;	// IMP=0x000000010001d910
- (void)performWorkWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010001d8fc
- (id)transactionName;	// IMP=0x000000010001d890
- (id)initWithEntityName:(id)arg1 delegate:(id)arg2;	// IMP=0x000000010001d444
