...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100021f24
- (void).cxx_destruct;	// IMP=0x0000000100022a44
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100022360
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100021f2c
- (id)configuredRecordFromAttributes;	// IMP=0x0000000100021964
- (id)zoneName;	// IMP=0x0000000100021834
- (id)identifier;	// IMP=0x0000000100021828
- (id)recordType;	// IMP=0x000000010002181c
@property(readonly, copy) NSString *description;
- (id)initWithRecord:(id)arg1;	// IMP=0x0000000100021008
- (id)initWithCloudData:(id)arg1;	// IMP=0x0000000100020b64
- (id)initWithAssetID:(id)arg1;	// IMP=0x0000000100020a98
