...
+ (id)propertyIDKey;	// IMP=0x0000000100020714
@property(readonly, copy) NSString *debugDescription;
@property(readonly, nonatomic) _Bool isAudiobook;
- (id)zoneName;	// IMP=0x0000000100020720
- (id)identifier;	// IMP=0x0000000100020708
- (id)recordType;	// IMP=0x00000001000206fc
- (void)resolveConflictsFromRecord:(id)arg1 withResolvers:(id)arg2;	// IMP=0x000000010001f37c
- (_Bool)isEqualExceptForDate:(id)arg1;	// IMP=0x000000010001e98c
- (_Bool)setDifferentBookmarkTime:(double)arg1;	// IMP=0x000000010001e91c
- (void)_configureFromAssetDetail:(id)arg1 withMergers:(id)arg2;	// IMP=0x000000010001e020
- (void)configureFromCloudData:(id)arg1 withMergers:(id)arg2;	// IMP=0x000000010001df5c
- (id)mutableCopy;	// IMP=0x000000010001df28
