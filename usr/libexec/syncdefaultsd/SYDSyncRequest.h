...
- (void).cxx_destruct;	// IMP=0x0000000100047344
...
- (id)initWithType:(long long)arg1 reason:(int)arg2 apps:(id)arg3 soon:(_Bool)arg4 message:(id)arg5;	// IMP=0x0000000100047228
