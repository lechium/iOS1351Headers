...
- (void).cxx_destruct;	// IMP=0x000000010004ce40
@property(retain, nonatomic) NSDictionary *persistentState; // @synthesize persistentState=_persistentState;
- (id)limitsDescription;	// IMP=0x000000010004c868
- (_Bool)updateWithNewPersistentState:(id)arg1;	// IMP=0x000000010004c7f4
...
- (id)initWithPersistentState:(id)arg1;	// IMP=0x000000010004bbd0
