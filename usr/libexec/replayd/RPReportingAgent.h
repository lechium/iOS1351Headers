...
+ (void)reportSessionEnded:(unsigned short)arg1 endReason:(id)arg2 withServiceName:(id)arg3;	// IMP=0x000000010001940c
...
- (void)reportEventWithType:(unsigned short)arg1 dictionary:(id)arg2;	// IMP=0x000000010001910c
- (id)collectSummaryEventMetrics;	// IMP=0x0000000100018c8c
- (id)initWithServiceName:(id)arg1;	// IMP=0x0000000100018c18
