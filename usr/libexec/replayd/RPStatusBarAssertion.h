...
- (void).cxx_destruct;	// IMP=0x00000001000161f0
...
- (void)statusBarCoordinator:(id)arg1 invalidatedRegistrationWithError:(id)arg2;	// IMP=0x0000000100016078
- (void)updateStatusStringWithTimer:(id)arg1;	// IMP=0x0000000100015f94
- (void)updateDoubleHeightStatusBarWithDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015e94
- (id)rpLocalizedRecordingDuration:(double)arg1 paused:(_Bool)arg2;	// IMP=0x0000000100015d90
- (id)stringWithTimeInterval:(double)arg1;	// IMP=0x0000000100015ca4
- (void)invalidateDoubleHeightStatusBar;	// IMP=0x0000000100015bdc
- (void)startRepeatingTimer;	// IMP=0x0000000100015ae0
- (void)showDoubleHeightStatusBarWithPid:(int)arg1;	// IMP=0x000000010001596c
- (void)acquireAssertionWithPid:(int)arg1;	// IMP=0x0000000100015910
- (void)acquireAssertionWithPidWaitForCompletion:(int)arg1;	// IMP=0x00000001000156b0
