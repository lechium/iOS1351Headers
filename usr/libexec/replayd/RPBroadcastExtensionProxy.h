...
- (void).cxx_destruct;	// IMP=0x000000010000c144
...
- (void)processPayload:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000be74
- (void)finishBroadcastWithError:(id)arg1;	// IMP=0x000000010000bde8
- (void)ping;	// IMP=0x000000010000bd70
- (void)updateBroadcastURL:(id)arg1;	// IMP=0x000000010000bce4
- (void)updateServiceInfo:(id)arg1;	// IMP=0x000000010000bc58
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000bc34
- (void)setupNewConnection:(id)arg1;	// IMP=0x000000010000b954
- (void)invalidateConnection;	// IMP=0x000000010000b824
- (void)establishConnectionWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010000b40c
- (id)initWithBroadcastUploadListenerEndpoint:(id)arg1;	// IMP=0x000000010000b360
- (id)initWithBroadcastUploadExtension:(id)arg1;	// IMP=0x000000010000b24c
