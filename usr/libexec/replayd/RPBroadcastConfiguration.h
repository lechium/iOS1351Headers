...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100021a34
- (void).cxx_destruct;	// IMP=0x0000000100021a60
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010002195c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100021868
