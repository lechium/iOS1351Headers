...
- (void).cxx_destruct;	// IMP=0x00000001002064cc
...
- (void)_updateWithDictionary:(id)arg1;	// IMP=0x00000001002063c8
- (id)description;	// IMP=0x00000001002062a8
- (id)initWithItemID:(id)arg1 bundleID:(id)arg2 clusterVersionID:(id)arg3 dictionary:(id)arg4;	// IMP=0x0000000100206180
