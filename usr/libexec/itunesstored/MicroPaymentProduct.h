...
+ (id)periodFromISO8601String:(id)arg1;	// IMP=0x000000010006640c
...
- (id)copyProduct;	// IMP=0x0000000100066000
- (void)dealloc;	// IMP=0x0000000100065f70
- (id)initWithDictionary:(id)arg1;	// IMP=0x000000010006590c
