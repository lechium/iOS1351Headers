...
+ (unsigned int)mediaTypeForStoreDownload:(id)arg1;	// IMP=0x000000010011c8b4
- (id)_copyChapterVideoTracksForAsset:(id)arg1;	// IMP=0x000000010011e050
@property long long updateType;
- (void)setValue:(id)arg1 forAdditionalEntityProperty:(id)arg2;	// IMP=0x000000010011dee4
...
- (void)loadPropertiesFromMediaPath:(id)arg1 includeTracks:(_Bool)arg2;	// IMP=0x000000010011d540
@property(readonly) _Bool hasItemArtwork;
@property(readonly, getter=isDownloading) _Bool downloading;
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010011c71c
- (void)dealloc;	// IMP=0x000000010011c6a4
- (id)init;	// IMP=0x000000010011c648
