...
- (void)WiFiDeviceManagerHandlePowerUnchangedPowerBudget:(unsigned long long)arg1:(CDStruct_777f7d9a *)arg2;	// IMP=0x000000010008e5cc
- (void)WiFiDeviceManagerHandlePowerBudgetChange:(unsigned long long)arg1;	// IMP=0x000000010008e5c0
- (void)WiFiDeviceManagerHandleInterfaceAvailability:(unsigned long long)arg1;	// IMP=0x000000010008e5b4
- (unsigned long long)WiFiBatteryManagerHandleCpmsAllocatedBudgetReturnIndex:(id)arg1;	// IMP=0x000000010008e188
- (id)getDutyCycleForPowerNumber:(int)arg1;	// IMP=0x000000010008e120
- (id)getPowerNumberForDutyCycle:(int)arg1;	// IMP=0x000000010008e0b8
- (void)releasePowerResources;	// IMP=0x000000010008de54
- (int)admissionCheck;	// IMP=0x000000010008d9d0
- (int)requestPowerResource:(unsigned long long)arg1:(void *)arg2;	// IMP=0x000000010008d7c8
- (_Bool)isPowerResourceAvailable:(unsigned long long)arg1;	// IMP=0x000000010008d66c
- (void)WiFiBatteryManagerHandlePowerAdmissionResponse:(unsigned long long)arg1;	// IMP=0x000000010008d230
- (void)dealloc;	// IMP=0x000000010008d168
- (void)WiFiBatteryManagerPpmCallbackConfiguration:(struct __WiFiDeviceManager *)arg1;	// IMP=0x000000010008cc3c
- (void)WiFiBatteryManagerCpmsCallbackConfiguration:(struct __WiFiDeviceManager *)arg1;	// IMP=0x000000010008c8e4
- (id)WiFiBatteryManagerPopulatePowerTable;	// IMP=0x000000010008c6b4
- (_Bool)configureWiFiClientAndRegisterWithBatteryModule:(_Bool)arg1:(struct __WiFiDeviceManager *)arg2:(id)arg3:(id)arg4;	// IMP=0x000000010008c2f8
- (_Bool)setup;	// IMP=0x000000010008c1a4
- (id)initWithContext:(void *)arg1;	// IMP=0x000000010008bcf8
