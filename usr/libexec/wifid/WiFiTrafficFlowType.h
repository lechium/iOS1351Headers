...
- (_Bool)canTrigger11axPerfStudy;	// IMP=0x00000001001367b0
- (id)copyStringRepresentationWithFlowClassification:(unsigned int)arg1;	// IMP=0x0000000100136260
- (id)copyStringRepresentationWithFlowProperty:(unsigned int)arg1 flowPropertyString:(id)arg2;	// IMP=0x00000001001360e8
- (void)processFlowClassifications:(unsigned int)arg1;	// IMP=0x0000000100135e20
- (void)processCombinedFlowProperties:(unsigned long long)arg1;	// IMP=0x0000000100135c14
- (void)dealloc;	// IMP=0x0000000100135bc4
- (id)initWithType:(_Bool)arg1;	// IMP=0x0000000100135b4c
