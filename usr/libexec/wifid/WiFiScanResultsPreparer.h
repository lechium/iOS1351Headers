...
+ (_Bool)wifiNetworkShouldBeProminentlyDisplayed:(struct __WiFiNetwork *)arg1;	// IMP=0x00000001000f4028
...
- (id)mostPopularProminentNetwork;	// IMP=0x00000001000f40ec
- (void)_prepareScanResults:(id)arg1;	// IMP=0x00000001000f38c4
- (void)dealloc;	// IMP=0x00000001000f385c
- (id)initWithManager:(struct __WiFiDeviceManager *)arg1 availabilityEngine:(id)arg2 scanResults:(id)arg3 disableProminentFiltering:(_Bool)arg4 blacklistedSSIDs:(id)arg5;	// IMP=0x00000001000f3798
- (id)initWithManager:(struct __WiFiDeviceManager *)arg1 availabilityEngine:(id)arg2 scanResults:(id)arg3;	// IMP=0x00000001000f3788
- (id)initWithManager:(struct __WiFiDeviceManager *)arg1 availabilityEngine:(id)arg2 scanResults:(id)arg3 disableProminentFiltering:(_Bool)arg4;	// IMP=0x00000001000f3778
