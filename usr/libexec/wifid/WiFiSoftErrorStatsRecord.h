...
@interface WiFiSoftErrorStatsRecord : NSObject
{
    ...
    WAMessage *_chipCounters;	// 16 = 0x10
    WAMessage *_btCoexStats;	// 24 = 0x18
    WAMessage *_frameCounters;	// 32 = 0x20
...
- (void).cxx_destruct;	// IMP=0x000000010000767c
...
@property(retain, nonatomic) WAMessage *frameCounters; // @synthesize frameCounters=_frameCounters;
@property(retain, nonatomic) WAMessage *btCoexStats; // @synthesize btCoexStats=_btCoexStats;
@property(retain, nonatomic) WAMessage *chipCounters; // @synthesize chipCounters=_chipCounters;
- (void)grabStats:(int)arg1 deviceContext:(void *)arg2 wifiManagerCtxt:(void *)arg3 withContext:(id)arg4;	// IMP=0x0000000100006d54
