...
- (void).cxx_destruct;	// IMP=0x000000010000b404
...
- (void)evictRandom;	// IMP=0x000000010000b2ec
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010000afe0
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010000ae08
- (void)flush;	// IMP=0x000000010000accc
- (id)initWithCapacity:(unsigned long long)arg1;	// IMP=0x000000010000ac0c
