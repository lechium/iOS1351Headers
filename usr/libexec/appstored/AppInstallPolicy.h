...
+ (id)defaultInstallPolicy;	// IMP=0x000000010006837c
- (void).cxx_destruct;	// IMP=0x0000000100068af4
- (id)copyDictionaryRepresentation;	// IMP=0x0000000100068ae4
...
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100068418
- (id)init;	// IMP=0x00000001000683b8
