...
- (void).cxx_destruct;	// IMP=0x000000010006ac48
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010006a968
- (void)setObject:(id)arg1 forKeyedSubscript:(id)arg2;	// IMP=0x000000010006a918
- (id)objectForKeyedSubscript:(id)arg1;	// IMP=0x000000010006a7e8
- (void)setValue:(id)arg1 forRequestParameter:(id)arg2;	// IMP=0x000000010006a688
- (void)setValue:(id)arg1 forRequestHeader:(id)arg2;	// IMP=0x000000010006a524
...
- (id)init;	// IMP=0x000000010006953c
