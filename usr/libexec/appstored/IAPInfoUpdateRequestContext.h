...
+ (id)newContextWithRevision:(id)arg1 forAccount:(id)arg2 token:(id)arg3;	// IMP=0x00000001000ec1d0
- (void).cxx_destruct;	// IMP=0x00000001000ec3e8
...
- (id)_initWithRevision:(id)arg1 forAccount:(id)arg2 client:(id)arg3 logUUID:(id)arg4;	// IMP=0x00000001000ec2bc
