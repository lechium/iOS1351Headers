...
+ (id)newContextWithRevision:(id)arg1 forAccountID:(long long)arg2 requestingAccount:(id)arg3 client:(id)arg4 purchaseHistoryContext:(unsigned long long)arg5;	// IMP=0x00000001002a4e80
- (void).cxx_destruct;	// IMP=0x00000001002a5044
...
- (id)_initWithRevision:(id)arg1 forAccountID:(long long)arg2 requestingAccount:(id)arg3 client:(id)arg4 purchaseHistoryContext:(unsigned long long)arg5;	// IMP=0x00000001002a4f28
