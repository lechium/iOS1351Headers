...
- (_Bool)_lib_isValidDSID:(id)arg1;	// IMP=0x0000000100200414
- (id)lib_storeMetadataError:(id *)arg1;	// IMP=0x000000010020037c
- (id)lib_extensionType:(long long)arg1;	// IMP=0x00000001002001e8
