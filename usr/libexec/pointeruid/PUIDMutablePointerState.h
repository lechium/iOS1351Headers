...
- (id)description;	// IMP=0x0000000100023e30
- (id)mutableCopyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100023df8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100023db8
