...
- (void).cxx_destruct;	// IMP=0x00000001000238cc
@property(nonatomic) __weak id <DRSessionViewDelegate> delegate; // @synthesize delegate=_delegate;
- (id)hitTest:(struct CGPoint)arg1 withEvent:(id)arg2;	// IMP=0x0000000100023834
- (void)layoutSubviews;	// IMP=0x00000001000237ec
@property(readonly, nonatomic) DRFlockContainer *flockContainer;
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x000000010002375c
