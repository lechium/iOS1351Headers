...
- (void).cxx_destruct;	// IMP=0x000000010000689c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000654c
- (unsigned long long)hash;	// IMP=0x0000000100006318
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100006074
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100005e20
- (void)copyTo:(id)arg1;	// IMP=0x0000000100005c18
- (void)writeTo:(id)arg1;	// IMP=0x0000000100005a3c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100005a34
- (id)dictionaryRepresentation;	// IMP=0x0000000100004e28
- (id)description;	// IMP=0x0000000100004d74
