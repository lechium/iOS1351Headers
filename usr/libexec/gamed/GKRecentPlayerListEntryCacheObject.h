...
+ (id)entityName;	// IMP=0x0000000100054d28
- (id)internalRepresentation;	// IMP=0x0000000100054ef0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100054d34
