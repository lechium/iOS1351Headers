...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100135624
...
- (unsigned long long)hash;	// IMP=0x000000010013587c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001357e8
- (void)dealloc;	// IMP=0x0000000100135594
