...
+ (Class)entryClass;	// IMP=0x0000000100055010
+ (id)entityName;	// IMP=0x0000000100055004
- (id)internalRepresentation;	// IMP=0x00000001000551d4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005501c
