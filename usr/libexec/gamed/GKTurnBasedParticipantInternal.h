...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013dfd0
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013e3ec
- (id)serverRepresentation;	// IMP=0x000000010013e25c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e18c
- (unsigned long long)hash;	// IMP=0x000000010013e170
- (void)dealloc;	// IMP=0x000000010013df20
@property(readonly, nonatomic) NSString *playerID;
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001451e0
