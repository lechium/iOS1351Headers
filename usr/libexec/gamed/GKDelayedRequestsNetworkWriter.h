...
+ (id)writerWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100126e58
...
- (void)writeResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x0000000100126f68
- (void)dealloc;	// IMP=0x0000000100126f18
- (id)initWithTransport:(id)arg1 forBagKey:(id)arg2;	// IMP=0x0000000100126e98
