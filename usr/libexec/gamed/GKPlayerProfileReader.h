...
+ (id)readerWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013c068
...
- (void)readResources:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010013c404
- (id)poolName;	// IMP=0x000000010013c3b0
- (int)familiarityForPlayer:(id)arg1;	// IMP=0x000000010013c208
- (void)dealloc;	// IMP=0x000000010013c1a0
- (id)initWithLocalPlayer:(id)arg1 language:(id)arg2 readerConnection:(id)arg3 writerConnection:(id)arg4 transport:(id)arg5;	// IMP=0x000000010013c0d0
