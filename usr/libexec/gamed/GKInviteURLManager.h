...
+ (id)sharedManager;	// IMP=0x0000000100109290
- (void).cxx_destruct;	// IMP=0x00000001001097b0
...
- (_Bool)isRecordEqualToMostRecentInviteShare:(id)arg1;	// IMP=0x0000000100109500
- (id)init;	// IMP=0x0000000100109448
