...
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001001400c8
+ (id)nearbyInviteIDForPlayerID:(id)arg1 deviceID:(id)arg2 bundleID:(id)arg3;	// IMP=0x000000010013ff18
+ (id)inviteFromNearbyPlayer:(id)arg1 participantID:(id)arg2 deviceID:(id)arg3 bundleID:(id)arg4 connectionData:(id)arg5;	// IMP=0x000000010013fde0
+ (id)inviteWithBulletin:(id)arg1;	// IMP=0x000000010013f978
...
- (id)descriptionSubstitutionMap;	// IMP=0x0000000100140458
@property(readonly, nonatomic) _Bool isNearby; // @dynamic isNearby;
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001403bc
- (unsigned long long)hash;	// IMP=0x0000000100140398
- (void)dealloc;	// IMP=0x000000010013ffb8
- (id)init;	// IMP=0x000000010013ff54
