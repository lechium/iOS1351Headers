...
- (void)handleAction:(id)arg1;	// IMP=0x00000001000fe994
- (void)dealloc;	// IMP=0x00000001000fe944
- (id)initWithPlayer:(id)arg1 localizedGameName:(id)arg2 inviteDictionary:(id)arg3;	// IMP=0x00000001000fe378
