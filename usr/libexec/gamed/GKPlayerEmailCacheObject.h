...
+ (id)entityName;	// IMP=0x0000000100049118
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100048ef0
- (id)internalRepresentation;	// IMP=0x0000000100048d30
