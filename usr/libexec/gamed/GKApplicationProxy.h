...
+ (id)metadataForBundleURL:(id)arg1;	// IMP=0x0000000100094a8c
...
- (id)bundleURL;	// IMP=0x0000000100094c84
...
- (void)dealloc;	// IMP=0x0000000100094b64
- (id)initWithBundleID:(id)arg1;	// IMP=0x0000000100094a4c
- (id)initWithProxy:(id)arg1;	// IMP=0x00000001000949ec
