...
+ (id)defaultCustomTournamentForTournamentDefinition:(id)arg1;	// IMP=0x00000001000fd4cc
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fd160
- (void).cxx_destruct;	// IMP=0x00000001000fd9c8
