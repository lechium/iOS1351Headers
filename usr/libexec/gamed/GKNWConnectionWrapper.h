...
- (void).cxx_destruct;	// IMP=0x00000001000cb234
...
- (void)cancelConnection;	// IMP=0x00000001000cb1b4
- (void)readData;	// IMP=0x00000001000cb1b0
- (void)_sendData:(id)arg1;	// IMP=0x00000001000cb1ac
- (_Bool)sendData:(id)arg1;	// IMP=0x00000001000cb140
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x00000001000caf14
- (void)dealloc;	// IMP=0x00000001000cae78
- (id)initWithConnection:(id)arg1 delegate:(id)arg2 delegateQueue:(id)arg3;	// IMP=0x00000001000cad80
