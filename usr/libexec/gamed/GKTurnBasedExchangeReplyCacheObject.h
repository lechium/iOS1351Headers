...
+ (id)entityName;	// IMP=0x00000001000593f4
- (id)internalRepresentation;	// IMP=0x000000010005963c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100059400
