...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012cf04
...
- (id)description;	// IMP=0x000000010012ce18
@property(readonly) NSString *scopeAsString;
- (void)dealloc;	// IMP=0x000000010012cc9c
- (unsigned long long)hash;	// IMP=0x000000010012cc78
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012cb18
