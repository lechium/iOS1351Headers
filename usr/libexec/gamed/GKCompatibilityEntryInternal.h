...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010014079c
...
- (unsigned long long)hash;	// IMP=0x0000000100140ad0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100140964
- (void)dealloc;	// IMP=0x000000010014071c
