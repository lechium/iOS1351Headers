...
+ (id)entityName;	// IMP=0x0000000100056bf0
- (id)internalRepresentation;	// IMP=0x0000000100056d5c
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x0000000100056bfc
