...
+ (id)entityName;	// IMP=0x000000010004e750
- (_Bool)isValid;	// IMP=0x000000010004e810
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004e75c
