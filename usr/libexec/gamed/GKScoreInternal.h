...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100135f08
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001001359d4
...
- (unsigned long long)hash;	// IMP=0x00000001001363c4
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001361d4
- (id)serverRepresentation;	// IMP=0x00000001001360ac
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100135dc8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001001359fc
- (void)dealloc;	// IMP=0x0000000100135944
