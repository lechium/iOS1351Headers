...
+ (id)entityName;	// IMP=0x000000010004e5c0
- (id)internalRepresentation;	// IMP=0x000000010004e3b4
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x000000010004df70
