...
+ (id)entityName;	// IMP=0x000000010004b080
- (_Bool)isValid;	// IMP=0x000000010004b140
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004b08c
