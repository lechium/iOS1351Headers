...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013f370
...
- (_Bool)hasGuestPlayers;	// IMP=0x000000010013f690
- (unsigned long long)hash;	// IMP=0x000000010013f2fc
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013eee0
- (void)dealloc;	// IMP=0x000000010013ee30
- (id)init;	// IMP=0x000000010013edb0
