...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010012c804
...
- (unsigned long long)hash;	// IMP=0x000000010012ca48
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012c908
- (void)dealloc;	// IMP=0x000000010012c794
