...
+ (id)entityName;	// IMP=0x0000000100058d90
- (id)internalRepresentation;	// IMP=0x00000001000593ec
- (void)updateWithServerRepresentation:(id)arg1 participants:(id)arg2;	// IMP=0x0000000100058d9c
