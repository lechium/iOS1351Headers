...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010009aac4
...
- (void)loadGoalTextForGameDescriptor:(id)arg1 handler:(CDUnknownBlockType)arg2;	// IMP=0x000000010009b2f8
- (void)loadDetailsWithHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010009ab7c
- (id)initWithChallenge:(id)arg1;	// IMP=0x000000010009ab24
- (id)challengeInternalObject;	// IMP=0x000000010009ab1c
- (id)description;	// IMP=0x000000010009aacc
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010009a9d8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010009a82c
- (void)dealloc;	// IMP=0x000000010009a7a4
