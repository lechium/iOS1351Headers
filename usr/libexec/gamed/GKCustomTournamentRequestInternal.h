...
+ (id)customTournamentRequestWithTournamentDefinition:(id)arg1 player:(id)arg2;	// IMP=0x00000001000fc238
+ (id)secureCodedPropertyKeys;	// IMP=0x00000001000fc03c
- (void).cxx_destruct;	// IMP=0x00000001000fc5f4
