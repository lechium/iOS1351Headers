...
+ (id)entityName;	// IMP=0x00000001000514b0
- (void)updateWithServerRepresentation:(id)arg1;	// IMP=0x00000001000518ec
- (id)internalRepresentation;	// IMP=0x00000001000514bc
