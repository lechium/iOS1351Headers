...
+ (Class)entryClass;	// IMP=0x000000010005a8dc
+ (id)entityName;	// IMP=0x000000010005a8d0
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010005a8e8
