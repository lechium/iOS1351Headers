...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013ce44
...
- (id)descriptionSubstitutionMap;	// IMP=0x000000010013db6c
@property(nonatomic) unsigned int state; // @synthesize state=_state;
- (long long)activeExchangeCount;	// IMP=0x000000010013d550
- (long long)previousParticipantIndex;	// IMP=0x000000010013d3c8
- (long long)localPlayerParticipantIndex;	// IMP=0x000000010013d374
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013d260
- (unsigned long long)hash;	// IMP=0x000000010013d23c
- (void)dealloc;	// IMP=0x000000010013cce4
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x000000010014495c
