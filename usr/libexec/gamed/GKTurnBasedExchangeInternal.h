...
+ (id)secureCodedPropertyKeys;	// IMP=0x000000010013e6ec
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010013e9b4
- (unsigned long long)hash;	// IMP=0x000000010013e99c
- (void)dealloc;	// IMP=0x000000010013e61c
- (void)updateWithCacheObject:(id)arg1;	// IMP=0x00000001001453e0
