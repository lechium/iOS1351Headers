...
+ (id)secureCodedPropertyKeys;	// IMP=0x0000000100132c24
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100132bac
...
- (unsigned long long)hash;	// IMP=0x0000000100132dd0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100132d08
- (void)dealloc;	// IMP=0x0000000100132bb4
