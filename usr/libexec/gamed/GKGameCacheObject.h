...
+ (id)entityName;	// IMP=0x000000010004b074
+ (id)_gamesForFullGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x0000000100049728
+ (id)gamesForGameDescriptors:(id)arg1 context:(id)arg2;	// IMP=0x00000001000495e8
+ (id)gamesForBundleIDs:(id)arg1 context:(id)arg2;	// IMP=0x00000001000494a8
+ (id)gameForBundleID:(id)arg1 context:(id)arg2;	// IMP=0x00000001000492d8
+ (id)gameForGameDescriptor:(id)arg1 context:(id)arg2;	// IMP=0x000000010004923c
+ (id)fetchSortDescriptors;	// IMP=0x0000000100049190
+ (const void *)uniqueObjectIDLookupKey;	// IMP=0x0000000100049184
+ (id)uniqueAttributeName;	// IMP=0x0000000100049178
- (id)gameDescriptor;	// IMP=0x000000010004adbc
- (id)leaderboardSetWithIdentifier:(id)arg1;	// IMP=0x000000010004ad40
- (id)internalRepresentation;	// IMP=0x000000010004ac18
- (_Bool)storePiecesExpired;	// IMP=0x000000010004abe8
- (_Bool)storePiecesValid;	// IMP=0x000000010004aba4
- (void)updateStorePiecesWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004a5f4
- (void)updateWithServerRepresentation:(id)arg1 expirationDate:(id)arg2;	// IMP=0x000000010004a050
- (void)updateWithGameDescriptor:(id)arg1;	// IMP=0x0000000100049ae8
- (_Bool)isValid;	// IMP=0x0000000100049a6c
- (void)invalidate;	// IMP=0x0000000100049124
