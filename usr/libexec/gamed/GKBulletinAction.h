...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100081d34
...
- (id)description;	// IMP=0x0000000100081fc4
@property(readonly) NSDictionary *actionDictionary;
- (void)dealloc;	// IMP=0x0000000100081da8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100081d3c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100081a94
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100081810
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100081788
- (id)init;	// IMP=0x0000000100081748
