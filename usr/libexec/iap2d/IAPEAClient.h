...
+ (unsigned int)clientIDForCameraClient;	// IMP=0x0000000100043930
+ (unsigned int)clientIDForLocationClient;	// IMP=0x0000000100043924
...
- (void)_setJetsamPrioritySpecialCasing:(_Bool)arg1;	// IMP=0x0000000100044194
- (int)_getProcessId;	// IMP=0x00000001000440d0
@property(nonatomic) _Bool cameraSupportedByClient;
@property(nonatomic) _Bool locationSupportedByClient;
- (void)decreaseSessionRefCount;	// IMP=0x0000000100043f18
- (void)increaseSessionRefCount;	// IMP=0x0000000100043ed4
- (_Bool)canSendConnectionEventForAccessory:(id)arg1;	// IMP=0x0000000100043b70
- (void)takeProcessAssertion:(id)arg1;	// IMP=0x000000010004393c
- (void)dealloc;	// IMP=0x00000001000437b8
- (id)initWithCapabilities:(unsigned int)arg1 auditToken:(CDStruct_4c969caf)arg2 xpcConnection:(id)arg3 eaProtocols:(id)arg4 andBundleId:(id)arg5;	// IMP=0x00000001000433a4
