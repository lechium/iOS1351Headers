...
- (void).cxx_destruct;	// IMP=0x00000001000333a4
...
- (id)applicationInfoForPIDSync:(int)arg1;	// IMP=0x00000001000331c0
- (id)applicationInfoForBundleIDSync:(id)arg1;	// IMP=0x00000001000331b0
- (void)layoutMonitor:(id)arg1 didUpdateDisplayLayout:(id)arg2 withContext:(id)arg3;	// IMP=0x0000000100032ed8
- (void)stopObserving;	// IMP=0x0000000100032dc8
- (void)startObserving;	// IMP=0x0000000100032920
- (void)dealloc;	// IMP=0x000000010003289c
- (id)init;	// IMP=0x0000000100032828
- (void)sharedInit;	// IMP=0x000000010003277c
