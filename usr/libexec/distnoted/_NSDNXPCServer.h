...
- (id)createEndpoint;	// IMP=0x0000000100001824
- (id)allClients;	// IMP=0x00000001000017dc
- (void)start;	// IMP=0x00000001000015cc
- (void)addInvalidationHandler:(CDUnknownBlockType)arg1;	// IMP=0x0000000100001550
- (void)invalidate;	// IMP=0x0000000100001408
- (id)__invalidate;	// IMP=0x00000001000013cc
- (void)setPrivileged:(_Bool)arg1;	// IMP=0x00000001000013c4
- (id)dispatchQueue;	// IMP=0x00000001000013bc
...
- (void)dealloc;	// IMP=0x00000001000011a4
- (id)initWithConfiguration:(struct distnoted_configuration *)arg1;	// IMP=0x00000001000010e8
