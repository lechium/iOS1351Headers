...
@interface TKHostToken : NSObject <NSSecureCoding>
{
...
+ (id)keychainItemClasses;	// IMP=0x0000000100002f18
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100002748
- (void).cxx_destruct;	// IMP=0x00000001000033a0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000031c4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100003068
- (id)connectionWithError:(id *)arg1;	// IMP=0x0000000100002978
- (id)description;	// IMP=0x0000000100002878
- (id)initWithTokenID:(id)arg1 persistent:(_Bool)arg2 automatic:(_Bool)arg3;	// IMP=0x0000000100002750
