...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010005f130
- (void).cxx_destruct;	// IMP=0x000000010005f124
...
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010005efc8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010005eed4
- (id)initWithCallbackType:(int)arg1 taskIdentifier:(unsigned long long)arg2 args:(id)arg3;	// IMP=0x000000010005edf0
