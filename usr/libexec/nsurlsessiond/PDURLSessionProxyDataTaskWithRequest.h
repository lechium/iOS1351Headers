...
- (void).cxx_destruct;	// IMP=0x0000000100010574
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000103f8
- (unsigned long long)hash;	// IMP=0x0000000100010350
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010001021c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100010118
- (void)copyTo:(id)arg1;	// IMP=0x0000000100010060
- (void)writeTo:(id)arg1;	// IMP=0x000000010000ffb8
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000fca4
- (id)dictionaryRepresentation;	// IMP=0x000000010000fb24
- (id)description;	// IMP=0x000000010000fa70
