...
- (void).cxx_destruct;	// IMP=0x0000000100003e7c
...
- (void)recordBytes:(unsigned long long)arg1 bundleID:(id)arg2;	// IMP=0x0000000100003d00
- (void)deleteMetrics;	// IMP=0x0000000100003c24
- (void)saveMetrics;	// IMP=0x00000001000039d4
- (void)readMetrics;	// IMP=0x00000001000036e8
- (id)initWithStageURL:(id)arg1 reportHandler:(CDUnknownBlockType)arg2;	// IMP=0x000000010000344c
