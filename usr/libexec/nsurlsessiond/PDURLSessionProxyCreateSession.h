...
- (void).cxx_destruct;	// IMP=0x000000010000735c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100007138
- (unsigned long long)hash;	// IMP=0x0000000100007008
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100006e08
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100006c60
- (void)copyTo:(id)arg1;	// IMP=0x0000000100006afc
- (void)writeTo:(id)arg1;	// IMP=0x00000001000069b0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000062f0
- (id)dictionaryRepresentation;	// IMP=0x0000000100006038
- (id)description;	// IMP=0x0000000100005f84
