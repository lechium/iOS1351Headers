...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100025908
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100025c78
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100025bd4
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100025910
- (id)newIncidentsForDestination:(id)arg1;	// IMP=0x00000001000256ec
- (void)updateWithIncidents:(id)arg1;	// IMP=0x0000000100025418
@property(readonly, nonatomic) NSString *JSONString;
- (void)clear;	// IMP=0x0000000100025218
@property(readonly, nonatomic) NSString *statusString;
@property(readonly, nonatomic, getter=isInTripMode) _Bool inTripMode;
- (void)completeWindowBecause:(unsigned long long)arg1;	// IMP=0x0000000100024ad8
- (void)setReasonForEnd:(unsigned long long)arg1;	// IMP=0x0000000100024a7c
...
- (void)setNumberOfUpdatesToRoutesPerDestination:(unsigned long long)arg1;	// IMP=0x0000000100024878
- (unsigned long long)numberOfUpdatesToRoutesPerDestination;	// IMP=0x0000000100024828
...
- (void)_writeObject:(id)arg1 toKey:(unsigned long long)arg2 updateModTime:(_Bool)arg3;	// IMP=0x0000000100024178
- (id)_readObjectFromKey:(unsigned long long)arg1;	// IMP=0x0000000100023fd8
- (id)init;	// IMP=0x0000000100023f0c
