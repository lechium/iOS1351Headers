...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000c844
- (unsigned long long)hash;	// IMP=0x000000010000c658
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000c50c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000c3fc
- (void)copyTo:(id)arg1;	// IMP=0x000000010000c308
- (void)writeTo:(id)arg1;	// IMP=0x000000010000c218
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000c210
- (id)dictionaryRepresentation;	// IMP=0x000000010000bc8c
- (id)description;	// IMP=0x000000010000bbd8
