...
+ (void)invalidateConfigurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100063a34
+ (void)loadConfigurationForEnvironment:(id)arg1 interface:(long long)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000100063664
+ (id)configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x00000001000633cc
+ (id)_onQueue_configurationForEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100063184
+ (void)initialize;	// IMP=0x0000000100063128
- (void).cxx_destruct;	// IMP=0x00000001000655b4
...
- (void)setExpiryInterval:(double)arg1 expirationBlock:(CDUnknownBlockType)arg2;	// IMP=0x00000001000653a0
- (_Bool)_isExpired;	// IMP=0x000000010006533c
- (_Bool)_isLoaded;	// IMP=0x0000000100065334
...
- (id)bagExpiryInterval;	// IMP=0x00000001000652d4
...
- (id)ExpensiveConditionsBackOffInterval;	// IMP=0x00000001000651b4
...
@property(readonly, nonatomic) NSNumber *allowTLS1_3;
...
- (void)_finishLoadWithResponse:(id)arg1 urlHost:(id)arg2 data:(id)arg3;	// IMP=0x0000000100064a24
- (void)_failWithError:(id)arg1;	// IMP=0x0000000100064914
- (void)_callCompletionBlocksWithError:(id)arg1;	// IMP=0x00000001000646a0
- (void)addCompletionBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100064500
- (id)pendingCompletionBocks;	// IMP=0x00000001000644f8
- (void)dealloc;	// IMP=0x00000001000644ac
- (id)initWithEnvironment:(id)arg1 interface:(long long)arg2;	// IMP=0x0000000100063d58
