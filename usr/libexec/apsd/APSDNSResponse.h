...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000188dc
- (void).cxx_destruct;	// IMP=0x0000000100018b30
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100018a94
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000188e4
- (id)initResponseForHostname:(id)arg1 ipv4Address:(id)arg2 ipv6Address:(id)arg3;	// IMP=0x00000001000187bc
