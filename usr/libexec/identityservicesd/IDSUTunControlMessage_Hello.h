...
- (void).cxx_destruct;	// IMP=0x000000010015cdd4
...
- (id)initWithBytes:(const void *)arg1 length:(unsigned long long)arg2 loggingPrefixString:(id)arg3;	// IMP=0x0000000100159fd4
- (id)data;	// IMP=0x000000010015924c
- (id)init;	// IMP=0x00000001001591d0
- (_Bool)_isSupportIPsecLinkFlagSet;	// IMP=0x0000000100159150
- (id)description;	// IMP=0x0000000100158ffc
