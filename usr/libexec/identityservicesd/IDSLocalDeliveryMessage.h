...
- (id)socketPairMessage;	// IMP=0x000000010027d25c
- (void)processAckForSocketPairMessage:(id)arg1;	// IMP=0x000000010027d1f8
- (void)kickProgressBlock;	// IMP=0x000000010027cfe0
- (id)init;	// IMP=0x000000010027cd1c
