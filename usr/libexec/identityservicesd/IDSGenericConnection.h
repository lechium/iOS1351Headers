...
- (void).cxx_destruct;	// IMP=0x00000001004eef4c
...
- (void)_createStallDetectorWithName:(id)arg1;	// IMP=0x00000001004ed524
- (void)_triggerStallDetectionLogsForDetector:(id)arg1 withEvent:(id)arg2;	// IMP=0x00000001004ece28
- (void)reportToAWD:(unsigned long long)arg1 connectionType:(int)arg2 error:(int)arg3;	// IMP=0x00000001004ecb20
- (void)invalidate;	// IMP=0x00000001004ec124
- (void)dealloc;	// IMP=0x00000001004ec020
- (void)_closeSockets;	// IMP=0x00000001004eb984
@property(nonatomic) NSObject<OS_dispatch_queue> *completionQueue;
- (id)initWithAddressPair:(id)arg1 protocol:(int)arg2;	// IMP=0x00000001004eb4fc
- (id)flagsString;	// IMP=0x00000001004eb3b8
- (CDStruct_eff2b79e *)encryptionState;	// IMP=0x00000001004eb398
- (id)description;	// IMP=0x00000001004eaf1c
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 keyMaterialLength:(int)arg3 isCloudEnabled:(_Bool)arg4;	// IMP=0x00000001004eaac8
- (id)initWithConnectionID:(id)arg1 protocol:(int)arg2 isCloudEnabled:(_Bool)arg3;	// IMP=0x00000001004ea670
