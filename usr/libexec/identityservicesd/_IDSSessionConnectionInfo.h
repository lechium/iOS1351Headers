...
- (void).cxx_destruct;	// IMP=0x00000001003b9f90
...
- (unsigned int)_numberOfOutagesSinceInterval:(double)arg1;	// IMP=0x00000001003b9560
- (void)_addRemotePacketOutage;	// IMP=0x00000001003b9498
- (id)description;	// IMP=0x00000001003b9370
@property(readonly, nonatomic) _Bool isFinished;
- (id)init;	// IMP=0x00000001003b9280
