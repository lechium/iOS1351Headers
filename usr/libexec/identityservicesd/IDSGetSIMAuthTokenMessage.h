...
- (void).cxx_destruct;	// IMP=0x000000010061ba28
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x000000010061b424
- (_Bool)isMultipleAuthCertCapable;	// IMP=0x000000010061b408
- (id)bagKey;	// IMP=0x000000010061b3ec
- (id)requiredKeys;	// IMP=0x000000010061b394
- (id)messageBody;	// IMP=0x000000010061afe4
- (id)additionalMessageHeaders;	// IMP=0x000000010061ae38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010061aae0
