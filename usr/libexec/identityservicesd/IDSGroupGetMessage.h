...
- (void).cxx_destruct;	// IMP=0x00000001005e6f34
...
- (void)handleResponseDictionary:(id)arg1;	// IMP=0x00000001005e6978
- (id)bagKey;	// IMP=0x00000001005e695c
- (id)requiredKeys;	// IMP=0x00000001005e6904
- (id)messageBody;	// IMP=0x00000001005e64f4
- (id)additionalMessageHeaders;	// IMP=0x00000001005e61d0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001005e5e78
