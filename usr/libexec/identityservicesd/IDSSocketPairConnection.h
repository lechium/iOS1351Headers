...
- (void)setOTREncryptionBlock:(CDUnknownBlockType)arg1 decryptionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010006d240
- (void)setNotifyWhenConnectionReceivesBytes:(_Bool)arg1;	// IMP=0x000000010006d1ec
- (void)_endSession;	// IMP=0x000000010006ce48
- (_Bool)sendDataMessage:(id)arg1 canFragment:(_Bool)arg2;	// IMP=0x000000010006c920
- (_Bool)sendDataMessage:(id)arg1;	// IMP=0x000000010006c8a8
- (void)_sendToConnectedSocket;	// IMP=0x000000010006bab8
- (_Bool)_queueNextOutgoingData;	// IMP=0x000000010006a9cc
- (void)_processBytesAvailable;	// IMP=0x0000000100069764
- (_Bool)_processIncomingMessage:(id)arg1;	// IMP=0x000000010006884c
- (void)processStoredIncomingMessage:(id)arg1;	// IMP=0x0000000100068434
- (void)removePendingMessagesForProtectionClass:(unsigned int)arg1;	// IMP=0x0000000100067b58
- (long long)_read:(char *)arg1 maxLength:(unsigned long long)arg2;	// IMP=0x0000000100067704
- (void)_callDelegateWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100067578
...
- (void)endSession;	// IMP=0x0000000100066a9c
- (void)dealloc;	// IMP=0x0000000100066998
- (void)start;	// IMP=0x00000001000666fc
- (id)initWithSocket:(int)arg1 queue:(id)arg2 delegate:(id)arg3 priority:(long long)arg4 connectionID:(id)arg5 linkType:(unsigned long long)arg6;	// IMP=0x0000000100066134
