...
#import "PDTaskSchedulerTask-Protocol.h"

@class NSString;
@protocol OS_dispatch_queue;

@interface PDTaskSchedulerBlockTask : NSObject <PDTaskSchedulerTask>
{
...
- (void).cxx_destruct;	// IMP=0x000000010006ae08
...
- (void)run;	// IMP=0x000000010006aa5c
- (void)clampToPredefinedTimePeriod:(unsigned long long)arg1;	// IMP=0x000000010006a9dc
- (id)initWithIdentifier:(id)arg1 queue:(id)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x000000010006a8c0
