...
- (void).cxx_destruct;	// IMP=0x000000010000c44c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000c1d8
- (unsigned long long)hash;	// IMP=0x000000010000c0ac
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000bea0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000bcd0
- (void)copyTo:(id)arg1;	// IMP=0x000000010000bb64
- (void)writeTo:(id)arg1;	// IMP=0x000000010000ba14
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000ba0c
- (id)dictionaryRepresentation;	// IMP=0x000000010000b390
- (id)description;	// IMP=0x000000010000b2dc
