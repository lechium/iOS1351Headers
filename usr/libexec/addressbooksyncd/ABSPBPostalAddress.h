...
- (void).cxx_destruct;	// IMP=0x00000001000177ac
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010001751c
- (unsigned long long)hash;	// IMP=0x0000000100017418
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100017210
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100017048
- (void)copyTo:(id)arg1;	// IMP=0x0000000100016efc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100016dd4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100016dcc
- (id)dictionaryRepresentation;	// IMP=0x0000000100016a8c
- (id)description;	// IMP=0x00000001000169d8
