...
- (void).cxx_destruct;	// IMP=0x000000010000cea4
...
- (void)URLSession:(id)arg1 didReceiveChallenge:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010000ce08
- (void)URLSession:(id)arg1 didBecomeInvalidWithError:(id)arg2;	// IMP=0x000000010000ce04
- (void)enqueueRequest:(id)arg1 withCompletion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000c0d0
- (void)dealloc;	// IMP=0x000000010000c064
- (id)init;	// IMP=0x000000010000bd24
