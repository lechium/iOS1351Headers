...
- (void).cxx_destruct;	// IMP=0x0000000100209ea4
...
- (void)combineWithAdvertisement:(id)arg1;	// IMP=0x0000000100209c4c
- (CDStruct_3f8e1fcf)structRepresentation;	// IMP=0x0000000100209bc0
- (id)initWithRPI:(id)arg1 encryptedAEM:(id)arg2 timestamp:(double)arg3 scanInterval:(unsigned short)arg4 avgRSSI:(BOOL)arg5 saturated:(_Bool)arg6 countryCode:(unsigned short)arg7 counter:(unsigned char)arg8;	// IMP=0x0000000100209ab4
- (id)initWithStructRepresentation:(CDStruct_3f8e1fcf)arg1;	// IMP=0x00000001002099b0
