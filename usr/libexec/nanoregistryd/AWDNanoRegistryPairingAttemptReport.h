...
- (void).cxx_destruct;	// IMP=0x000000010009c894
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010009c23c
- (unsigned long long)hash;	// IMP=0x000000010009bef8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010009ba0c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010009b5a0
- (void)copyTo:(id)arg1;	// IMP=0x000000010009b1b0
- (void)writeTo:(id)arg1;	// IMP=0x000000010009ae28
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010009ae20
- (id)dictionaryRepresentation;	// IMP=0x00000001000999c0
- (id)description;	// IMP=0x000000010009990c
