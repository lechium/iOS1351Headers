...
+ (Class)resourceClass;	// IMP=0x000000010008a930
- (void).cxx_destruct;	// IMP=0x000000010008aae4
...
- (void)updateWithPairingID:(id)arg1;	// IMP=0x000000010008a998
- (void)destroyResource;	// IMP=0x000000010008a93c
@property(readonly, nonatomic) NRRegistry *registry;
- (id)initWithFactory:(id)arg1 pairingID:(id)arg2;	// IMP=0x000000010008a7c8
