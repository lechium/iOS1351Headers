...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000887b8
- (void).cxx_destruct;	// IMP=0x000000010008a634
...
- (_Bool)isPairingErrorSet;	// IMP=0x000000010008a494
- (_Bool)didPairingReportRecordAFailure;	// IMP=0x000000010008a470
- (void)submitPairingReportWithPairingAttemptCounter:(unsigned int)arg1 andSwitchCounter:(unsigned int)arg2 andPairedDeviceCount:(unsigned int)arg3 andGizmoHardware:(id)arg4 andGizmoSerial:(id)arg5 andBuildType:(id)arg6 screenName:(id)arg7 idsDisconnectCounter:(long long)arg8 pairingStartTime:(id)arg9 andEnclosureMaterial:(unsigned int)arg10 shouldLogOnly:(_Bool)arg11;	// IMP=0x000000010008a034
- (void)setPairingReportErrorForRemoteError:(unsigned long long)arg1 withReason:(id)arg2;	// IMP=0x0000000100089340
- (void)setPairingReportErrorForPairingClient:(id)arg1 reason:(id)arg2;	// IMP=0x00000001000889b0
- (id)pairingError;	// IMP=0x00000001000889a4
- (void)setPairingError:(id)arg1;	// IMP=0x00000001000887c0
- (id)description;	// IMP=0x00000001000884d4
- (void)incrementIncorrectPINcount;	// IMP=0x00000001000883cc
@property(readonly, nonatomic) _Bool isErrorSet;
- (void)setSubreasonWithPairingError:(id)arg1;	// IMP=0x0000000100086ff8
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100085e80
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100085bcc
@property(readonly, nonatomic) NSError *detailedError;
- (id)init;	// IMP=0x0000000100084b74
