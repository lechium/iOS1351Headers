...
+ (void)submitWithRegistry:(id)arg1 switchToDeviceID:(id)arg2 switchType:(unsigned int)arg3 switchDuration:(double)arg4 idsSwitchDuration:(double)arg5 daemonDisableDuration:(double)arg6 daemonEnableDuration:(double)arg7;	// IMP=0x00000001000b6a90
- (void).cxx_destruct;	// IMP=0x00000001000cf53c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000cf218
- (unsigned long long)hash;	// IMP=0x00000001000cf040
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000ced90
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ceb28
- (void)copyTo:(id)arg1;	// IMP=0x00000001000ce8fc
- (void)writeTo:(id)arg1;	// IMP=0x00000001000ce704
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000ce6fc
- (id)dictionaryRepresentation;	// IMP=0x00000001000cd9ac
- (id)description;	// IMP=0x00000001000cd8f8
...
- (_Bool)submitMetric;	// IMP=0x00000001000b7150
- (id)initWithRegistry:(id)arg1 switchToDeviceID:(id)arg2 switchType:(unsigned int)arg3 switchDuration:(double)arg4 idsSwitchDuration:(double)arg5 daemonDisableDuration:(double)arg6 daemonEnableDuration:(double)arg7;	// IMP=0x00000001000b6be4
