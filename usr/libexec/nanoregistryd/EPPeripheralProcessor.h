...
- (void)resourceAvailabilityDidChange:(id)arg1;	// IMP=0x00000001000f1f88
- (void)centralManagerDidUpdateState:(id)arg1;	// IMP=0x00000001000f1f7c
- (void)update;	// IMP=0x00000001000f1dac
- (id)initWithDeviceIDs:(id)arg1 block:(CDUnknownBlockType)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001000f1c3c
