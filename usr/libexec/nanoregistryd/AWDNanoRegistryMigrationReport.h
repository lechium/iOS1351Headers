...
+ (void)submitWithDeviceHistory:(id)arg1 error:(id)arg2;	// IMP=0x00000001000dde04
- (void).cxx_destruct;	// IMP=0x0000000100083348
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100082fa0
- (unsigned long long)hash;	// IMP=0x0000000100082d90
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100082a78
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000827c4
- (void)copyTo:(id)arg1;	// IMP=0x000000010008255c
- (void)writeTo:(id)arg1;	// IMP=0x0000000100082330
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100082328
- (id)dictionaryRepresentation;	// IMP=0x000000010008155c
- (id)description;	// IMP=0x00000001000814a8
...
- (_Bool)submitMetric;	// IMP=0x00000001000de4d8
- (id)initWithDeviceHistory:(id)arg1 error:(id)arg2;	// IMP=0x00000001000ddf94
