...
+ (void)submitWithDevice:(id)arg1 requestType:(id)arg2 duration:(double)arg3 andResponseCode:(unsigned int)arg4;	// IMP=0x000000010000c604
- (void).cxx_destruct;	// IMP=0x000000010007b7bc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010007b5e4
- (unsigned long long)hash;	// IMP=0x000000010007b4d4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010007b318
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010007b1a8
- (void)copyTo:(id)arg1;	// IMP=0x000000010007b07c
- (void)writeTo:(id)arg1;	// IMP=0x000000010007af6c
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010007af64
- (id)dictionaryRepresentation;	// IMP=0x000000010007a8a4
- (id)description;	// IMP=0x000000010007a7f0
...
- (_Bool)submitMetric;	// IMP=0x000000010000c904
- (id)initWithDevice:(id)arg1 requestType:(id)arg2 duration:(double)arg3 andResponseCode:(unsigned int)arg4;	// IMP=0x000000010000c738
