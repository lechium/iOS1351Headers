...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000df040
- (void).cxx_destruct;	// IMP=0x00000001000df2ac
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000df118
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000df048
@property(readonly, nonatomic) id <NSObject> value;
- (id)initWithEntryName:(id)arg1 operandName:(id)arg2;	// IMP=0x00000001000deed0
