...
- (void)applicationsDidUninstall:(id)arg1;	// IMP=0x00000001000e583c
- (void)applicationsWillUninstall:(id)arg1;	// IMP=0x00000001000e5728
- (void)applicationsDidInstall:(id)arg1;	// IMP=0x00000001000e5614
- (int)getFilteredMediaTypesMask:(int)arg1;	// IMP=0x00000001000e5594
- (void)handleAppUninstall:(id)arg1;	// IMP=0x00000001000e5340
- (void)handleAppInstall:(id)arg1;	// IMP=0x00000001000e512c
- (void)dealloc;	// IMP=0x00000001000e50ac
- (id)init;	// IMP=0x00000001000e4f24
@property(readonly) _Bool iTunesRadioEnabled;
- (void)_updateITunesRadioEnabled;	// IMP=0x00000001000e4e24
