...
- (void)dealloc;	// IMP=0x0000000100002adc
- (void)checkInRecognizer;	// IMP=0x0000000100002a9c
- (id)checkOutRecognizer;	// IMP=0x0000000100002a88
- (id)initWithRecognizer:(id)arg1;	// IMP=0x0000000100002a14
