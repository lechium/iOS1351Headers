...
+ (id)responseWithResponse:(id)arg1;	// IMP=0x000000010006e780
+ (id)responseWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x000000010006e6b8
- (void).cxx_destruct;	// IMP=0x000000010006e994
...
- (id)description;	// IMP=0x000000010006e8b0
- (id)initWithCode:(unsigned long long)arg1 headerFields:(id)arg2 data:(id)arg3 MIMEType:(id)arg4 error:(id)arg5;	// IMP=0x000000010006e588
