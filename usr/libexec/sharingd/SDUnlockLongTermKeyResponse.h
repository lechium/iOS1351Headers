...
- (void).cxx_destruct;	// IMP=0x00000001001fbd70
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001fbc44
- (unsigned long long)hash;	// IMP=0x00000001001fbb8c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001fba54
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001fb954
- (void)copyTo:(id)arg1;	// IMP=0x00000001001fb890
- (void)writeTo:(id)arg1;	// IMP=0x00000001001fb7dc
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001fb7d4
- (id)dictionaryRepresentation;	// IMP=0x00000001001fb348
- (id)description;	// IMP=0x00000001001fb294
