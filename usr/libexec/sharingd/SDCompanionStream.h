...
- (void).cxx_destruct;	// IMP=0x00000001001fac74
...
- (void)logClientReceived;	// IMP=0x00000001001faa7c
- (void)logClientSent;	// IMP=0x00000001001faa08
- (void)writeNetworkStream;	// IMP=0x00000001001fa8fc
- (void)readClientStream;	// IMP=0x00000001001fa6d4
- (void)writeClientStream;	// IMP=0x00000001001fa394
- (void)handleOpenedStream;	// IMP=0x00000001001fa2f4
- (void)stream:(id)arg1 handleEvent:(unsigned long long)arg2;	// IMP=0x00000001001fa12c
- (void)streamHandlerDidClose:(id)arg1 withError:(id)arg2;	// IMP=0x00000001001f9eb0
- (void)streamHandler:(id)arg1 didReceiveStreamData:(id)arg2;	// IMP=0x00000001001f9e3c
- (void)streamHandler:(id)arg1 bufferSpaceChanged:(_Bool)arg2;	// IMP=0x00000001001f9db8
- (void)handleStreamResponse:(id)arg1;	// IMP=0x00000001001f9bb8
- (void)handleStreamRequest:(id)arg1;	// IMP=0x00000001001f9940
- (void)streamHandler:(id)arg1 didReceiveMessage:(id)arg2;	// IMP=0x00000001001f979c
- (void)netServiceBrowser:(id)arg1 didFindService:(id)arg2 moreComing:(_Bool)arg3;	// IMP=0x00000001001f96e4
- (int)setBufferSize:(int)arg1 socket:(int)arg2;	// IMP=0x00000001001f9680
@property(readonly) NSFileHandle *fileHandle; // @synthesize fileHandle=_fileHandle;
- (void)notifyStreamRequestWithError:(id)arg1;	// IMP=0x00000001001f914c
- (void)switchToStreaming;	// IMP=0x00000001001f90b8
- (void)sendInitialResponse:(_Bool)arg1;	// IMP=0x00000001001f8dac
- (void)sendInitialRequest;	// IMP=0x00000001001f8a24
- (void)startBrowser;	// IMP=0x00000001001f8948
- (void)getStreamsWithCompletionHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001001f88e4
- (void)setBundleID:(id)arg1;	// IMP=0x00000001001f8830
- (void)stopIfReady;	// IMP=0x00000001001f87e0
- (void)stop;	// IMP=0x00000001001f861c
- (void)start;	// IMP=0x00000001001f85e0
- (void)dealloc;	// IMP=0x00000001001f8594
- (id)initWithAuthorData:(id)arg1 streamHandler:(id)arg2;	// IMP=0x00000001001f846c
- (id)initWithStreamHandler:(id)arg1;	// IMP=0x00000001001f8458
