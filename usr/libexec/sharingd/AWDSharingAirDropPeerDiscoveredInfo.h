...
- (void).cxx_destruct;	// IMP=0x00000001001f1454
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001f0fb8
- (unsigned long long)hash;	// IMP=0x00000001001f0d34
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001f0984
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001f0628
- (void)copyTo:(id)arg1;	// IMP=0x00000001001f0320
- (void)writeTo:(id)arg1;	// IMP=0x00000001001f0064
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001f005c
- (id)dictionaryRepresentation;	// IMP=0x00000001001eef60
- (id)description;	// IMP=0x00000001001eeeac
