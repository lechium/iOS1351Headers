...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000afdf0
- (unsigned long long)hash;	// IMP=0x00000001000afc40
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000af9b8
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000af774
- (void)copyTo:(id)arg1;	// IMP=0x00000001000af574
- (void)writeTo:(id)arg1;	// IMP=0x00000001000af3a4
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000af39c
- (id)dictionaryRepresentation;	// IMP=0x00000001000ae800
- (id)description;	// IMP=0x00000001000ae74c
