...
+ (id)shared;	// IMP=0x000000010027d350
- (void).cxx_destruct;	// IMP=0x00000001002857e0
- (id)init;	// IMP=0x000000010027ec48
- (_Bool)acquireTokenForIdentifier:(unsigned long long)arg1;	// IMP=0x000000010027d390
