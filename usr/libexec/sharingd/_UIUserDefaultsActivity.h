...
- (void).cxx_destruct;	// IMP=0x000000010007f6ec
...
- (void)_prepareActivityViewControllerIfNeeded;	// IMP=0x000000010007f498
- (void)_cleanup;	// IMP=0x000000010007f488
- (void)_settingsViewControllerDidDismiss:(id)arg1;	// IMP=0x000000010007f478
- (void)activityDidFinish:(_Bool)arg1 items:(id)arg2 error:(id)arg3;	// IMP=0x000000010007f390
- (id)activityViewController;	// IMP=0x000000010007f35c
- (_Bool)canPerformWithActivityItems:(id)arg1;	// IMP=0x000000010007f354
- (id)_actionImage;	// IMP=0x000000010007f28c
- (id)_activityImage;	// IMP=0x000000010007f034
- (id)activityTitle;	// IMP=0x000000010007efac
- (id)activityType;	// IMP=0x000000010007ef9c
- (id)initWithUserDefaults:(id)arg1 activityCategory:(long long)arg2;	// IMP=0x000000010007eef8
