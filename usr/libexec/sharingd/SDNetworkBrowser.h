...
- (void).cxx_destruct;	// IMP=0x0000000100062db4
...
- (void)invalidate;	// IMP=0x0000000100062ba8
- (int)closeNode:(struct __SFNode *)arg1;	// IMP=0x0000000100062b20
- (int)removeNode:(struct __SFNode *)arg1;	// IMP=0x0000000100062ab8
- (int)addNode:(struct __SFNode *)arg1;	// IMP=0x0000000100062a50
@property(copy) NSDictionary *options;
@property long long mode;
- (id)sidebarChildren;	// IMP=0x0000000100062914
- (id)childrenForNode:(struct __SFNode *)arg1;	// IMP=0x000000010006289c
- (struct __SFNode *)copyRootNode;	// IMP=0x000000010006288c
- (int)openNode:(struct __SFNode *)arg1 forProtocol:(id)arg2 flags:(unsigned long long)arg3;	// IMP=0x000000010006270c
- (void)nodeBrowser:(id)arg1 nodesChangedForParent:(struct __SFNode *)arg2 protocol:(id)arg3 error:(int)arg4;	// IMP=0x0000000100062694
- (void)dealloc;	// IMP=0x0000000100062630
- (id)initWithKind:(id)arg1 rootNode:(struct __SFNode *)arg2;	// IMP=0x0000000100062550
