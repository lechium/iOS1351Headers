...
- (void).cxx_destruct;	// IMP=0x0000000100038b18
...
- (void)handleTimerFired;	// IMP=0x0000000100038938
- (void)invalidateResponseTimer;	// IMP=0x0000000100038860
- (void)restartResponseTimer:(unsigned long long)arg1;	// IMP=0x0000000100038664
- (id)dataFromUUID:(id)arg1;	// IMP=0x00000001000385e4
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2 useProxy:(_Bool)arg3 senderID:(id)arg4;	// IMP=0x0000000100038414
- (id)wrapPayload:(id)arg1 withType:(unsigned short)arg2;	// IMP=0x0000000100038400
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x00000001000383fc
- (void)start;	// IMP=0x00000001000383f8
- (void)invalidate;	// IMP=0x0000000100038274
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x0000000100038178
- (id)init;	// IMP=0x0000000100038110
