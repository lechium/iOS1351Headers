...
- (void).cxx_destruct;	// IMP=0x000000010015820c
...
- (void)stop;	// IMP=0x0000000100158178
- (int)start;	// IMP=0x00000001001580c8
- (void)eject;	// IMP=0x0000000100157e94
- (void)ejectMountPoints:(id)arg1 useAssistant:(_Bool)arg2;	// IMP=0x0000000100157e90
- (void)notifyClientAboutEject:(int)arg1;	// IMP=0x0000000100157d10
- (void)dealloc;	// IMP=0x0000000100157cc8
- (id)initWithNode:(struct __SFNode *)arg1;	// IMP=0x0000000100157c54
