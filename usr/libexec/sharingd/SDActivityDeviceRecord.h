...
- (void).cxx_destruct;	// IMP=0x000000010004a940
...
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 isReplay:(_Bool)arg3 newAdvertisementHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100049a0c
- (void)updateWithRawAdvertisementData:(id)arg1 receivedViaScanning:(_Bool)arg2 newAdvertisementHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001000499b0
- (id)description;	// IMP=0x00000001000498c0
- (id)initWithDevice:(id)arg1;	// IMP=0x0000000100049824
