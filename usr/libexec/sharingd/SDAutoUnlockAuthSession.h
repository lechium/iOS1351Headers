...
- (void).cxx_destruct;	// IMP=0x00000001001d9a0c
...
- (id)peerListFromAWDLInfo:(id)arg1;	// IMP=0x00000001001d90ac
- (void)sendData:(id)arg1 bleDevice:(id)arg2 direct:(_Bool)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001001d8bbc
- (void)sendData:(id)arg1 bleDevice:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001d8b4c
- (void)sendAWDLInfo:(_Bool)arg1;	// IMP=0x00000001001d841c
- (void)sendAWDLInfo;	// IMP=0x00000001001d840c
- (void)sendData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001d8344
- (void)sendData:(id)arg1 type:(unsigned short)arg2 errorHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001d8228
- (void)sendAWDLInfoData:(id)arg1 type:(unsigned short)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x00000001001d81d0
- (void)_start;	// IMP=0x00000001001d81c4
- (void)start;	// IMP=0x00000001001d8138
- (id)getAppName;	// IMP=0x00000001001d8130
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x00000001001d812c
- (void)connectionActivated;	// IMP=0x00000001001d8128
- (void)invalidate;	// IMP=0x00000001001d8018
- (id)initWithDevice:(id)arg1 sessionID:(id)arg2 bleDevice:(id)arg3;	// IMP=0x00000001001d7f50
