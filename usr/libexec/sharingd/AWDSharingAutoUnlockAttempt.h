...
- (void).cxx_destruct;	// IMP=0x0000000100143ccc
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001433cc
- (unsigned long long)hash;	// IMP=0x0000000100142e40
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100142668
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100141fd8
- (void)copyTo:(id)arg1;	// IMP=0x00000001001419ac
- (void)writeTo:(id)arg1;	// IMP=0x0000000100141418
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100141410
- (id)dictionaryRepresentation;	// IMP=0x000000010013eed0
- (id)description;	// IMP=0x000000010013ee1c
