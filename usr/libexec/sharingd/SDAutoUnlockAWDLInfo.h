...
- (void).cxx_destruct;	// IMP=0x00000001000feca8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000fea90
- (unsigned long long)hash;	// IMP=0x00000001000fe95c
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000fe75c
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000fe5bc
- (void)copyTo:(id)arg1;	// IMP=0x00000001000fe460
- (void)writeTo:(id)arg1;	// IMP=0x00000001000fe324
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000fe31c
- (id)dictionaryRepresentation;	// IMP=0x00000001000fdb4c
- (id)description;	// IMP=0x00000001000fda98
