...
- (void).cxx_destruct;	// IMP=0x00000001000ae2ec
...
- (void)service:(id)arg1 nearbyDevicesChanged:(id)arg2;	// IMP=0x00000001000ae1dc
- (void)service:(id)arg1 devicesChanged:(id)arg2;	// IMP=0x00000001000ae05c
- (void)nearbyServiceDevicesChanged:(id)arg1;	// IMP=0x00000001000adba0
- (void)activityServiceDevicesChanged:(id)arg1;	// IMP=0x00000001000adb9c
- (id)idsDeviceFromBTIdentifier:(id)arg1;	// IMP=0x00000001000ad85c
- (void)stop;	// IMP=0x00000001000ad858
- (_Bool)restart;	// IMP=0x00000001000ad850
- (void)start;	// IMP=0x00000001000ad84c
- (id)init;	// IMP=0x00000001000ad7b0
