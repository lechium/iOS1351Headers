...
- (void).cxx_destruct;	// IMP=0x000000010018e308
...
- (unsigned long long)hash;	// IMP=0x000000010018e10c
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018e034
- (id)description;	// IMP=0x000000010018df30
- (void)dealloc;	// IMP=0x000000010018de78
- (id)initWithDictRepresentation:(id)arg1;	// IMP=0x000000010018dc84
