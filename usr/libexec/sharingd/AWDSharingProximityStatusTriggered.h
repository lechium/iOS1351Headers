...
- (void).cxx_destruct;	// IMP=0x00000001000ed364
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000ece14
- (unsigned long long)hash;	// IMP=0x00000001000ecaf8
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000ec688
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000ec294
- (void)copyTo:(id)arg1;	// IMP=0x00000001000ebedc
- (void)writeTo:(id)arg1;	// IMP=0x00000001000ebb7c
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000ebb74
- (id)dictionaryRepresentation;	// IMP=0x00000001000ea434
- (id)description;	// IMP=0x00000001000ea380
