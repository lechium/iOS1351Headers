...
- (void).cxx_destruct;	// IMP=0x00000001001db568
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001db2e0
- (unsigned long long)hash;	// IMP=0x00000001001db170
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001daf38
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001001dad48
- (void)copyTo:(id)arg1;	// IMP=0x00000001001dab9c
- (void)writeTo:(id)arg1;	// IMP=0x00000001001daa18
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001001daa10
- (id)dictionaryRepresentation;	// IMP=0x00000001001da06c
- (id)description;	// IMP=0x00000001001d9fb8
