...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100064b24
- (void).cxx_destruct;	// IMP=0x0000000100064fc0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100064dfc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100064b2c
