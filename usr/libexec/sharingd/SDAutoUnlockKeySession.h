...
- (void).cxx_destruct;	// IMP=0x0000000100044074
...
- (void)logAutoUnlockEnd;	// IMP=0x0000000100043bd4
- (void)logAutoUnlockStart;	// IMP=0x0000000100043a84
- (void)invalidateAssertionTimer;	// IMP=0x00000001000439ac
- (void)restartAssertionTimer;	// IMP=0x0000000100043794
- (void)releaseIdleSleepAssertion;	// IMP=0x00000001000436ec
- (void)declareSystemActivityAssertion;	// IMP=0x0000000100043488
- (void)sendConfirmationACK;	// IMP=0x0000000100043250
- (void)sendSessionAuthToken:(id)arg1 error:(id)arg2;	// IMP=0x0000000100042db0
- (void)sendKeyExchangeRequestWithData:(id)arg1 error:(id)arg2;	// IMP=0x0000000100042a64
- (void)sendAuthPromptResponseWithData:(id)arg1 error:(id)arg2;	// IMP=0x0000000100042740
- (void)sendAWDLInfoWithKeyData:(id)arg1 error:(id)arg2;	// IMP=0x00000001000420ac
- (void)handleUnlockConfirmation:(id)arg1;	// IMP=0x0000000100041c88
- (void)createAuthTokenIfReady;	// IMP=0x0000000100041548
- (void)handleSessionKeyExchangeResponse:(id)arg1;	// IMP=0x00000001000412d8
- (void)handleAuthPromptImageData:(id)arg1;	// IMP=0x0000000100041014
- (void)handleAuthPromptRequest:(id)arg1;	// IMP=0x0000000100040b90
- (_Bool)handleAWDLInfo:(id)arg1;	// IMP=0x00000001000407cc
- (void)handleMessageWithWrapper:(id)arg1;	// IMP=0x000000010004013c
- (void)handleWiFiRequestInvalidated;	// IMP=0x00000001000400f4
- (void)handleWiFiRequestStartedWithStartAWDLHandler:(CDUnknownBlockType)arg1;	// IMP=0x00000001000400c0
- (void)awdlNetworkStarted;	// IMP=0x000000010003fef4
- (void)createWiFiRequest;	// IMP=0x000000010003f8e8
- (void)alertOfUnlock;	// IMP=0x000000010003f7d4
- (void)promptForApproval;	// IMP=0x000000010003f7d0
- (void)deviceDisconnected:(id)arg1;	// IMP=0x000000010003f558
- (void)removeObservers;	// IMP=0x000000010003f508
- (void)addObservers;	// IMP=0x000000010003f4a0
- (void)beginAKSSession;	// IMP=0x000000010003f49c
- (void)notifyDelegateWithError:(id)arg1;	// IMP=0x000000010003f2c8
- (_Bool)keyCanUnlock;	// IMP=0x000000010003f2c0
- (void)_invalidate;	// IMP=0x000000010003f08c
- (void)invalidate;	// IMP=0x000000010003f008
- (id)initWithBLEDevice:(id)arg1 sessionID:(id)arg2;	// IMP=0x000000010003ed40
