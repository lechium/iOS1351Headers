...
- (void).cxx_destruct;	// IMP=0x0000000100129224
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001001290c4
- (unsigned long long)hash;	// IMP=0x0000000100128fec
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100128e84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100128d60
- (void)copyTo:(id)arg1;	// IMP=0x0000000100128c78
- (void)writeTo:(id)arg1;	// IMP=0x0000000100128ba4
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100128b9c
- (id)dictionaryRepresentation;	// IMP=0x0000000100128618
- (id)description;	// IMP=0x0000000100128564
