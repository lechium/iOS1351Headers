...
- (void).cxx_destruct;	// IMP=0x00000001002615ec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010026139c
- (unsigned long long)hash;	// IMP=0x0000000100261248
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100261024
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100260e5c
- (void)copyTo:(id)arg1;	// IMP=0x0000000100260cd8
- (void)writeTo:(id)arg1;	// IMP=0x0000000100260b78
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100260b70
- (id)dictionaryRepresentation;	// IMP=0x00000001002602a4
- (id)description;	// IMP=0x00000001002601f0
