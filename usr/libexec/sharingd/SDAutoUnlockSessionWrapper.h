...
- (void).cxx_destruct;	// IMP=0x000000010012bbd8
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010012b8f4
- (unsigned long long)hash;	// IMP=0x000000010012b778
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010012b504
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010012b2ec
- (void)copyTo:(id)arg1;	// IMP=0x000000010012b130
- (void)writeTo:(id)arg1;	// IMP=0x000000010012afa0
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010012af98
- (id)dictionaryRepresentation;	// IMP=0x000000010012a720
- (id)description;	// IMP=0x000000010012a66c
