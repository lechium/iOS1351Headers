...
@interface SDShareSheetSession : NSObject
{
    ...
    NSArray *_airDropPeople;	// 224 = 0xe0
    NSArray *_suggestedPeople;	// 232 = 0xe8
    NSArray *_shareActivities;	// 240 = 0xf0
    NSDictionary *_shareActivitiesByUUID;	// 248 = 0xf8
    NSArray *_shareActivitiesInUserOrder;	// 256 = 0x100
    NSArray *_visibleShareActivities;	// 264 = 0x108
    NSArray *_actionActivities;	// 272 = 0x110
    NSDictionary *_actionActivitiesByUUID;	// 280 = 0x118
    NSArray *_actionActivitiesInUserOrder;	// 288 = 0x120
    NSArray *_visibleActionActivities;	// 296 = 0x128
    NSArray *_favoriteApps;	// 304 = 0x130
    NSArray *_favoriteActions;	// 312 = 0x138
    NSArray *_airDropNodes;	// 320 = 0x140
    NSArray *_peopleNodes;	// 328 = 0x148
    NSArray *_hostShareActivityProxies;	// 336 = 0x150
    NSArray *_hostActionActivityProxies;	// 344 = 0x158
    NSMutableDictionary *_realNameToNodeID;	// 352 = 0x160
    NSMutableDictionary *_shareActivityToID;	// 360 = 0x168
    NSMutableDictionary *_actionActivityToID;	// 368 = 0x170
    NSNumber *_nearbyCountSlotID;	// 376 = 0x178
    NSMutableArray *_activeSecurityContexts;	// 384 = 0x180
    CDUnknownBlockType _disabledNodesUpdatedHandler;	// 392 = 0x188
}

- (void).cxx_destruct;	// IMP=0x000000010017c340
...
- (id)secondaryLabelColor;	// IMP=0x000000010017be20
- (id)labelColor;	// IMP=0x000000010017bd34
- (void)generateSpecialPreviewPhotoForRequestID:(long long)arg1;	// IMP=0x000000010017b8c0
- (_Bool)addAttributedString:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x000000010017b648
- (_Bool)addString:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x000000010017b438
- (_Bool)createURLPayloadForData:(id)arg1 ofType:(id)arg2 withAttachmentName:(id)arg3 description:(id)arg4 previewImage:(id)arg5 itemIndex:(int)arg6 completion:(CDUnknownBlockType)arg7;	// IMP=0x000000010017ae84
- (_Bool)addData:(id)arg1 ofType:(id)arg2 withAttachmentName:(id)arg3 description:(id)arg4 previewImage:(id)arg5 itemIndex:(int)arg6;	// IMP=0x000000010017ac28
- (_Bool)addImage:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x000000010017a848
- (_Bool)addURL:(id)arg1 withAttachmentName:(id)arg2 description:(id)arg3 previewImage:(id)arg4 itemIndex:(int)arg5;	// IMP=0x000000010017a328
- (_Bool)isValidPayload:(id)arg1 toPerson:(id)arg2 invalidMessage:(id *)arg3;	// IMP=0x0000000100179840
- (void)resetAfterAirDropTransfer;	// IMP=0x00000001001797a8
- (void)startSendForNode:(id)arg1 WithItems:(id)arg2 itemData:(id)arg3;	// IMP=0x0000000100178d64
@property(readonly, nonatomic) NSString *hostAppBundleID;
- (id)_orderedActivitiesIncludingUserDisabledExtensionsForAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0000000100178cc4
- (void)_loadPresentableActivitiesForAuditToken:(CDStruct_4c969caf)arg1;	// IMP=0x0000000100178c08
- (id)_orderedAvailableActivitiesForAuditToken:(CDStruct_4c969caf)arg1 WithMatchingContextCustomizationBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100178998
- (void)checkPolicyForAirDropPeople;	// IMP=0x000000010017862c
- (void)checkPolicyForSuggestedPeople;	// IMP=0x0000000100178154
- (void)updatePoliciesByActivityType:(id)arg1;	// IMP=0x0000000100177cd4
- (void)nodesPotentiallyUpdated;	// IMP=0x0000000100177c58
- (void)systemRestrictionsChanged:(id)arg1;	// IMP=0x000000010017791c
- (void)removeStatusMonitorObservers;	// IMP=0x00000001001778cc
- (void)addStatusMonitorObservers;	// IMP=0x0000000100177830
- (void)_deactivateSecurityContext:(id)arg1;	// IMP=0x00000001001777c8
- (void)_activateSecurityContext:(id)arg1;	// IMP=0x0000000100177760
- (id)description;	// IMP=0x00000001001776a8
- (void)invalidate;	// IMP=0x0000000100177558
- (void)activate;	// IMP=0x00000001001773e8
- (id)init;	// IMP=0x0000000100177150
