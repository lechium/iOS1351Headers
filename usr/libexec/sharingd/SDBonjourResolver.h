...
- (void).cxx_destruct;	// IMP=0x000000010025351c
...
- (void)cancel;	// IMP=0x0000000100253420
- (void)resolve;	// IMP=0x0000000100252f58
- (void)parseResults:(const char *)arg1 port:(unsigned short)arg2 txtLen:(unsigned short)arg3 txtRecord:(const char *)arg4 interface:(unsigned int)arg5;	// IMP=0x0000000100252b8c
- (void)notifyClient:(int)arg1;	// IMP=0x0000000100252b3c
- (void)dealloc;	// IMP=0x0000000100252af0
- (id)initWithName:(id)arg1 type:(id)arg2 domain:(id)arg3 path:(id)arg4 timeout:(_Bool)arg5;	// IMP=0x00000001002529b0
