...
- (void).cxx_destruct;	// IMP=0x00000001000dc43c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x00000001000dc1c4
- (unsigned long long)hash;	// IMP=0x00000001000dc048
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001000dbe04
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000dbc18
- (void)copyTo:(id)arg1;	// IMP=0x00000001000dba68
- (void)writeTo:(id)arg1;	// IMP=0x00000001000db8e0
- (_Bool)readFrom:(id)arg1;	// IMP=0x00000001000db8d8
- (id)dictionaryRepresentation;	// IMP=0x00000001000dae70
- (id)description;	// IMP=0x00000001000dadbc
