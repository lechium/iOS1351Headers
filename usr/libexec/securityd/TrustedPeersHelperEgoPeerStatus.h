...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100172034
- (void).cxx_destruct;	// IMP=0x0000000100171ff8
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100171dfc
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100171a6c
- (id)description;	// IMP=0x00000001001719f8
- (id)initWithEgoPeerID:(id)arg1 status:(unsigned long long)arg2 viablePeerCountsByModelID:(id)arg3 peerCountsByMachineID:(id)arg4 isExcluded:(_Bool)arg5 isLocked:(_Bool)arg6;	// IMP=0x00000001001717f8
