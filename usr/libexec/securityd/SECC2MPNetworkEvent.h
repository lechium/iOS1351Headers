...
- (void).cxx_destruct;	// IMP=0x000000010016786c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100166ea8
- (unsigned long long)hash;	// IMP=0x0000000100166980
- (_Bool)isEqual:(id)arg1;	// IMP=0x00000001001661f0
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100165b2c
- (void)copyTo:(id)arg1;	// IMP=0x00000001001654ec
- (void)writeTo:(id)arg1;	// IMP=0x0000000100164f50
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100164f48
- (id)dictionaryRepresentation;	// IMP=0x00000001001643b8
- (id)description;	// IMP=0x0000000100164304
