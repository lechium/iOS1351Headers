...
- (void).cxx_destruct;	// IMP=0x00000001000bdc64
...
- (void)proceedWithKeys:(id)arg1 tlkShares:(id)arg2 salt:(id)arg3;	// IMP=0x00000001000bd924
- (void)proceedWithRecoveryKeyID:(id)arg1;	// IMP=0x00000001000bd75c
- (void)groupStart;	// IMP=0x00000001000bd1ec
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 recoveryKey:(id)arg4;	// IMP=0x00000001000bd0d0
