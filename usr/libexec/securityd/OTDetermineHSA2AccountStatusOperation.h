...
- (void).cxx_destruct;	// IMP=0x000000010012e86c
...
- (void)groupStart;	// IMP=0x000000010012e2d8
- (id)initWithDependencies:(id)arg1 stateIfHSA2:(id)arg2 stateIfNotHSA2:(id)arg3 stateIfNoAccount:(id)arg4 errorState:(id)arg5;	// IMP=0x000000010012e190
