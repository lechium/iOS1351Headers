...
- (void).cxx_destruct;	// IMP=0x00000001000bc9b8
...
- (id)description;	// IMP=0x00000001000bc86c
- (id)initWithFlag:(id)arg1 conditions:(unsigned long long)arg2;	// IMP=0x00000001000bc7e0
- (id)initWithFlag:(id)arg1 delayInSeconds:(double)arg2;	// IMP=0x00000001000bc728
