...
- (void).cxx_destruct;	// IMP=0x000000010009c954
...
- (void)cancel;	// IMP=0x000000010009c6a4
- (void)sendChangesToClient:(id)arg1 moreComing:(_Bool)arg2;	// IMP=0x000000010009c184
- (void)performFetch;	// IMP=0x000000010009baa8
- (void)groupStart;	// IMP=0x000000010009b884
- (void)queryClientsForChangeTokens;	// IMP=0x000000010009b3c0
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 clients:(id)arg3 fetchReasons:(id)arg4 apnsPushes:(id)arg5 forceResync:(_Bool)arg6 ckoperationGroup:(id)arg7;	// IMP=0x000000010009affc
- (id)init;	// IMP=0x000000010009afe4
