...
- (void).cxx_destruct;	// IMP=0x00000001000d60f0
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000d5e00
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 backupWrappedKey:(id)arg4 error:(id *)arg5;	// IMP=0x00000001000d5b98
