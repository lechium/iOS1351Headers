...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100171220
- (void).cxx_destruct;	// IMP=0x00000001001711f0
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100171018
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100170eb0
- (id)description;	// IMP=0x0000000100170d7c
- (id)initWithPeerID:(id)arg1 isPreapproved:(_Bool)arg2 status:(unsigned long long)arg3 memberChanges:(_Bool)arg4 unknownMachineIDs:(_Bool)arg5 osVersion:(id)arg6;	// IMP=0x0000000100170ca8
