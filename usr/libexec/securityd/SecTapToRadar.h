...
+ (_Bool)askUserIfTTR:(id)arg1;	// IMP=0x000000010001f8e4
+ (void)triggerTapToRadar:(id)arg1;	// IMP=0x000000010001f4a8
+ (void)disableTTRsEntirely;	// IMP=0x000000010001f4a4
+ (_Bool)isRateLimited:(id)arg1;	// IMP=0x000000010001f49c
+ (id)keyname:(id)arg1;	// IMP=0x000000010001f41c
- (void).cxx_destruct;	// IMP=0x000000010001f258
...
- (void)trigger;	// IMP=0x000000010001f150
- (void)clearRetryTimestamp;	// IMP=0x000000010001f0cc
- (void)updateRetryTimestamp;	// IMP=0x000000010001efec
- (_Bool)isRateLimited;	// IMP=0x000000010001eec4
- (id)initTapToRadar:(id)arg1 description:(id)arg2 radar:(id)arg3;	// IMP=0x000000010001ed58
