...
+ (id)trust;	// IMP=0x00000001001c6a24
- (void).cxx_destruct;	// IMP=0x00000001001c69e8
...
- (void)dealloc;	// IMP=0x00000001001c67ac
- (id)initWithRetirees:(id)arg1 fpi:(struct __OpaqueSOSFullPeerInfo *)arg2 circle:(struct __OpaqueSOSCircle *)arg3 departureCode:(int)arg4 peerExpansion:(id)arg5;	// IMP=0x00000001001c66b4
- (id)init;	// IMP=0x00000001001c65b8
