...
@class NSOperation, NSString, OTDeviceInformation, OTOperationDependencies, OTUpdateTrustedDeviceListOperation, TPPolicyVersion;
...
- (void).cxx_destruct;	// IMP=0x00000001000e92e8
...
- (void)proceedWithKeys:(id)arg1 pendingTLKShares:(id)arg2;	// IMP=0x00000001000e8d5c
- (void)afterSuccessfulAllowList;	// IMP=0x00000001000e8b6c
- (void)requestSilentEscrowUpdate;	// IMP=0x00000001000e8930
- (void)afterUpdate;	// IMP=0x00000001000e878c
- (void)handlePrepareErrors:(id)arg1 nextExpectedState:(id)arg2;	// IMP=0x00000001000e8614
- (void)afterPreflight;	// IMP=0x00000001000e83e8
- (void)afterPrepare;	// IMP=0x00000001000e823c
- (void)groupStart;	// IMP=0x00000001000e73f8
- (id)persistentKeyRef:(struct __SecKey *)arg1 error:(id *)arg2;	// IMP=0x00000001000e7340
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 ckksConflictState:(id)arg3 errorState:(id)arg4 deviceInfo:(id)arg5 policyOverride:(id)arg6;	// IMP=0x00000001000e71cc
