...
- (void).cxx_destruct;	// IMP=0x000000010008b1d0
...
- (void)cancel;	// IMP=0x000000010008b020
- (void)_onqueueTrigger:(unsigned long long)arg1 maximumDelay:(unsigned long long)arg2;	// IMP=0x000000010008aac0
- (void)trigger;	// IMP=0x000000010008a9f4
- (void)_onqueueTimerTick;	// IMP=0x000000010008a6c4
- (void)triggerAt:(unsigned long long)arg1;	// IMP=0x000000010008a5e8
- (void)waitUntil:(unsigned long long)arg1;	// IMP=0x000000010008a560
@property(readonly) NSDate *nextFireTime;
- (id)description;	// IMP=0x000000010008a37c
- (id)makeOperationDependency;	// IMP=0x000000010008a2a0
- (void)changeDelays:(unsigned long long)arg1 continuingDelay:(unsigned long long)arg2;	// IMP=0x000000010008a210
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 expontialBackoff:(double)arg3 maximumDelay:(unsigned long long)arg4 keepProcessAlive:(_Bool)arg5 dependencyDescriptionCode:(long long)arg6 block:(CDUnknownBlockType)arg7;	// IMP=0x000000010008a02c
- (id)initWithName:(id)arg1 initialDelay:(unsigned long long)arg2 continuingDelay:(unsigned long long)arg3 keepProcessAlive:(_Bool)arg4 dependencyDescriptionCode:(long long)arg5 block:(CDUnknownBlockType)arg6;	// IMP=0x0000000100089f84
- (id)initWithName:(id)arg1 delay:(unsigned long long)arg2 keepProcessAlive:(_Bool)arg3 dependencyDescriptionCode:(long long)arg4 block:(CDUnknownBlockType)arg5;	// IMP=0x0000000100089f04
