...
- (void)proceedWithKeys:(id)arg1 filteredTLKShares:(id)arg2;	// IMP=0x000000010006ad70
- (void)noteMetric:(id)arg1 count:(long long)arg2;	// IMP=0x000000010006abe4
- (void)proceedWithPeerID:(id)arg1;	// IMP=0x000000010006aa1c
- (void)groupStart;	// IMP=0x000000010006a39c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 bottleID:(id)arg4 entropy:(id)arg5 bottleSalt:(id)arg6;	// IMP=0x000000010006a228
