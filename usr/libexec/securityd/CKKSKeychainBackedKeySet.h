...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100170344
- (void).cxx_destruct;	// IMP=0x0000000100170308
...
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100170180
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100170060
- (id)description;	// IMP=0x000000010016ff7c
- (id)initWithTLK:(id)arg1 classA:(id)arg2 classC:(id)arg3 newUpload:(_Bool)arg4;	// IMP=0x000000010016fea4
