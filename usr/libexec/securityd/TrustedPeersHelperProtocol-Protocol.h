...
- (void)fetchCurrentPolicyWithContainer:(NSString *)arg1 context:(NSString *)arg2 reply:(void (^)(NSSet *, TPPolicy *, NSError *))arg3;
...
- (void)updateWithContainer:(NSString *)arg1 context:(NSString *)arg2 deviceName:(NSString *)arg3 serialNumber:(NSString *)arg4 osVersion:(NSString *)arg5 policyVersion:(NSNumber *)arg6 policySecrets:(NSDictionary *)arg7 reply:(void (^)(TrustedPeersHelperPeerState *, NSError *))arg8;
- (void)attemptPreapprovedJoinWithContainer:(NSString *)arg1 context:(NSString *)arg2 ckksKeys:(NSArray *)arg3 tlkShares:(NSArray *)arg4 preapprovedKeys:(NSArray *)arg5 reply:(void (^)(NSString *, NSArray *, NSSet *, TPPolicy *, NSError *))arg6;
- (void)preflightPreapprovedJoinWithContainer:(NSString *)arg1 context:(NSString *)arg2 reply:(void (^)(_Bool, NSError *))arg3;
- (void)joinWithContainer:(NSString *)arg1 context:(NSString *)arg2 voucherData:(NSData *)arg3 voucherSig:(NSData *)arg4 ckksKeys:(NSArray *)arg5 tlkShares:(NSArray *)arg6 preapprovedKeys:(NSArray *)arg7 reply:(void (^)(NSString *, NSArray *, NSSet *, TPPolicy *, NSError *))arg8;
...
- (void)preflightVouchWithRecoveryKeyWithContainer:(NSString *)arg1 context:(NSString *)arg2 recoveryKey:(NSString *)arg3 salt:(NSString *)arg4 reply:(void (^)(NSString *, NSSet *, TPPolicy *, NSError *))arg5;
...
- (void)preflightVouchWithBottleWithContainer:(NSString *)arg1 context:(NSString *)arg2 bottleID:(NSString *)arg3 reply:(void (^)(NSString *, NSSet *, TPPolicy *, NSError *))arg4;
...
- (void)establishWithContainer:(NSString *)arg1 context:(NSString *)arg2 ckksKeys:(NSArray *)arg3 tlkShares:(NSArray *)arg4 preapprovedKeys:(NSArray *)arg5 reply:(void (^)(NSString *, NSArray *, NSError *))arg6;
- (void)prepareWithContainer:(NSString *)arg1 context:(NSString *)arg2 epoch:(unsigned long long)arg3 machineID:(NSString *)arg4 bottleSalt:(NSString *)arg5 bottleID:(NSString *)arg6 modelID:(NSString *)arg7 deviceName:(NSString *)arg8 serialNumber:(NSString *)arg9 osVersion:(NSString *)arg10 policyVersion:(TPPolicyVersion *)arg11 policySecrets:(NSDictionary *)arg12 signingPrivKeyPersistentRef:(NSData *)arg13 encPrivKeyPersistentRef:(NSData *)arg14 reply:(void (^)(NSString *, NSData *, NSData *, NSData *, NSData *, NSSet *, TPPolicy *, NSError *))arg15;
