...
- (void).cxx_destruct;	// IMP=0x00000001000a1034
...
- (void)resetViews:(id)arg1;	// IMP=0x00000001000a0bf0
- (void)proceedWithKeys:(id)arg1 incompleteKeySets:(id)arg2 pendingTLKShares:(id)arg3;	// IMP=0x00000001000a06e4
- (void)groupStart;	// IMP=0x00000001000a0424
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x00000001000a033c
