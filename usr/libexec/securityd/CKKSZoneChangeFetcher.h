...
- (void).cxx_destruct;	// IMP=0x0000000100179d14
...
- (void)cancel;	// IMP=0x0000000100179ba4
- (void)holdFetchesUntil:(id)arg1;	// IMP=0x0000000100179b98
- (id)createSuccesfulFetchDependency;	// IMP=0x0000000100179b2c
- (void)_onqueueCreateNewFetch;	// IMP=0x00000001001793c8
- (void)maybeCreateNewFetch;	// IMP=0x000000010017934c
- (void)maybeCreateNewFetchOnQueue;	// IMP=0x00000001001791bc
- (id)requestSuccessfulFetchForManyReasons:(id)arg1;	// IMP=0x000000010017908c
- (id)requestFetchDueToAPNS:(id)arg1;	// IMP=0x0000000100178db4
- (id)requestSuccessfulFetch:(id)arg1;	// IMP=0x0000000100178d4c
- (id)clients;	// IMP=0x0000000100178b80
- (void)registerClient:(id)arg1;	// IMP=0x0000000100178aa4
- (id)description;	// IMP=0x0000000100178930
- (id)initWithContainer:(id)arg1 fetchClass:(Class)arg2 reachabilityTracker:(id)arg3;	// IMP=0x0000000100178620
