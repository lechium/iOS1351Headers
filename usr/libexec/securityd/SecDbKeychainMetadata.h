...
- (void).cxx_destruct;	// IMP=0x00000001000d5b8c
...
- (id)initWithData:(id)arg1;	// IMP=0x00000001000d57cc
- (id)initWithCiphertext:(id)arg1 wrappedKey:(id)arg2 tamperCheck:(id)arg3 error:(id *)arg4;	// IMP=0x00000001000d55d8
