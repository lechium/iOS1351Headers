...
+ (id)itemTypeForVersion:(int)arg1;	// IMP=0x00000001000422ac
+ (id)itemType;	// IMP=0x00000001000422a4
- (void).cxx_destruct;	// IMP=0x000000010004225c
...
- (id)managedItemTypeWithContext:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100042060
@property(readonly, copy) NSArray *syncableKeys;
@property(readonly, copy) NSArray *primaryKeys;
- (id)debugDescription;	// IMP=0x0000000100041f9c
- (id)description;	// IMP=0x0000000100041f58
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100041e64
- (id)_initWithName:(id)arg1 version:(int)arg2 primaryKeys:(id)arg3 syncableKeys:(id)arg4;	// IMP=0x0000000100041d40
