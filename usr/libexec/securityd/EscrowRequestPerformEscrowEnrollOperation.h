...
+ (void)cdpUploadPrerecord:(id)arg1 secretType:(unsigned long long)arg2 reply:(CDUnknownBlockType)arg3;	// IMP=0x00000001000965a8
...
- (void)groupStart;	// IMP=0x0000000100095870
- (_Bool)checkFatalError:(id)arg1;	// IMP=0x00000001000956e4
- (id)initWithIntendedState:(id)arg1 errorState:(id)arg2 enforceRateLimiting:(_Bool)arg3 lockStateTracker:(id)arg4;	// IMP=0x00000001000955ec
