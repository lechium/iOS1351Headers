...
+ (id)createFromProvider:(id)arg1;	// IMP=0x00000001000f7bf0
+ (id)noPeersState:(id)arg1;	// IMP=0x00000001000f7abc
- (void).cxx_destruct;	// IMP=0x00000001000f7a5c
...
- (id)description;	// IMP=0x00000001000f78cc
- (id)initWithPeerProviderID:(id)arg1 essential:(_Bool)arg2 selfPeers:(id)arg3 selfPeersError:(id)arg4 trustedPeers:(id)arg5 trustedPeersError:(id)arg6;	// IMP=0x00000001000f7654
