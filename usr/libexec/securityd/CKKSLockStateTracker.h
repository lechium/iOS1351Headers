...
+ (id)globalTracker;	// IMP=0x0000000100131d50
+ (_Bool)queryAKSLocked;	// IMP=0x0000000100131c50
- (void).cxx_destruct;	// IMP=0x00000001001318f4
...
- (void)addLockStateObserver:(id)arg1;	// IMP=0x00000001001317b8
- (_Bool)isLockedError:(id)arg1;	// IMP=0x0000000100131660
- (void)recheck;	// IMP=0x00000001001315e4
- (void)_onqueueRecheck;	// IMP=0x00000001001312ec
- (void)resetUnlockDependency;	// IMP=0x00000001001311fc
- (id)description;	// IMP=0x0000000100131138
@property(readonly) NSDate *lastUnlockTime;
@property(readonly) _Bool isLocked;
- (void)dealloc;	// IMP=0x0000000100130f58
