...
- (void).cxx_destruct;	// IMP=0x000000010008d96c
...
- (void)proceedWithKeys:(id)arg1 salt:(id)arg2;	// IMP=0x000000010008d660
- (void)groupStart;	// IMP=0x000000010008d180
- (id)initWithDependencies:(id)arg1 recoveryKey:(id)arg2;	// IMP=0x000000010008d0cc
