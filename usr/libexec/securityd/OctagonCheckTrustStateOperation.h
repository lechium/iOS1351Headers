...
- (void).cxx_destruct;	// IMP=0x000000010012fe3c
...
- (void)afterTPHTrustState:(id)arg1 trustedPeers:(id)arg2;	// IMP=0x000000010012ec9c
- (void)groupStart;	// IMP=0x000000010012ea8c
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3;	// IMP=0x000000010012e9a4
