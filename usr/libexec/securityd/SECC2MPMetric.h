...
- (void).cxx_destruct;	// IMP=0x0000000100087838
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100087574
- (unsigned long long)hash;	// IMP=0x0000000100087434
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100087224
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100087058
- (void)copyTo:(id)arg1;	// IMP=0x0000000100086ee0
- (void)writeTo:(id)arg1;	// IMP=0x0000000100086d8c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100086760
- (id)dictionaryRepresentation;	// IMP=0x000000010008640c
- (id)description;	// IMP=0x0000000100086358
...
- (int)StringAsMetricType:(id)arg1;	// IMP=0x0000000100086144
- (id)metricTypeAsString:(int)arg1;	// IMP=0x00000001000860cc
