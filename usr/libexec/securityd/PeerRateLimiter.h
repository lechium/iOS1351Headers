...
- (void).cxx_destruct;	// IMP=0x00000001001dc908
...
- (int)stateForAccessGroup:(id)arg1;	// IMP=0x00000001001dc78c
- (id)initWithPeer:(struct __OpaqueSOSPeer *)arg1;	// IMP=0x00000001001dc680
- (id)setUpConfigForPeer;	// IMP=0x00000001001dc5fc
