...
- (void).cxx_destruct;	// IMP=0x0000000100132b6c
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100132a30
- (unsigned long long)hash;	// IMP=0x00000001001329a4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100132878
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100132778
- (void)copyTo:(id)arg1;	// IMP=0x00000001001326dc
- (void)writeTo:(id)arg1;	// IMP=0x0000000100132650
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010013242c
- (id)dictionaryRepresentation;	// IMP=0x0000000100132350
- (id)description;	// IMP=0x000000010013229c
