...
- (void).cxx_destruct;	// IMP=0x00000001000a1800
...
- (void)groupStart;	// IMP=0x00000001000a13a0
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 peerUnknownState:(id)arg3 errorState:(id)arg4 retryFlag:(id)arg5;	// IMP=0x00000001000a1258
