...
- (void).cxx_destruct;	// IMP=0x000000010018d53c
...
- (id)eventsByTime;	// IMP=0x000000010018d188
- (id)eventsRelativeTime;	// IMP=0x000000010018cfa4
- (void)launch;	// IMP=0x000000010018cde8
- (void)reportMetric;	// IMP=0x000000010018cb18
- (void)addEvent:(id)arg1;	// IMP=0x000000010018c970
- (void)addAttribute:(id)arg1 value:(id)arg2;	// IMP=0x000000010018c81c
- (void)addDependantLaunch:(id)arg1 child:(id)arg2;	// IMP=0x000000010018c6a0
@property _Bool firstLaunch;
- (id)initWithRocketName:(id)arg1;	// IMP=0x000000010018c4c8
