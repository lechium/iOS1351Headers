...
- (void).cxx_destruct;	// IMP=0x0000000100121214
...
- (void)proceedWithKeys:(id)arg1;	// IMP=0x0000000100120d28
- (void)groupStart;	// IMP=0x0000000100120ad4
- (id)initWithDependencies:(id)arg1 intendedState:(id)arg2 errorState:(id)arg3 deviceInfo:(id)arg4 peerID:(id)arg5 permanentInfo:(id)arg6 permanentInfoSig:(id)arg7 stableInfo:(id)arg8 stableInfoSig:(id)arg9;	// IMP=0x00000001001208e0
