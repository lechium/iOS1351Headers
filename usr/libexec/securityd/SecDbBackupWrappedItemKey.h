...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000a32a4
- (void).cxx_destruct;	// IMP=0x00000001000a3274
...
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000a3168
- (void)encodeWithCoder:(id)arg1;	// IMP=0x00000001000a30b0
