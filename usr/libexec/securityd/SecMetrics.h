...
+ (id)managerObject;	// IMP=0x00000001001166b0
+ (id)c2MetricsEndpoint;	// IMP=0x000000010011651c
- (void).cxx_destruct;	// IMP=0x00000001001164e0
...
- (id)generateDeviceInfo;	// IMP=0x00000001001162d4
- (id)gzipEncode:(id)arg1;	// IMP=0x0000000100116134
- (id)requestForGenericEvent:(id)arg1;	// IMP=0x0000000100115ec0
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100115a68
- (id)getEvent:(id)arg1;	// IMP=0x0000000100115968
- (void)sendEvent:(id)arg1 pushTopic:(id)arg2;	// IMP=0x00000001001155f0
- (void)submitEvent:(id)arg1;	// IMP=0x00000001001155dc
- (id)init;	// IMP=0x00000001001154d0
