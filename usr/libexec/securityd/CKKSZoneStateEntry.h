...
+ (id)fromDatabaseRow:(id)arg1;	// IMP=0x0000000100070748
+ (id)sqlColumns;	// IMP=0x0000000100070680
+ (id)sqlTable;	// IMP=0x0000000100070674
+ (id)tryFromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x000000010007054c
+ (id)fromDatabase:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100070424
+ (id)state:(id)arg1;	// IMP=0x00000001000702c4
- (void).cxx_destruct;	// IMP=0x000000010007025c
...
- (id)sqlValues;	// IMP=0x000000010006fd48
- (id)whereClauseToFindSelf;	// IMP=0x000000010006fc9c
...
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010006f4e8
- (id)initWithCKZone:(id)arg1 zoneCreated:(_Bool)arg2 zoneSubscribed:(_Bool)arg3 changeToken:(id)arg4 moreRecordsInCloudKit:(_Bool)arg5 lastFetch:(id)arg6 lastFixup:(unsigned long long)arg7 encodedRateLimiter:(id)arg8;	// IMP=0x000000010006f370
