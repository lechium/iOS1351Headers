...
+ (id)stringFromAccountStatus:(long long)arg1;	// IMP=0x000000010003748c
+ (id)getCircleStatus;	// IMP=0x0000000100037368
+ (void)fetchCirclePeerID:(CDUnknownBlockType)arg1;	// IMP=0x00000001000372c4
- (void).cxx_destruct;	// IMP=0x00000001000355ac
...
- (void)setHSA2iCloudAccountStatus:(long long)arg1;	// IMP=0x0000000100035360
- (void)triggerOctagonStatusFetch;	// IMP=0x000000010003517c
- (id)checkForAllDeliveries;	// IMP=0x0000000100035060
- (void)notifyCircleStatusChangeAndWaitForSignal;	// IMP=0x0000000100035020
- (void)notifyCKAccountStatusChangeAndWaitForSignal;	// IMP=0x0000000100034fe0
- (void)_onqueueDeliverCurrentCloudKitState:(id)arg1 listenerQueue:(id)arg2 oldStatus:(id)arg3 group:(id)arg4;	// IMP=0x0000000100034e9c
- (void)_onqueueDeliverCloudKitStateChanges:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x0000000100034ce4
- (void)_onqueueUpdateAccountState:(id)arg1 dispatchGroup:(id)arg2;	// IMP=0x00000001000349f0
- (void)_onqueueUpdateAccountState:(id)arg1 deliveredSemaphore:(id)arg2;	// IMP=0x0000000100034868
- (void)_onqueueUpdateCirclePeerID:(id)arg1;	// IMP=0x0000000100034660
- (id)notifyCircleChange:(id)arg1;	// IMP=0x0000000100034558
- (void)_onqueueUpdateCKDeviceID:(id)arg1;	// IMP=0x00000001000343bc
- (id)notifyCKAccountStatusChange:(id)arg1;	// IMP=0x0000000100034294
- (id)registerForNotificationsOfCloudKitAccountStatusChange:(id)arg1;	// IMP=0x00000001000341a0
@property(readonly, copy) NSString *debugDescription;
@property(readonly, copy) NSString *description;
- (id)descriptionInternal:(id)arg1;	// IMP=0x0000000100033fe4
- (void)dealloc;	// IMP=0x0000000100033f68
- (void)performInitialDispatches;	// IMP=0x0000000100033ed8
- (id)init:(id)arg1 nsnotificationCenterClass:(Class)arg2;	// IMP=0x0000000100033b00
