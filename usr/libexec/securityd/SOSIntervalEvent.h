...
- (void).cxx_destruct;	// IMP=0x00000001001c01ac
...
- (id)initWithDefaults:(id)arg1 dateDescription:(id)arg2 earliest:(double)arg3 latest:(double)arg4;	// IMP=0x00000001001c0080
- (void)schedule;	// IMP=0x00000001001c0034
- (void)followup;	// IMP=0x00000001001bffec
- (_Bool)checkDate;	// IMP=0x00000001001bff88
- (id)getDate;	// IMP=0x00000001001bff74
