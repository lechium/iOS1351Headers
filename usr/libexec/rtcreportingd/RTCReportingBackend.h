...
+ (id)newBackendWithName:(id)arg1 profile:(id)arg2 productFamily:(id)arg3 clientType:(int)arg4;	// IMP=0x0000000100006020
...
- (unsigned long long)batchedEventsSize;	// IMP=0x00000001000069a0
- (_Bool)isBlacklistedEvent:(unsigned short)arg1;	// IMP=0x0000000100006864
- (_Bool)isWhitelistedEvent:(unsigned short)arg1;	// IMP=0x000000010000673c
- (void)setCorrelatedSessionID:(id)arg1;	// IMP=0x0000000100006730
- (_Bool)uploadLogData:(id)arg1;	// IMP=0x0000000100006728
- (_Bool)uploadFileAtPath:(id)arg1 extensionToken:(char *)arg2;	// IMP=0x0000000100006720
- (id)flushMessagesWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x00000001000066f4
- (id)sendMessage:(id)arg1 timestamp:(const struct timeval *)arg2 method:(unsigned short)arg3 respCode:(unsigned short)arg4 flag:(int)arg5;	// IMP=0x00000001000066d4
- (void)setStartTimestamp:(const struct timeval *)arg1;	// IMP=0x00000001000066ac
- (id)sendMessage:(id)arg1 timestamp:(const struct timeval *)arg2 method:(unsigned short)arg3 respCode:(unsigned short)arg4 eventID:(unsigned short)arg5 flag:(int)arg6;	// IMP=0x00000001000066a4
- (int)updateState;	// IMP=0x0000000100006680
@property int state;
- (void)setSelfVersion:(id)arg1;	// IMP=0x0000000100006484
- (void)setReportingSessionActivitySchedulerDelegate:(id)arg1;	// IMP=0x0000000100006478
- (void)dealloc;	// IMP=0x00000001000063b4
- (void)cleanup;	// IMP=0x00000001000063b0
- (id)initWithName:(id)arg1 profile:(id)arg2 productFamily:(id)arg3;	// IMP=0x00000001000062e4
- (id)convertIntoSHA256:(id)arg1;	// IMP=0x00000001000061f4
