...
- (void).cxx_destruct;	// IMP=0x0000000100092580
...
- (void)checkEnabledDevices;	// IMP=0x00000001000921a8
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x0000000100092024
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x0000000100091e68
- (void)linkIsSuspended:(id)arg1;	// IMP=0x0000000100091ce8
- (void)linkIsReady:(id)arg1;	// IMP=0x0000000100091b68
- (void)linkIsAvailable:(id)arg1;	// IMP=0x00000001000919ac
- (void)setup;	// IMP=0x0000000100091730
- (id)createFixedInterfaceLinkForNRUUID:(id)arg1;	// IMP=0x00000001000915dc
- (id)copyStatusString;	// IMP=0x00000001000913dc
- (id)copyName;	// IMP=0x00000001000913d0
- (void)dealloc;	// IMP=0x0000000100091334
- (void)invalidateManager;	// IMP=0x0000000100091300
- (void)cancel;	// IMP=0x0000000100091070
- (id)initManagerWithQueue:(id)arg1 managerDelegate:(id)arg2 fixedInterfaceName:(id)arg3 peerEndpoint:(id)arg4;	// IMP=0x0000000100090e7c
