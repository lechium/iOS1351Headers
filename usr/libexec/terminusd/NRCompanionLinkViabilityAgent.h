...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100036ac4
+ (id)agentDomain;	// IMP=0x0000000100036a80
+ (id)agentType;	// IMP=0x0000000100036a3c
- (void).cxx_destruct;	// IMP=0x0000000100036970
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100036834
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000367ec
- (_Bool)registerAgentWithActivate:(_Bool)arg1;	// IMP=0x0000000100036248
- (void)activateAgent;	// IMP=0x0000000100036120
- (void)suspendAgent;	// IMP=0x0000000100035ff8
- (_Bool)unregisterAgent;	// IMP=0x0000000100035e04
- (id)copyAgentData;	// IMP=0x0000000100035dfc
- (id)description;	// IMP=0x0000000100035c84
- (void)dealloc;	// IMP=0x0000000100035be0
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2;	// IMP=0x0000000100035704
