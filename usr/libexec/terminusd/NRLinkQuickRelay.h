...
- (void).cxx_destruct;	// IMP=0x000000010001fd88
...
- (void)session:(id)arg1 receivedInvitationDeclineFromID:(id)arg2;	// IMP=0x000000010001f26c
- (void)session:(id)arg1 receivedInvitationCancelFromID:(id)arg2;	// IMP=0x000000010001f094
- (void)session:(id)arg1 receivedInvitationAcceptFromID:(id)arg2;	// IMP=0x000000010001eebc
- (void)session:(id)arg1 didReceiveData:(id)arg2;	// IMP=0x000000010001ec68
- (void)sessionEnded:(id)arg1 withReason:(unsigned int)arg2 error:(id)arg3;	// IMP=0x000000010001e784
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010001e6cc
- (void)sessionStarted:(id)arg1;	// IMP=0x000000010001e0ec
- (void)service:(id)arg1 account:(id)arg2 inviteReceivedForSession:(id)arg3 fromID:(id)arg4 withOptions:(id)arg5;	// IMP=0x000000010001d9e8
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010001ce7c
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x000000010001cd58
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x000000010001cd54
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010001cd44
- (void)setPacketReceiver:(id)arg1;	// IMP=0x000000010001cac0
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x000000010001c680
- (void)readDatagramFromSession;	// IMP=0x000000010001c3b4
- (_Bool)writeDatagramToSession:(id)arg1;	// IMP=0x000000010001bfe4
- (_Bool)sendControlData:(id)arg1;	// IMP=0x000000010001bd50
- (void)setupIPsec;	// IMP=0x000000010001b834
- (void)setupIPsecClassC;	// IMP=0x000000010001b788
- (void)setupIPsecClassD;	// IMP=0x000000010001b6dc
- (void)setupIKEListener;	// IMP=0x000000010001b56c
- (void)setupIKEInitiatorSessionForClass:(unsigned char)arg1;	// IMP=0x000000010001b534
- (void)setupIKECallbacksForClass:(unsigned char)arg1;	// IMP=0x000000010001afec
- (void)restartIKESessionForClass:(unsigned char)arg1;	// IMP=0x000000010001ae64
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x000000010001adf8
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x000000010001acb4
- (void)handleIKEConnected;	// IMP=0x000000010001ab50
- (void)ikeSessionTimeoutSourceDisarm;	// IMP=0x000000010001aac4
- (void)armIKELinkTimeout;	// IMP=0x000000010001a8e0
- (void)handleLinkIdleTimeout;	// IMP=0x000000010001a7e4
- (void)armLinkIdleTimer;	// IMP=0x000000010001a584
- (void)linkIdleTimerDisarm;	// IMP=0x000000010001a4f8
- (_Bool)setupNexus;	// IMP=0x0000000100019194
- (void)sendInvitation;	// IMP=0x0000000100019000
- (void)reportEventToPowerLog:(int)arg1;	// IMP=0x0000000100018d94
- (void)invalidateIDSSession;	// IMP=0x0000000100018a70
- (void)invalidateConnection;	// IMP=0x000000010001891c
- (void)setupIDSSessionAndSendInvitation;	// IMP=0x000000010001853c
- (_Bool)setupIDSService;	// IMP=0x0000000100018358
- (_Bool)resume;	// IMP=0x0000000100018160
- (_Bool)suspend;	// IMP=0x0000000100017cd4
- (_Bool)start;	// IMP=0x0000000100017aa4
- (id)copyStatusString;	// IMP=0x0000000100016f70
- (unsigned short)metric;	// IMP=0x0000000100016f68
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x0000000100016c80
- (void)invalidateLink;	// IMP=0x00000001000167d4
- (void)dealloc;	// IMP=0x0000000100016738
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3;	// IMP=0x0000000100016494
