...
+ (id)agentFromData:(id)arg1;	// IMP=0x0000000100035490
+ (id)agentDomain;	// IMP=0x0000000100035460
+ (id)agentType;	// IMP=0x000000010003541c
- (void).cxx_destruct;	// IMP=0x00000001000351b8
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x0000000100035020
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x0000000100034fa0
- (_Bool)registerAgent;	// IMP=0x0000000100034ab0
- (_Bool)unregisterAgent;	// IMP=0x0000000100034918
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x0000000100034908
- (void)dealloc;	// IMP=0x00000001000348bc
- (id)initWithNRUUID:(id)arg1 queue:(id)arg2 delegate:(id)arg3;	// IMP=0x00000001000345cc
