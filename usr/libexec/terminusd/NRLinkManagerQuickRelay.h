...
- (void).cxx_destruct;	// IMP=0x0000000100094750
...
- (void)connection:(id)arg1 didChangeConnectedStatus:(_Bool)arg2;	// IMP=0x0000000100094554
- (void)connection:(id)arg1 didReceivePublicToken:(id)arg2;	// IMP=0x00000001000944a8
- (void)checkEnabledDevices;	// IMP=0x0000000100094294
- (void)linkDidReceiveData:(id)arg1 data:(id)arg2;	// IMP=0x000000010009412c
- (void)linkIsUnavailable:(id)arg1;	// IMP=0x0000000100093fdc
- (void)linkIsReady:(id)arg1;	// IMP=0x0000000100093ed4
- (void)linkIsSuspended:(id)arg1;	// IMP=0x0000000100093dcc
- (void)linkIsAvailable:(id)arg1;	// IMP=0x0000000100093c90
- (void)createLinkForNRUUID:(id)arg1;	// IMP=0x0000000100093bc0
- (void)createLinkIfApplicable;	// IMP=0x0000000100093788
- (void)setup;	// IMP=0x0000000100093320
- (id)copyStatusString;	// IMP=0x0000000100093210
- (id)copyName;	// IMP=0x0000000100093204
- (void)dealloc;	// IMP=0x0000000100093184
- (void)invalidateManager;	// IMP=0x0000000100093070
- (void)cancel;	// IMP=0x0000000100093038
- (id)initManagerWithQueue:(id)arg1 managerDelegate:(id)arg2 quickRelayManagerDelegate:(id)arg3;	// IMP=0x0000000100092e34
