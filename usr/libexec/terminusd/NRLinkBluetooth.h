...
@interface NRLinkBluetooth : NRLink <NENexusDelegate, NEIKEv2ListenerDelegate, NEIKEv2PacketDelegate>
{
    ...
    _Bool _dLinkInputSourceSuspended;	// 85 = 0x55
    _Bool _dLinkOutputSourceSuspended;	// 86 = 0x56
    _Bool _dDatagramLinkInputSourceSuspended;	// 87 = 0x57
    _Bool _dDatagramLinkOutputSourceSuspended;	// 88 = 0x58
    _Bool _datagramPipeNeeded;	// 89 = 0x59
    _Bool _dUrgentLinkInputSourceSuspended;	// 90 = 0x5a
    _Bool _dUrgentLinkOutputSourceSuspended;	// 91 = 0x5b
    _Bool _hasUrgentPrelude;	// 92 = 0x5c
    unsigned char _ringIdxToStart;	// 93 = 0x5d
    _Bool _shouldSuspend;	// 94 = 0x5e
    _Bool _isSuspended;	// 95 = 0x5f
    _Bool _pipeDisconnected;	// 96 = 0x60
    _Bool _hasConnectedPairingOnce;	// 97 = 0x61
    _Bool _hasFailedToConnectClassA;	// 98 = 0x62
    _Bool _remoteClassCUnlocked;	// 99 = 0x63
    _Bool _hasScheduledSendingLocalClassCUnlock;	// 100 = 0x64
    _Bool _requestedLocalPublicClassCKeysEncryptedWithIDS;	// 101 = 0x65
    _Bool _requestedLocalPublicClassAKeysEncryptedWithIDS;	// 102 = 0x66
    _Bool _isResponder;	// 103 = 0x67
    _Bool _lastKnownPeerIsAsleep;	// 104 = 0x68
    _Bool _didIssueFirstIsAsleepUpdate;	// 105 = 0x69
    unsigned short _remoteInnerLinkVersionHBO;	// 106 = 0x6a
    unsigned int _filledInLinkWriteBufferBytes;	// 108 = 0x6c
    unsigned int _handledLinkWriteBufferBytes;	// 112 = 0x70
    unsigned int _controlPacketCounter;	// 116 = 0x74
    unsigned int _filledInUrgentLinkWriteBufferBytes;	// 120 = 0x78
    unsigned int _handledUrgentLinkWriteBufferBytes;	// 124 = 0x7c
    int _controlDataSendQueueLen;	// 128 = 0x80
    unsigned int _filledInLinkReadBufferBytes;	// 132 = 0x84
    unsigned int _handledLinkReadBufferBytes;	// 136 = 0x88
    unsigned int _filledInUrgentLinkReadBufferBytes;	// 140 = 0x8c
    unsigned int _handledUrgentLinkReadBufferBytes;	// 144 = 0x90
...
- (void).cxx_destruct;	// IMP=0x000000010004c748
...
- (void)attemptPairingUsingOutOfBandKey:(id)arg1 completionBlock:(CDUnknownBlockType)arg2;	// IMP=0x000000010004aa90
- (void)setPacketReceiver:(id)arg1;	// IMP=0x000000010004a834
- (_Bool)sendPacketData:(id)arg1;	// IMP=0x000000010004a6ec
- (void)requestConfigurationForListener:(id)arg1 session:(id)arg2 sessionConfig:(id)arg3 childConfig:(id)arg4 validateAuthBlock:(CDUnknownBlockType)arg5 responseBlock:(CDUnknownBlockType)arg6;	// IMP=0x00000001000497c8
- (id)respondToIKESession:(id)arg1 dataProtectionClass:(unsigned char)arg2 validateAuthBlock:(CDUnknownBlockType)arg3;	// IMP=0x00000001000493a0
- (void)listener:(id)arg1 receivedNewSession:(id)arg2;	// IMP=0x00000001000492a4
- (_Bool)setupIPsec;	// IMP=0x0000000100049078
- (void)restartIKESessionForDataProtectionClass:(unsigned char)arg1;	// IMP=0x0000000100048eb0
- (void)scheduleIKESessionClassADueToConnectFailure;	// IMP=0x0000000100048c8c
- (void)restartIKESessionClassA;	// IMP=0x0000000100048c7c
- (void)restartIKESessionClassC;	// IMP=0x0000000100048c6c
- (void)restartIKESessionClassD;	// IMP=0x0000000100048c5c
- (void)setupIPsecInitiatorIfNecessary:(unsigned char)arg1;	// IMP=0x0000000100048310
- (void)setupIPsecForPairingInitiatorIfNecessary;	// IMP=0x0000000100048048
- (void)setupIKECallbacksPairing;	// IMP=0x0000000100047be4
- (void)sendlocalPublicClassAKeysEncryptedWithIDS;	// IMP=0x0000000100047998
- (void)sendlocalPublicClassCKeysEncryptedWithIDS;	// IMP=0x000000010004774c
- (void)setupIKECallbacksClassA;	// IMP=0x000000010004773c
- (void)setupIKECallbacksClassC;	// IMP=0x000000010004772c
- (void)setupIKECallbacksClassD;	// IMP=0x000000010004771c
- (void)setupIKECallbacks:(unsigned char)arg1;	// IMP=0x0000000100047168
- (void)reportRegistrationFailureIfNeededWithFailureCode:(long long)arg1 errorDescription:(id)arg2;	// IMP=0x000000010004714c
- (void)handleNotifyCode:(unsigned short)arg1 payload:(id)arg2;	// IMP=0x00000001000459e8
- (void)sendNotifyPayload;	// IMP=0x00000001000459e4
- (_Bool)sendAlwaysOnWiFiUpdate;	// IMP=0x00000001000457d4
- (id)copyNotifyPayloadsToSendWithProxy:(_Bool)arg1;	// IMP=0x0000000100045044
- (_Bool)sendControlData:(id)arg1;	// IMP=0x0000000100044df4
- (_Bool)handleIncomingIKEData:(id)arg1;	// IMP=0x0000000100044bb4
- (_Bool)sendIKEData:(id)arg1;	// IMP=0x00000001000448a8
- (void)handleRequestToActivateNexus:(id)arg1 fromFlow:(id)arg2;	// IMP=0x00000001000448a4
- (void)acceptNewFlow:(id)arg1 fromNexus:(id)arg2 completionHandler:(CDUnknownBlockType)arg3;	// IMP=0x0000000100044814
- (_Bool)appendEncapsulatedData:(id)arg1 type:(unsigned char)arg2;	// IMP=0x00000001000444a0
- (void)appendlinkOutgoingData:(id)arg1;	// IMP=0x0000000100044430
- (_Bool)sendData;	// IMP=0x0000000100044420
- (_Bool)sendDataWithCount:(unsigned int)arg1;	// IMP=0x00000001000441d8
- (void)stopReadingPackets;	// IMP=0x00000001000441c8
- (void)stopReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100044044
- (void)resumeReadingPackets;	// IMP=0x0000000100044034
- (void)resumeReadingPacketsWithCount:(unsigned int)arg1;	// IMP=0x0000000100043e8c
- (unsigned long long)writeBytesToChannel:(const char *)arg1 length:(unsigned long long)arg2;	// IMP=0x0000000100043c44
- (void)readDataFromChannelWithIsUrgent:(_Bool)arg1;	// IMP=0x00000001000439d8
- (void)readIncomingData:(char *)arg1 length:(unsigned long long)arg2 isUrgentLink:(_Bool)arg3;	// IMP=0x000000010004373c
- (void)handleIncoming6LoWPANData:(const char *)arg1 tlvBufferLength:(unsigned short)arg2 length:(unsigned short)arg3 tlvType:(unsigned char)arg4;	// IMP=0x00000001000433f0
- (void)handPacketToNexus:(id)arg1;	// IMP=0x00000001000433e4
- (void)writePacketToNexusChannel:(id)arg1;	// IMP=0x00000001000432e8
- (void)handleReadData:(_Bool)arg1;	// IMP=0x0000000100040f1c
- (void)flushPipeWithReason:(id)arg1;	// IMP=0x0000000100040e88
- (void)cleanupLinkReadBufferWithExtra:(unsigned int)arg1;	// IMP=0x0000000100040d04
- (void)armLinkStatsTimer;	// IMP=0x0000000100040be4
- (_Bool)setupNexus;	// IMP=0x0000000100040684
- (void)checkProxyAgentWithForceUpdate:(_Bool)arg1;	// IMP=0x00000001000405f0
- (void)addVirtualInterfaceRoutes;	// IMP=0x0000000100040418
- (void)handlePongSequenceNumber:(unsigned long long)arg1 receiveTime:(unsigned long long)arg2;	// IMP=0x0000000100040078
- (void)measureLatencyWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010003fc50
- (void)updateDatagramPipe:(id)arg1;	// IMP=0x000000010003f284
- (void)updateUrgentPipe:(id)arg1;	// IMP=0x000000010003e8e4
- (void)cleanupUrgentPipeState;	// IMP=0x000000010003e5e0
- (_Bool)setQosMarkingEnabled;	// IMP=0x000000010003e310
- (_Bool)setMPKLLoggingWithEnabled:(_Bool)arg1;	// IMP=0x000000010003e0c8
- (_Bool)setupNexusChannelVoice:(id)arg1;	// IMP=0x000000010003da78
- (_Bool)setupNexusChannelBestEffort:(id)arg1;	// IMP=0x000000010003d428
- (_Bool)setupNexusChannelBackground:(id)arg1;	// IMP=0x000000010003cdd8
- (_Bool)setupNexusChannelVideo:(id)arg1;	// IMP=0x000000010003c788
- (_Bool)validateChannelAttributes:(struct channel_attr *)arg1;	// IMP=0x000000010003bcc8
- (_Bool)setupNexusChannel;	// IMP=0x000000010003ba54
- (void)pipeDidDisconnect;	// IMP=0x000000010003ba40
- (_Bool)resume;	// IMP=0x000000010003b944
- (_Bool)suspend;	// IMP=0x000000010003b7d8
- (_Bool)cancelBecausePipeDisconnected;	// IMP=0x000000010003b668
- (_Bool)cancelWithReason:(id)arg1;	// IMP=0x000000010003b118
- (unsigned short)metric;	// IMP=0x000000010003b110
- (void)observeValueForKeyPath:(id)arg1 ofObject:(id)arg2 change:(id)arg3 context:(void *)arg4;	// IMP=0x000000010003af38
- (void)refreshCompanionProxyAgent;	// IMP=0x000000010003aeb0
- (void)dealloc;	// IMP=0x000000010003ae14
- (void)invalidateLink;	// IMP=0x000000010003aa04
- (void)invalidateNexusChannels;	// IMP=0x000000010003a408
- (void)invalidateIKESessionClassA;	// IMP=0x000000010003a3f8
- (void)invalidateIKESessionClassC;	// IMP=0x000000010003a3e8
- (void)invalidateIKESessionClassD;	// IMP=0x000000010003a3d8
- (id *)ikeSessionPointerForDataProtectionClass:(unsigned char)arg1;	// IMP=0x000000010003a280
- (void)invalidateIKESessionForClass:(unsigned char)arg1;	// IMP=0x000000010003a214
- (_Bool)start;	// IMP=0x00000001000386dc
- (id)copyShortDescriptionInner;	// IMP=0x00000001000385ec
- (id)copyDescriptionInner;	// IMP=0x0000000100038468
- (id)initLinkWithQueue:(id)arg1 linkDelegate:(id)arg2 nrUUID:(id)arg3 pipe:(id)arg4 remoteDeviceName:(id)arg5;	// IMP=0x0000000100037ef4
@property(readonly, nonatomic) _Bool hasValidPipe;
- (id)copyStatusString;	// IMP=0x0000000100036b0c
