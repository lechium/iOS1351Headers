...
- (id)initDTLSWithQueue:(id)arg1 server:(_Bool)arg2 delegate:(id)arg3;	// IMP=0x00000001000a1774
- (void)startDTLS;	// IMP=0x00000001000a12a8
- (void)handleIsReady;	// IMP=0x00000001000a1214
- (void)readOnDTLSConnection;	// IMP=0x00000001000a110c
- (void)readOnUDPConnection;	// IMP=0x00000001000a1004
- (void)retransmitOutboundEncryptedData:(id)arg1 retransmitCount:(unsigned int)arg2;	// IMP=0x00000001000a0f14
- (void)processInboundEncryptedData:(id)arg1;	// IMP=0x00000001000a0df0
- (void)processOutboundUnencryptedData:(id)arg1;	// IMP=0x00000001000a0ce0
- (id)description;	// IMP=0x00000001000a0c4c
