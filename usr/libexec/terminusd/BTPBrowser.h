...
- (void)handleReplyName:(id)arg1 type:(id)arg2 domain:(id)arg3 ifIndex:(unsigned int)arg4 add:(_Bool)arg5;	// IMP=0x0000000100003cf0
- (void)dealloc;	// IMP=0x0000000100003c6c
- (void)stop;	// IMP=0x0000000100003b0c
- (_Bool)start;	// IMP=0x0000000100003974
- (id)initWithSrcIfIndex:(unsigned int)arg1 dstIfIndex:(unsigned int)arg2 bonjourType:(id)arg3;	// IMP=0x0000000100003878
