...
@interface NRAnalyticsCmpnLinkBluetooth : NRAnalyticsCmpnLink
{
    ...
    _Bool _urgentPipeDisconnections;	// 103 = 0x67
...
@property(nonatomic) _Bool urgentPipeDisconnections; // @synthesize urgentPipeDisconnections=_urgentPipeDisconnections;
...
- (void)submit;	// IMP=0x000000010009cea8
