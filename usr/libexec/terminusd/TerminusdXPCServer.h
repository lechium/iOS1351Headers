...
+ (id)copySharedServer;	// IMP=0x000000010002d9d0
...
- (void)handleRequest:(id)arg1 onConnection:(id)arg2;	// IMP=0x00000001000275d0
- (void)startXPCListener;	// IMP=0x0000000100027298
- (void)registerHandlerFunctions;	// IMP=0x0000000100025dbc
- (void)registerHandlerFunction:(CDUnknownFunctionPointerType)arg1 type:(unsigned long long)arg2 allowedEntitlementGroup:(id)arg3;	// IMP=0x0000000100025984
- (id)initInternal;	// IMP=0x00000001000255bc
