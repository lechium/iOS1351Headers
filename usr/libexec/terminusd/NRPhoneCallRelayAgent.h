...
+ (id)agentFromData:(id)arg1;	// IMP=0x00000001000c5098
+ (id)agentDomain;	// IMP=0x00000001000c5054
+ (id)agentType;	// IMP=0x00000001000c5010
- (void).cxx_destruct;	// IMP=0x00000001000c4d00
...
- (void)unassertAgentWithOptions:(id)arg1;	// IMP=0x00000001000c4b7c
- (_Bool)assertAgentWithOptions:(id)arg1;	// IMP=0x00000001000c4afc
- (_Bool)registerAgent;	// IMP=0x00000001000c4650
- (_Bool)unregisterAgent;	// IMP=0x00000001000c44b8
@property(nonatomic) _Bool requiresAssert;
- (id)copyAgentData;	// IMP=0x00000001000c44a8
- (void)dealloc;	// IMP=0x00000001000c445c
- (id)initWithQueue:(id)arg1 delegate:(id)arg2;	// IMP=0x00000001000c418c
