...
- (void).cxx_destruct;	// IMP=0x000000010007659c
...
- (_Bool)cancelIfMatchesPrefix:(id)arg1 routerID:(unsigned long long)arg2 seqno:(unsigned short)arg3;	// IMP=0x000000010007640c
- (_Bool)cancelIfRouteUnselected;	// IMP=0x0000000100076330
- (void)dealloc;	// IMP=0x00000001000762b0
- (void)cancelWithDelay:(_Bool)arg1;	// IMP=0x000000010007617c
- (void)cancelTimer;	// IMP=0x0000000100076140
- (void)start;	// IMP=0x00000001000760b4
- (id)description;	// IMP=0x0000000100075fa8
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100075ed8
- (_Bool)matchesPrefix:(id)arg1 routerID:(unsigned long long)arg2;	// IMP=0x0000000100075eb4
- (id)initWithInstance:(id)arg1 prefix:(id)arg2 routerID:(unsigned long long)arg3;	// IMP=0x0000000100075c68
- (void)sendSeqnoReq;	// IMP=0x0000000100075b70
- (id)createTLV;	// IMP=0x0000000100075ac0
