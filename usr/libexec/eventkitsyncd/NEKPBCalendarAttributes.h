...
- (void).cxx_destruct;	// IMP=0x00000001000107b4
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010000fb88
- (unsigned long long)hash;	// IMP=0x000000010000f5e8
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010000ec84
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000e480
- (void)copyTo:(id)arg1;	// IMP=0x000000010000dd80
- (void)writeTo:(id)arg1;	// IMP=0x000000010000d740
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010000d738
- (id)dictionaryRepresentation;	// IMP=0x000000010000b7e0
- (id)description;	// IMP=0x000000010000b72c
