...
- (void).cxx_destruct;	// IMP=0x000000010003d89c
...
- (id)description;	// IMP=0x000000010003d6e8
- (void)terminateIfNotFinished;	// IMP=0x000000010003d618
- (void)terminate;	// IMP=0x000000010003d55c
- (id)pop;	// IMP=0x000000010003d448
- (void)conditionalPop:(CDUnknownBlockType)arg1;	// IMP=0x000000010003d1ac
- (void)finish;	// IMP=0x000000010003d0f0
- (_Bool)push:(id)arg1;	// IMP=0x000000010003ce88
- (id)initWithFIFOLength:(long long)arg1 name:(id)arg2;	// IMP=0x000000010003cda8
- (id)init;	// IMP=0x000000010003cd94
