...
+ (id)changeSetForReminder;	// IMP=0x00000001000475c0
+ (id)changeSetForEvent;	// IMP=0x00000001000475a4
- (void).cxx_destruct;	// IMP=0x0000000100047830
...
- (void)enumerateForChangeType:(int)arg1 forEntitiesOfClass:(Class)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x0000000100047794
- (id)description;	// IMP=0x00000001000476a4
