...
- (void).cxx_destruct;	// IMP=0x0000000100033d6c
...
- (id)description;	// IMP=0x0000000100033c60
- (id)dictionaryValue;	// IMP=0x0000000100033abc
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100033928
