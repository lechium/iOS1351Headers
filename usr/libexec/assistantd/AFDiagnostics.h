...
+ (id)sharedDiagnostics;	// IMP=0x00000001001b96bc
- (void).cxx_destruct;	// IMP=0x00000001001bb244
...
- (unsigned long long)_AWDTimestampTruncatedToHourPrecision;	// IMP=0x00000001001bb16c
- (double)_currentTime;	// IMP=0x00000001001bb110
- (void)_submitMetricWithIdentifier:(unsigned int)arg1 hotShipIdentifier:(unsigned int)arg2 hotShipTimestamp:(unsigned long long)arg3 generation:(CDUnknownBlockType)arg4;	// IMP=0x00000001001bafa0
- (void)_submitMetricWithIdentifier:(unsigned int)arg1 generation:(CDUnknownBlockType)arg2;	// IMP=0x00000001001bae9c
...
- (unsigned long long)_durationInMillisecondsFromTime:(double)arg1 toTime:(double)arg2;	// IMP=0x00000001001bae6c
- (void)logSpeechRecognized;	// IMP=0x00000001001bab60
- (void)logNetworkAnalyzeRunWithResults:(id)arg1;	// IMP=0x00000001001ba970
- (void)logVoiceSendEnd;	// IMP=0x00000001001ba698
- (void)logVoiceSendStart;	// IMP=0x00000001001ba4a0
- (void)logVoiceRecordingEnd;	// IMP=0x00000001001ba1c8
- (void)logVoiceRecordingStart;	// IMP=0x00000001001b9fd0
- (void)logConnectionFailedWithError:(id)arg1 connectionType:(long long)arg2;	// IMP=0x00000001001b9d2c
- (void)logConnectionOpenWithConnectionType:(long long)arg1;	// IMP=0x00000001001b9a90
- (void)logConnectionStart;	// IMP=0x00000001001b989c
- (void)flush;	// IMP=0x00000001001b9858
- (id)init;	// IMP=0x00000001001b9728
