...
- (void).cxx_destruct;	// IMP=0x00000001001bb390
...
- (unsigned long long)_durationInMillisecondsForDuration:(id)arg1;	// IMP=0x00000001001bb824
- (id)metricValue;	// IMP=0x00000001001bb408
