...
+ (Class)notificationPreviewRestrictedAppsType;	// IMP=0x000000010018d02c
+ (unsigned short)_ADPBDeviceRequestType;	// IMP=0x00000001001fb010
- (void).cxx_destruct;	// IMP=0x000000010018ffec
...
- (void)mergeFrom:(id)arg1;	// IMP=0x000000010018f7c8
- (unsigned long long)hash;	// IMP=0x000000010018f4b4
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010018ef48
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010018e9c8
- (void)copyTo:(id)arg1;	// IMP=0x000000010018e590
- (void)writeTo:(id)arg1;	// IMP=0x000000010018e160
- (_Bool)readFrom:(id)arg1;	// IMP=0x000000010018e158
- (id)dictionaryRepresentation;	// IMP=0x000000010018d230
- (id)description;	// IMP=0x000000010018d17c
...
- (id)notificationPreviewRestrictedAppsAtIndex:(unsigned long long)arg1;	// IMP=0x000000010018d014
- (unsigned long long)notificationPreviewRestrictedAppsCount;	// IMP=0x000000010018cffc
- (void)addNotificationPreviewRestrictedApps:(id)arg1;	// IMP=0x000000010018cf88
- (void)clearNotificationPreviewRestrictedApps;	// IMP=0x000000010018cf70
...
- (void)_ad_performWithSharedDataRemote:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002ba4c
@property(copy, nonatomic, setter=_ad_setData:) ADSharedData *_ad_data;
- (void)_ad_performWithCloudService:(id)arg1 fromPeer:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x00000001001f875c
