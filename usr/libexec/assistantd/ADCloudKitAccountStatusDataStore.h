...
- (void).cxx_destruct;	// IMP=0x000000010000fdc8
...
- (void)synchronizeUsingActivity:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000fd48
- (void)fetchDeviceTypesForAllLanguages:(CDUnknownBlockType)arg1;	// IMP=0x000000010000fd2c
- (void)fetchDeviceTypesForLanguage:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010000fd14
- (void)deleteUserData:(id)arg1;	// IMP=0x000000010000fc58
- (void)mergeDataWithModifiedRecords:(id)arg1 deletedRecordIDs:(id)arg2 containsAllChanges:(_Bool)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010000f480
- (void)synchronizeWithCompletion:(CDUnknownBlockType)arg1;	// IMP=0x000000010000f1dc
@property(retain, nonatomic) CKServerChangeToken *serverChangeToken;
@property(nonatomic) _Bool hasSetUpRecordZoneSubscription;
- (id)init;	// IMP=0x000000010000edc4
