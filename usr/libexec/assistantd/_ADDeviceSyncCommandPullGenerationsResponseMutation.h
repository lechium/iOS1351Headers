...
- (void).cxx_destruct;	// IMP=0x0000000100190724
- (id)generate;	// IMP=0x0000000100190670
- (void)setGenerationsByDataType:(id)arg1;	// IMP=0x000000010019063c
- (id)initWithBaseModel:(id)arg1;	// IMP=0x00000001001905c4
- (id)init;	// IMP=0x00000001001905b4
