...
- (void).cxx_destruct;	// IMP=0x00000001001e74e0
...
- (void)_setAudioFileIOTransactionState:(long long)arg1;	// IMP=0x00000001001e7194
- (void)_setSpeechRecognitionTransactionState:(long long)arg1;	// IMP=0x00000001001e6e88
- (void)dealloc;	// IMP=0x00000001001e6bb4
- (id)initWithUUID:(id)arg1 timestamp:(unsigned long long)arg2 languageCode:(id)arg3 options:(id)arg4 speechRequestOptions:(id)arg5;	// IMP=0x00000001001e6a88
- (id)init;	// IMP=0x00000001001e6a70
