...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000798b0
- (void).cxx_destruct;	// IMP=0x0000000100079e78
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100079bb8
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000798b8
