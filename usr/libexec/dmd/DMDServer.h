...
+ (id)sharedServer;	// IMP=0x0000000100077e88
- (void).cxx_destruct;	// IMP=0x0000000100078138
...
- (void)invalidate;	// IMP=0x000000010007801c
- (void)run;	// IMP=0x0000000100077ef4
- (id)init;	// IMP=0x0000000100077b78
