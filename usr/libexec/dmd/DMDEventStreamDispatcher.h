...
- (void).cxx_destruct;	// IMP=0x000000010004fabc
...
- (void)_dispatchToListenerForKey:(id)arg1 inMap:(id)arg2 withBlock:(CDUnknownBlockType)arg3;	// IMP=0x000000010004f8cc
- (void)_registerListener:(id)arg1 forKeys:(id)arg2 inMap:(id)arg3;	// IMP=0x000000010004f6b4
- (void)_registerEventStreamHandlers;	// IMP=0x000000010004ef0c
- (id)initWithListeners:(id)arg1;	// IMP=0x000000010004ec28
