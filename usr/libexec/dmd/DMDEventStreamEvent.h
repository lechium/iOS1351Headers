...
- (void).cxx_destruct;	// IMP=0x000000010004fdc0
...
- (id)eventStatusMessageWithPayloadIdentifier:(id)arg1;	// IMP=0x000000010004fc60
- (id)description;	// IMP=0x000000010004fbd4
- (id)initWithEventType:(id)arg1 details:(id)arg2;	// IMP=0x000000010004faf8
