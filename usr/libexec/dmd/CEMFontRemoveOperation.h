...
- (void).cxx_destruct;	// IMP=0x0000000100007acc
...
- (void)main;	// IMP=0x0000000100007944
- (id)initWithFontDeclaration:(id)arg1 installMetadata:(id)arg2;	// IMP=0x0000000100007890
