...
- (void)networkDidChange;	// IMP=0x00000001000415a4
- (void)keybagLockStateDidChange;	// IMP=0x0000000100041534
- (void)stopObservingChanges;	// IMP=0x00000001000414e8
- (void)startObservingChanges;	// IMP=0x00000001000410fc
@property(readonly, copy) NSString *description;
- (id)init;	// IMP=0x0000000100040ff8
