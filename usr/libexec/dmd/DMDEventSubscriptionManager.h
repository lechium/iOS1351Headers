...
- (void).cxx_destruct;	// IMP=0x00000001000505f4
...
- (id)eventStatusesByPayloadIdentifierSinceStartDate:(id)arg1 organizationIdentifier:(id)arg2;	// IMP=0x0000000100050380
- (_Bool)setEventSubscriptionRegistrations:(id)arg1 error:(id *)arg2;	// IMP=0x000000010004fe60
- (id)init;	// IMP=0x000000010004fdfc
