...
- (void).cxx_destruct;	// IMP=0x000000010004c5d4
...
- (void)delegateUpdatedDeclarationSourceAndEndOperation:(id)arg1;	// IMP=0x000000010004c3dc
- (void)main;	// IMP=0x000000010004bc48
