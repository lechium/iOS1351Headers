...
- (void).cxx_destruct;	// IMP=0x000000010000f3ec
...
- (id)_nextDateAfter:(id)arg1 matchingWeekday:(long long)arg2 hour:(long long)arg3 minute:(long long)arg4 second:(long long)arg5 inCalendar:(id)arg6;	// IMP=0x000000010000f164
- (id)_datesForNextCurfewBoundary;	// IMP=0x000000010000ed9c
- (void)_registerPredicateObserver;	// IMP=0x000000010000e9a0
- (_Bool)_extractComponentsFromPredicate:(id)arg1;	// IMP=0x000000010000e0b4
- (id)metadata;	// IMP=0x000000010000df6c
- (void)updateObserverRegistration;	// IMP=0x000000010000df60
- (void)invalidate;	// IMP=0x000000010000dde0
- (id)evaluatePredicateWithError:(id *)arg1;	// IMP=0x000000010000d8e8
- (id)initWithDelegate:(id)arg1 uniqueIdentifier:(id)arg2 curfewPredicate:(id)arg3;	// IMP=0x000000010000d7b4
