...
+ (_Bool)supportsSecureCoding;	// IMP=0x00000001000751ec
- (void).cxx_destruct;	// IMP=0x000000010007547c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100075360
- (id)initWithCoder:(id)arg1;	// IMP=0x00000001000751f4
