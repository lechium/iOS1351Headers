...
- (void).cxx_destruct;	// IMP=0x000000010004ebd4
...
- (void)startWithScheduleElapsedHandler:(CDUnknownBlockType)arg1;	// IMP=0x000000010004e9d0
- (unsigned long long)hash;	// IMP=0x000000010004e888
- (_Bool)isEqual:(id)arg1;	// IMP=0x000000010004e60c
- (id)description;	// IMP=0x000000010004e53c
- (void)dealloc;	// IMP=0x000000010004e4ec
- (id)initWithScheduleRegistration:(id)arg1;	// IMP=0x000000010004e1f4
