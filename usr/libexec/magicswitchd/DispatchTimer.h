...
- (void).cxx_destruct;	// IMP=0x000000010000c444
...
- (void)fireTimer;	// IMP=0x000000010000c3a0
- (void)scheduleTimer;	// IMP=0x000000010000c218
@property(readonly, nonatomic, getter=isWaking) _Bool waking;
- (void)invalidate;	// IMP=0x000000010000c1c4
- (void)dealloc;	// IMP=0x000000010000c16c
- (id)initWithIdentifier:(id)arg1 delay:(double)arg2 gracePeriod:(double)arg3 handlerBlock:(CDUnknownBlockType)arg4;	// IMP=0x000000010000c0a0
