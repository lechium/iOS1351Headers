...
- (id)description;	// IMP=0x000000010000e7cc
- (id)_stringFromISO15693AccessFilterList;	// IMP=0x000000010000e678
- (id)_stringFromArray:(id)arg1;	// IMP=0x000000010000e4f8
...
- (id)getAppInfoDictionary;	// IMP=0x000000010000e2ac
@property(readonly, copy, nonatomic) NSString *clientName;
- (unsigned int)validateISO15693TagAccessWithManufacturerCode:(unsigned long long)arg1;	// IMP=0x000000010000e158
- (unsigned int)validateISO15693TagAccessWithManufacturerCode:(unsigned long long)arg1 serialNumber:(id)arg2;	// IMP=0x000000010000de3c
- (unsigned int)validateISO15693TagAcesssWithUID:(id)arg1;	// IMP=0x000000010000dd40
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x000000010000dc28
- (void)dealloc;	// IMP=0x000000010000dbc0
- (id)initWithConnection:(id)arg1 coreNFCConnection:(_Bool)arg2;	// IMP=0x000000010000d6c0
- (id)initWithConnection:(id)arg1;	// IMP=0x000000010000d6b0
- (void)_initISO7816PermissibleAIDListWithSecTask:(struct __SecTask *)arg1 infoPlist:(id)arg2;	// IMP=0x000000010000d528
- (void)_initCoreNFCEntitlements:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x000000010000d2c4
- (_Bool)_isAIDStringValid:(id)arg1;	// IMP=0x000000010000cfbc
- (void)_initTagSpecifier:(id)arg1 maximumFilterStringLength:(unsigned long long)arg2;	// IMP=0x000000010000cccc
- (void)_initISO15693TagSpecifier:(id)arg1;	// IMP=0x000000010000ccbc
- (id)_createAccessDictionaryFromICCode:(id)arg1 serialNumber:(id)arg2 maximumFilterStringLength:(unsigned long long)arg3;	// IMP=0x000000010000ca48
- (id)_stringValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x000000010000c9dc
- (id)_arrayValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x000000010000c97c
- (_Bool)_boolValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x000000010000c910
- (void *)_copyValueOfEntitlement:(id)arg1 secTask:(struct __SecTask *)arg2;	// IMP=0x000000010000c6f4
