...
+ (void)initialize;	// IMP=0x0000000100026878
- (void).cxx_destruct;	// IMP=0x000000010002aed8
...
- (void)_networkStateChanged:(id)arg1;	// IMP=0x000000010002ac7c
- (void)_incrementRetryCountForType:(id)arg1;	// IMP=0x000000010002a9c4
- (int)_consecutiveRetryCountForType:(id)arg1;	// IMP=0x000000010002a91c
- (int)_retryCountForType:(id)arg1;	// IMP=0x000000010002a874
- (void)_scheduleRetryAfterTimeInterval:(double)arg1;	// IMP=0x000000010002a408
- (void)_networkCameUp;	// IMP=0x000000010002a000
- (void)_retryNow;	// IMP=0x0000000100029ecc
- (void)_retryTimerFired;	// IMP=0x0000000100029d64
- (double)_decayedWaitIntervalForRetryCount:(long long)arg1;	// IMP=0x0000000100029cc0
- (void)checkAndScheduleRetries;	// IMP=0x00000001000291d4
- (void)_disablePowerAssertion;	// IMP=0x0000000100029120
- (void)_enablePowerAssertion;	// IMP=0x000000010002906c
- (void)_endXPCTransaction;	// IMP=0x0000000100028fb8
- (void)_beginXPCTransaction;	// IMP=0x0000000100028f04
- (id)_basicAuthValue;	// IMP=0x0000000100028ab8
- (void)cancel;	// IMP=0x00000001000288b4
- (void)send;	// IMP=0x0000000100027374
@property(readonly, nonatomic) long long responseErrorType;
- (_Bool)canReplace:(id)arg1;	// IMP=0x0000000100027150
- (id)authTokenType;	// IMP=0x00000001000270d4
...
- (id)urlSession;	// IMP=0x00000001000268e0
- (void)deinitializeRequest;	// IMP=0x0000000100026730
- (void)dealloc;	// IMP=0x0000000100026698
- (id)initWithProvider:(id)arg1;	// IMP=0x0000000100026588
- (id)init;	// IMP=0x0000000100026578
