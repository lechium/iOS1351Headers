...
- (void).cxx_destruct;	// IMP=0x000000010000861c
...
- (void)_teardown;	// IMP=0x00000001000084a4
- (void)deinitializeProvider;	// IMP=0x00000001000084a0
- (void)accountDidChange;	// IMP=0x000000010000849c
- (void)accountDeactivated;	// IMP=0x0000000100008490
@property(readonly, nonatomic) NSString *serviceName;
- (void)stop;	// IMP=0x0000000100008478
- (void)start;	// IMP=0x0000000100008014
