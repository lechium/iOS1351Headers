...
- (void).cxx_destruct;	// IMP=0x00000001000261f0
...
- (void)copyInfoFromAccount:(id)arg1;	// IMP=0x0000000100025f60
- (_Bool)hasSameRelevantInfoAs:(id)arg1;	// IMP=0x0000000100025950
- (_Bool)isValid;	// IMP=0x00000001000258e0
...
- (id)uniqueId;	// IMP=0x00000001000256e4
