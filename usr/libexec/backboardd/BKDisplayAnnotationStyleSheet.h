...
- (void).cxx_destruct;	// IMP=0x0000000100026c64
...
- (id)newLayerForContent:(id)arg1 scale:(double)arg2;	// IMP=0x0000000100026a7c
- (void)sizeLayer:(id)arg1 toFitAtScale:(double)arg2;	// IMP=0x00000001000269b8
- (void)applyToLayer:(id)arg1 forContent:(id)arg2;	// IMP=0x000000010002692c
