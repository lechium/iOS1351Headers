...
+ (id)accessibilityHIDServices;	// IMP=0x00000001000845d8
- (void).cxx_destruct;	// IMP=0x00000001000845a8
...
- (id)initWithSenderID:(unsigned long long)arg1;	// IMP=0x00000001000844a4
