...
- (_Bool)isComplete;	// IMP=0x000000010004e500
- (void)stop;	// IMP=0x000000010004e494
- (void)start;	// IMP=0x000000010004e3c4
- (void)displayLinkFired:(id)arg1;	// IMP=0x000000010004e2c4
- (id)initWithRelativeTranslation:(struct CGPoint)arg1 destinationPoint:(struct CGPoint)arg2 animationDriver:(id)arg3 updateRate:(long long)arg4 applierBlock:(CDUnknownBlockType)arg5 completionBlock:(CDUnknownBlockType)arg6;	// IMP=0x000000010004e190
