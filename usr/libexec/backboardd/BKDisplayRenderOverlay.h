...
- (void).cxx_destruct;	// IMP=0x000000010002b960
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x000000010002b838
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x000000010002b7e4
- (id)succinctDescriptionBuilder;	// IMP=0x000000010002b778
- (id)succinctDescription;	// IMP=0x000000010002b724
@property(readonly, copy) NSString *description;
- (void)_wrapInCATransaction:(CDUnknownBlockType)arg1;	// IMP=0x000000010002b6a4
- (id)_persistenceData;	// IMP=0x000000010002b628
- (void)_cleanup;	// IMP=0x000000010002b624
- (void)_freeze;	// IMP=0x000000010002b620
- (void)_dismissWithAnimationSettings:(id)arg1;	// IMP=0x000000010002b61c
- (void)_stopAnimating;	// IMP=0x000000010002b618
- (void)_startAnimating;	// IMP=0x000000010002b614
- (_Bool)_presentWithAnimationSettings:(id)arg1;	// IMP=0x000000010002b60c
- (void)dismissWithAnimationSettings:(id)arg1;	// IMP=0x000000010002b4b4
- (void)freeze;	// IMP=0x000000010002b2dc
- (_Bool)presentWithAnimationSettings:(id)arg1;	// IMP=0x000000010002b0f4
...
- (void)dealloc;	// IMP=0x000000010002af38
- (id)_initWithPersistenceData:(id)arg1;	// IMP=0x000000010002ae7c
- (id)initWithOverlayDescriptor:(id)arg1 level:(float)arg2;	// IMP=0x000000010002acdc
