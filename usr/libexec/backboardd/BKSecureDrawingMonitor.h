...
+ (id)sharedInstance;	// IMP=0x0000000100063880
- (void).cxx_destruct;	// IMP=0x0000000100063324
@property(getter=isSecureModeEnabled) _Bool secureModeEnabled; // @synthesize secureModeEnabled=_secureModeEnabled;
- (void)reportAndKillInsecureProcesses;	// IMP=0x0000000100062fd8
- (void)startMonitoringSecureDrawing;	// IMP=0x0000000100062f78
- (id)init;	// IMP=0x0000000100062ebc
