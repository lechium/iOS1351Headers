...
- (void).cxx_destruct;	// IMP=0x0000000100086ee4
...
- (id)initWithRegion:(id)arg1 relativeRegion:(id)arg2 edge:(unsigned int)arg3 edgePosition:(double)arg4;	// IMP=0x0000000100086e08
