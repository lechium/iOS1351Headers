...
- (void).cxx_destruct;	// IMP=0x000000010006806c
...
- (id)descriptionBuilderWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100067ea8
- (id)descriptionWithMultilinePrefix:(id)arg1;	// IMP=0x0000000100067e54
- (id)succinctDescriptionBuilder;	// IMP=0x0000000100067dac
- (id)succinctDescription;	// IMP=0x0000000100067d58
@property(readonly, copy) NSString *description;
- (void)dealloc;	// IMP=0x0000000100067cfc
- (id)initWithConnection:(id)arg1;	// IMP=0x0000000100067c60
