...
+ (id)defaultClient;	// IMP=0x0000000100076224
- (void).cxx_destruct;	// IMP=0x00000001000761ac
...
- (id)initWithMode:(unsigned long long)arg1 port:(id)arg2 auditToken:(id)arg3;	// IMP=0x0000000100076028
