...
- (void).cxx_destruct;	// IMP=0x00000001000320b0
...
- (void)_loadAllImages;	// IMP=0x0000000100031ff4
- (struct CGImage *)_imageAtIndex:(long long)arg1;	// IMP=0x0000000100031da4
- (id)_idiomSuffix;	// IMP=0x0000000100031cf8
- (struct CGImage *)_createImageForIndex:(unsigned long long)arg1 basename:(id)arg2 scale:(double)arg3 idiom:(id)arg4 bundle:(id)arg5;	// IMP=0x00000001000319fc
- (id)allImages;	// IMP=0x00000001000319c8
- (struct CGImage *)imageAtIndex:(long long)arg1;	// IMP=0x00000001000319bc
- (id)initWithBasename:(id)arg1 bundle:(id)arg2 imageCount:(long long)arg3 scale:(double)arg4;	// IMP=0x0000000100031884
