...
- (void)watchForPortDeathOnQueue:(id)arg1 block:(CDUnknownBlockType)arg2;	// IMP=0x0000000100080468
- (id)description;	// IMP=0x0000000100080284
- (void)invalidate;	// IMP=0x0000000100080210
- (void)dealloc;	// IMP=0x0000000100080144
- (id)init;	// IMP=0x0000000100080100
