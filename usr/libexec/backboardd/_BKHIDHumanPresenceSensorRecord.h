...
- (void).cxx_destruct;	// IMP=0x00000001000766b4
...
- (void)removeService:(id)arg1;	// IMP=0x0000000100076648
- (void)addService:(id)arg1;	// IMP=0x00000001000765d4
- (void)_resetServiceStatus;	// IMP=0x000000010007641c
- (id)description;	// IMP=0x0000000100076324
