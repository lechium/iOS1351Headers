...
- (void).cxx_destruct;	// IMP=0x0000000100012e40
...
- (void)resetForCancel;	// IMP=0x0000000100012d88
- (id)description;	// IMP=0x0000000100012c0c
- (id)initWithService:(id)arg1;	// IMP=0x0000000100012a00
