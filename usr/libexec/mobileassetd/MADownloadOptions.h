...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000df34
...
- (void)logOptions;	// IMP=0x000000010000e560
- (id)description;	// IMP=0x000000010000e43c
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000e268
- (void)dealloc;	// IMP=0x000000010000e218
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000df98
- (id)init;	// IMP=0x000000010000df3c
