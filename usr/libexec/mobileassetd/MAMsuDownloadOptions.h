...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010000adb4
...
- (void)logOptions;	// IMP=0x000000010000b308
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010000b0ec
- (void)dealloc;	// IMP=0x000000010000b06c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010000ae54
- (id)init;	// IMP=0x000000010000adbc
