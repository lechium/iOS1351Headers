...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001bbd0
- (void)dealloc;	// IMP=0x000000010001bb9c
- (id)initWithDownloadManager:(id)arg1;	// IMP=0x000000010001bb54
