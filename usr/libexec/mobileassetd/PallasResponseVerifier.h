...
- (_Bool)verifyResponse:(id)arg1 signature:(id)arg2 error:(id *)arg3;	// IMP=0x0000000100006d6c
- (_Bool)verifyCerts:(id)arg1 error:(id *)arg2;	// IMP=0x0000000100006a48
- (_Bool)determineAlg:(id)arg1;	// IMP=0x00000001000069c8
- (id)init;	// IMP=0x000000010000698c
