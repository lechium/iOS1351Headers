...
- (void).cxx_destruct;	// IMP=0x000000010002b360
...
- (void)xpcSessionActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002b0f4
- (void)xpcServerUpdate:(id)arg1;	// IMP=0x000000010002ae04
- (void)xpcServerActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002a748
- (void)xpcDiscoveryUpdate:(id)arg1;	// IMP=0x000000010002a690
- (void)xpcDiscoveryActivate:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002a554
- (void)companionLinkTryPassword:(id)arg1;	// IMP=0x000000010002a464
- (void)companionLinkSendRequestID:(id)arg1 request:(id)arg2 destinationID:(id)arg3 options:(id)arg4 responseHandler:(CDUnknownBlockType)arg5;	// IMP=0x000000010002a230
- (void)companionLinkDeregisterRequestID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x000000010002a174
- (void)companionLinkRegisterRequestID:(id)arg1 options:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x000000010002a064
- (void)companionLinkDeregisterProfileID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100029f10
- (void)companionLinkRegisterProfileID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100029ca0
- (void)companionLinkSendEventID:(id)arg1 event:(id)arg2 destinationID:(id)arg3 options:(id)arg4 completion:(CDUnknownBlockType)arg5;	// IMP=0x0000000100029a7c
- (void)companionLinkDeregisterEventID:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100029900
- (void)companionLinkRegisterEventID:(id)arg1 options:(id)arg2 completion:(CDUnknownBlockType)arg3;	// IMP=0x0000000100029680
- (void)companionLinkUpdateClient:(id)arg1;	// IMP=0x0000000100029320
- (void)companionLinkActivateClient:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100028790
- (void)companionLinkInvalidateAssertion:(id)arg1;	// IMP=0x000000010002878c
- (void)companionLinkActivateAssertion:(id)arg1 completion:(CDUnknownBlockType)arg2;	// IMP=0x0000000100028774
- (void)reportChangedDevice:(id)arg1 changes:(unsigned int)arg2;	// IMP=0x00000001000285a0
- (void)reportLostDevice:(id)arg1;	// IMP=0x000000010002844c
- (void)reportFoundDevice:(id)arg1;	// IMP=0x00000001000282f4
- (void)receivedRequestID:(id)arg1 request:(id)arg2 options:(id)arg3 responseHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000281d8
- (void)receivedEventID:(id)arg1 event:(id)arg2 options:(id)arg3;	// IMP=0x00000001000280e0
- (void)promptForPasswordType:(int)arg1 flags:(unsigned int)arg2 throttleSeconds:(int)arg3;	// IMP=0x0000000100027ff0
- (id)_devicesForClient:(id)arg1;	// IMP=0x0000000100027d1c
- (void)authCompletion:(id)arg1;	// IMP=0x0000000100027c60
- (_Bool)_entitledAndReturnError:(id *)arg1;	// IMP=0x0000000100027aec
- (void)connectionInvalidated;	// IMP=0x0000000100027404
- (id)initWithDaemon:(id)arg1 xpcCnx:(id)arg2;	// IMP=0x0000000100027348
