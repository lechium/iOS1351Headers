...
+ (id)sharedDaemon;	// IMP=0x000000010002ba50
- (void).cxx_destruct;	// IMP=0x000000010002eb14
...
- (void)_xpcPublisherStateChangedForToken:(unsigned long long)arg1 state:(_Bool)arg2;	// IMP=0x000000010002e8e0
- (void)_xpcPublisherTriggeredReply:(id)arg1 token:(unsigned long long)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002e57c
- (void)_xpcPublisherTriggeredToken:(unsigned long long)arg1 payload:(id)arg2 responseHandler:(CDUnknownBlockType)arg3;	// IMP=0x000000010002e268
- (void)_xpcPublisherRemoveToken:(unsigned long long)arg1;	// IMP=0x000000010002e0e8
- (void)_xpcPublisherAddToken:(unsigned long long)arg1 event:(id)arg2;	// IMP=0x000000010002dc44
- (void)_xpcPublisherAction:(unsigned int)arg1 token:(unsigned long long)arg2 event:(id)arg3;	// IMP=0x000000010002db5c
- (void)_updateErrorFlags;	// IMP=0x000000010002d9fc
- (void)_prefsChanged;	// IMP=0x000000010002d8e0
- (void)postDaemonInfoChanges:(unsigned long long)arg1;	// IMP=0x000000010002d704
- (id)keychainStateString;	// IMP=0x000000010002d4b0
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010002d23c
- (_Bool)diagnosticCommand:(id)arg1 params:(id)arg2;	// IMP=0x000000010002d0b4
- (void)invalidate;	// IMP=0x000000010002cd5c
- (void)activate;	// IMP=0x000000010002c340
- (id)descriptionWithLevel:(int)arg1;	// IMP=0x000000010002bcb0
- (id)init;	// IMP=0x000000010002babc
