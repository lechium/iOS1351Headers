...
+ (struct CGRect)_frameWithIntegralOrigin:(struct CGRect)arg1;	// IMP=0x00000001000abd88
+ (struct CGRect)_bestFrameFor90ControlAtAngle:(double)arg1 size:(struct CGSize)arg2 centerPoint:(struct CGPoint)arg3;	// IMP=0x00000001000aba5c
+ (_Bool)_isValidPositionFor90ControlWithXAlignment:(unsigned long long)arg1 yAlignment:(unsigned long long)arg2 size:(struct CGSize)arg3 nearestPoint:(struct CGPoint)arg4 centerPoint:(struct CGPoint)arg5 frame:(struct CGRect *)arg6;	// IMP=0x00000001000ab6e4
+ (struct CGRect)_frameFor90ControlWithXAlignment:(unsigned long long)arg1 yAlignment:(unsigned long long)arg2 size:(struct CGSize)arg3 nearestPoint:(struct CGPoint)arg4;	// IMP=0x00000001000ab664
- (void).cxx_destruct;	// IMP=0x00000001000ac8d4
...
- (void)_updateCurvatureControls;	// IMP=0x00000001000ac584
- (void)_updateCurvatureControl:(id)arg1 withTailPoint:(struct CGPoint)arg2 tailAngle:(double)arg3 distance:(double)arg4 curvature:(double)arg5;	// IMP=0x00000001000ac4dc
- (void)_updateRotationControls;	// IMP=0x00000001000ac188
- (double)_midAngleForCurvedTrailWithTailPoint:(struct CGPoint)arg1 fingerTrailDistance:(double)arg2 distanceAlongArc:(double)arg3 useSecondIntersectionPointIfNecessary:(_Bool)arg4;	// IMP=0x00000001000abfa0
- (void)_updateRotation90Controls;	// IMP=0x00000001000abd94
- (void)_updateControls;	// IMP=0x00000001000ab620
- (double)_actualDistanceForFingerTrail;	// IMP=0x00000001000ab5c0
- (struct CGPoint)_tailPoint;	// IMP=0x00000001000ab54c
- (void)_adjustArrowViewsForNumberOfFingers:(unsigned long long)arg1;	// IMP=0x00000001000ab3e0
- (id)_newRotate90Button;	// IMP=0x00000001000ab1a4
- (id)_newControlArrowForCurvature:(_Bool)arg1;	// IMP=0x00000001000ab148
...
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000aa378
