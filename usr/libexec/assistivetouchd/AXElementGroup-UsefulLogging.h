...
- (id)elemLog;	// IMP=0x0000000100033fb8
@property(nonatomic) _Bool scatAssistiveTechFocused;
- (void)prepareElementsForScanning:(id)arg1;	// IMP=0x00000001000b4774
...
- (void)scatScrollToVisible;	// IMP=0x00000001000b4538
@property(readonly, nonatomic) _Bool scatIsValid;
@property(readonly, nonatomic) NSString *scatSpeakableDescription;
- (id)scatSpeakableDescription:(_Bool)arg1;	// IMP=0x00000001000b4200
@property(readonly, nonatomic) struct CGRect scatFrame;
- (_Bool)scatCanScrollInAtLeastOneDirection;	// IMP=0x00000001000b418c
- (id)scrollableElement;	// IMP=0x00000001000b4114
...
- (id)scatSupportedGestures;	// IMP=0x00000001000b3e68
@property(readonly, nonatomic) struct CGPath *scatPath;
- (_Bool)scatPerformAction:(int)arg1 withValue:(id)arg2;	// IMP=0x00000001000b3e58
- (_Bool)scatPerformAction:(int)arg1;	// IMP=0x00000001000b3e50
- (_Bool)scatSupportsAction:(int)arg1;	// IMP=0x00000001000b3e48
