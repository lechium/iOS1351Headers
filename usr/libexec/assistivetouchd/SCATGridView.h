...
- (void).cxx_destruct;	// IMP=0x0000000100068210
...
- (void)drawRect:(struct CGRect)arg1;	// IMP=0x0000000100067ff0
- (void)_drawLinesInContext:(struct CGContext *)arg1 forRows:(_Bool)arg2;	// IMP=0x0000000100067db4
- (void)layoutSubviews;	// IMP=0x0000000100067a28
- (double)_adjustOriginValue:(double)arg1 forDistance:(double)arg2 maximumEndPosition:(double)arg3;	// IMP=0x0000000100067a00
- (id)initWithFrame:(struct CGRect)arg1;	// IMP=0x00000001000678bc
