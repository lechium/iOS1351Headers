...
- (void).cxx_destruct;	// IMP=0x00000001000202bc
...
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x000000010001ff20
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x000000010001fce0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x000000010001f71c
- (long long)versionFromTask:(id)arg1;	// IMP=0x000000010001f6c0
- (void)updateDb:(unsigned long long)arg1;	// IMP=0x000000010001f4d0
- (void)reschedule;	// IMP=0x000000010001f2e4
