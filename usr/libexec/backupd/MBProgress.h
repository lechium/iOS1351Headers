...
- (void)updateWithDuration:(double)arg1 size:(unsigned long long)arg2;	// IMP=0x000000010001db70
- (void)addDuration:(double)arg1;	// IMP=0x000000010001dac0
@property(readonly, nonatomic) _Bool isFinished;
@property(readonly, nonatomic) double percentage;
- (void)dealloc;	// IMP=0x000000010001da1c
- (id)init;	// IMP=0x000000010001d9dc
