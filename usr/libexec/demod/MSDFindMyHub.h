...
+ (id)sharedInstance;	// IMP=0x0000000100027ea8
- (void).cxx_destruct;	// IMP=0x0000000100029c34
...
- (_Bool)compareSavedHubHostsWithNewHosts;	// IMP=0x00000001000297d0
- (_Bool)compareSavedHubHostNameWithNewHostName;	// IMP=0x000000010002953c
- (_Bool)enrollAndSetup:(id *)arg1;	// IMP=0x0000000100028e0c
- (_Bool)askFindMyHubForHubInfoAndDeviceOptions;	// IMP=0x000000010002831c
- (unsigned long long)queryFindMyHubAndDetermineLogicSyncResult;	// IMP=0x0000000100028018
- (_Bool)discoverAndEnrollWithHub:(id *)arg1;	// IMP=0x0000000100027f58
