...
+ (id)sharedInstance;	// IMP=0x00000001000501b8
- (void).cxx_destruct;	// IMP=0x0000000100052738
...
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100052340
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100051f0c
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100051af0
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000518ac
- (void)invalidate;	// IMP=0x000000010005186c
- (_Bool)directDownload:(id)arg1 withCredential:(id)arg2 to:(id)arg3 error:(id *)arg4 retry:(long long)arg5;	// IMP=0x0000000100050818
- (id)init;	// IMP=0x0000000100050224
