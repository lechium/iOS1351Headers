...
- (void).cxx_destruct;	// IMP=0x000000010004216c
...
- (void)coordinator:(id)arg1 canceledWithReason:(id)arg2 client:(unsigned long long)arg3;	// IMP=0x0000000100041fc8
- (void)coordinatorDidCompleteSuccessfully:(id)arg1;	// IMP=0x0000000100041f7c
- (id)init;	// IMP=0x0000000100041f10
