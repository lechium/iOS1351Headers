...
+ (id)sharedInstance;	// IMP=0x0000000100005f7c
- (void).cxx_destruct;	// IMP=0x0000000100006c28
...
- (id)sanitizeTestLog:(id)arg1;	// IMP=0x0000000100006a7c
- (void)pushTestLog:(id)arg1;	// IMP=0x00000001000069e4
- (void)sendCommandsToDemod:(id)arg1 replyFromDemod:(CDUnknownBlockType)arg2;	// IMP=0x000000010000670c
- (_Bool)listener:(id)arg1 shouldAcceptNewConnection:(id)arg2;	// IMP=0x000000010000648c
- (void)sendTestEvents:(id)arg1;	// IMP=0x0000000100006350
- (void)pushTestEvent:(id)arg1 ofType:(id)arg2;	// IMP=0x0000000100006280
- (id)getTimeStamp;	// IMP=0x0000000100006224
- (void)start;	// IMP=0x0000000100006000
