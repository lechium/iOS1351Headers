...
+ (id)contentServerConnection:(id)arg1 port:(id)arg2;	// IMP=0x000000010006e72c
- (void).cxx_destruct;	// IMP=0x00000001000720fc
...
- (void)URLSession:(id)arg1 task:(id)arg2 willPerformHTTPRedirection:(id)arg3 newRequest:(id)arg4 completionHandler:(CDUnknownBlockType)arg5;	// IMP=0x0000000100071d38
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveData:(id)arg3;	// IMP=0x0000000100071898
- (void)URLSession:(id)arg1 dataTask:(id)arg2 didReceiveResponse:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x00000001000715a8
- (void)URLSession:(id)arg1 task:(id)arg2 didCompleteWithError:(id)arg3;	// IMP=0x0000000100070df4
- (void)URLSession:(id)arg1 task:(id)arg2 didReceiveChallenge:(id)arg3 completionHandler:(CDUnknownBlockType)arg4;	// IMP=0x0000000100070a8c
- (_Bool)addAuthenticationHeadersToRequest:(id)arg1 withBody:(id)arg2 error:(id *)arg3;	// IMP=0x00000001000707dc
- (void)cancelDownloading;	// IMP=0x0000000100070488
- (void)runRunLoopUntilDone;	// IMP=0x000000010007044c
- (_Bool)startDownloadingFile;	// IMP=0x000000010006f724
- (void)invalidate;	// IMP=0x000000010006f6e4
- (void)enableAuthenticationWithHMACKey:(id)arg1;	// IMP=0x000000010006f6d8
- (_Bool)downloadTo:(id)arg1 byPosting:(id)arg2 toPath:(id)arg3 retry:(int)arg4 error:(id *)arg5;	// IMP=0x000000010006f3e8
- (id)postDataForEnrolment:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x000000010006f2f8
- (id)postData:(id)arg1 to:(id)arg2 retry:(int)arg3 error:(id *)arg4;	// IMP=0x000000010006f194
- (_Bool)downloadFile:(id)arg1 to:(id)arg2 retry:(long long)arg3 completion:(CDUnknownBlockType)arg4;	// IMP=0x000000010006ed28
- (id)downloadFileToNSData:(id)arg1 retry:(long long)arg2 error:(id *)arg3;	// IMP=0x000000010006ebe4
- (void)dealloc;	// IMP=0x000000010006eaa4
- (void)setupServer:(id)arg1 port:(id)arg2;	// IMP=0x000000010006ea2c
- (id)initWithCellularAccess:(_Bool)arg1;	// IMP=0x000000010006e7f8
