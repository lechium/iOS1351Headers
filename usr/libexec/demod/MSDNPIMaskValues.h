...
+ (id)sharedInstance;	// IMP=0x0000000100065528
- (void).cxx_destruct;	// IMP=0x0000000100066038
...
- (void)initMaskValuesLookUpTable;	// IMP=0x0000000100065a1c
- (id)getMaskValueForKey:(id)arg1;	// IMP=0x0000000100065908
- (void)saveDeviceInfo:(id)arg1;	// IMP=0x000000010006562c
- (id)init;	// IMP=0x0000000100065594
