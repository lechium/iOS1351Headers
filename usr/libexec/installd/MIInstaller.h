...
+ (id)installerForURL:(id)arg1 withOptions:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000c420
- (void).cxx_destruct;	// IMP=0x00000001000117a8
...
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x00000001000100dc
- (_Bool)_installProvisioningProfilesAtStagingRootWithError:(id *)arg1;	// IMP=0x000000010000fc80
- (_Bool)_installProvisioningProfilesFromUserOptionsWithError:(id *)arg1;	// IMP=0x000000010000f90c
- (_Bool)_discoverInstallablesWithError:(id *)arg1;	// IMP=0x000000010000e8b4
- (void)_writeLockBundles:(id)arg1;	// IMP=0x000000010000e694
- (void)_acquireTerminationAssertionsForBundles:(id)arg1;	// IMP=0x000000010000e490
- (id)_bundlesAtURL:(id)arg1 error:(id *)arg2;	// IMP=0x000000010000e0d0
- (id)_manifestPathForBase:(id)arg1 withIdentifier:(id)arg2 patchType:(unsigned char *)arg3 error:(id *)arg4;	// IMP=0x000000010000dbe0
- (_Bool)_extractPackageContainedSymlink:(_Bool *)arg1 withError:(id *)arg2;	// IMP=0x000000010000d3b0
- (_Bool)_setupPackageStateWithError:(id *)arg1;	// IMP=0x000000010000c7f4
- (_Bool)_takeOwnershipOfInstallableContainingSymlink:(_Bool *)arg1 error:(id *)arg2;	// IMP=0x000000010000c59c
- (void)_fireCallbackWithStatus:(id)arg1;	// IMP=0x000000010000c530
- (void)_fireCallbackWithStatus:(id)arg1 percentComplete:(unsigned int)arg2;	// IMP=0x000000010000c4bc
- (void)dealloc;	// IMP=0x000000010000c244
- (id)initWithURL:(id)arg1 options:(id)arg2 forClient:(id)arg3;	// IMP=0x000000010000c174
- (id)init;	// IMP=0x000000010000c168
