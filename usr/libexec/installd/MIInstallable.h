...
- (id)description;	// IMP=0x000000010003d5cc
- (id)launchServicesDictionariesWithError:(id *)arg1;	// IMP=0x000000010003d5bc
- (_Bool)finalizeInstallationWithError:(id *)arg1;	// IMP=0x000000010003d5b4
- (_Bool)postFlightInstallationWithError:(id *)arg1;	// IMP=0x000000010003d5ac
- (_Bool)performInstallationWithError:(id *)arg1;	// IMP=0x000000010003d5a4
- (_Bool)performVerificationWithError:(id *)arg1;	// IMP=0x000000010003d59c
- (_Bool)performPreflightWithError:(id *)arg1;	// IMP=0x000000010003d590
- (_Bool)applyPatchWithError:(id *)arg1;	// IMP=0x000000010003d588
@property(readonly, nonatomic) _Bool shouldModifyExistingContainers;
- (id)initWithBundle:(id)arg1 inStagingRoot:(id)arg2 packageFormat:(unsigned char)arg3 userOptions:(id)arg4 error:(id *)arg5;	// IMP=0x000000010003d4a8
