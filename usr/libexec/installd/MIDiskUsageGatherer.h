...
- (void).cxx_destruct;	// IMP=0x00000001000168f4
...
- (id)gatherUsageInfoWithError:(id *)arg1;	// IMP=0x0000000100016678
- (id)_gatherForIdentifier:(id)arg1;	// IMP=0x00000001000160dc
- (id)initWithIdentifiers:(id)arg1 options:(id)arg2;	// IMP=0x0000000100015fa0
