...
- (void).cxx_destruct;	// IMP=0x000000010005bbe8
@property(retain, nonatomic) FBSApplicationTerminationAssertion *termAssertion; // @synthesize termAssertion=_termAssertion;
- (void)dealloc;	// IMP=0x000000010005bb74
- (void)invalidate;	// IMP=0x000000010005bb1c
- (id)initWithBundleIdentifier:(id)arg1 reason:(unsigned char)arg2;	// IMP=0x000000010005b758
