...
+ (id)defaultManager;	// IMP=0x000000010002136c
- (void).cxx_destruct;	// IMP=0x0000000100021988
...
- (void)waitForSystemAppMigrationToComplete:(CDUnknownBlockType)arg1;	// IMP=0x0000000100021734
@property(nonatomic) _Bool systemAppMigrationComplete; // @synthesize systemAppMigrationComplete=_systemAppMigrationComplete;
- (id)init;	// IMP=0x0000000100021230
