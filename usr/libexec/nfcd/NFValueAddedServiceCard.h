...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100064200
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100064154
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100064044
- (id)asDictionary;	// IMP=0x0000000100063f78
- (id)description;	// IMP=0x0000000100063efc
- (void)dealloc;	// IMP=0x0000000100063ea4
