...
- (id)signOutputTableWithInputTable:(id)arg1 data:(id)arg2 localValidation:(unsigned char)arg3 error:(id *)arg4;	// IMP=0x000000010004d154
- (void)dealloc;	// IMP=0x000000010004d0fc
