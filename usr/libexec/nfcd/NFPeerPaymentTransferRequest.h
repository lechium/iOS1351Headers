...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100038df4
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100038d20
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100038b9c
- (void)dealloc;	// IMP=0x0000000100038b24
- (id)initWithDictionary:(id)arg1;	// IMP=0x0000000100038a04
