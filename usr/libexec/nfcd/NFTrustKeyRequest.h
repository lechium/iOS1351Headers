...
+ (id)keyRequestWithSubjectIdentifier:(id)arg1 discretionaryData:(id)arg2 localValidations:(id)arg3 counterLimit:(id)arg4;	// IMP=0x000000010008bbc0
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010008b98c
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010008baf8
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010008b994
- (void)dealloc;	// IMP=0x000000010008b90c
