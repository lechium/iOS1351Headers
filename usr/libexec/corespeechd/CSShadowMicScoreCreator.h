...
- (void).cxx_destruct;	// IMP=0x000000010007717c
...
- (void)_calculateNumberOfVoicingFrames;	// IMP=0x0000000100076f40
- (void)_calculateSpeechVoicingLevel;	// IMP=0x0000000100076d70
- (double)_calculateRMSWithFrameData:(short [80])arg1;	// IMP=0x0000000100076d30
- (void)calculateShadowMicScore;	// IMP=0x0000000100076a48
- (void)addDataToBuffer:(id)arg1;	// IMP=0x0000000100076a38
- (id)init;	// IMP=0x00000001000769ac
