...
- (void)setCap:(unsigned long long)arg1 downsampleRatio:(unsigned long long)arg2 forQuery:(id)arg3;	// IMP=0x0000000100005424
- (id)newChildInstance;	// IMP=0x0000000100005418
- (id)keyForChildren:(id)arg1;	// IMP=0x0000000100005408
- (id)entryForQuery:(id)arg1;	// IMP=0x000000010000530c
