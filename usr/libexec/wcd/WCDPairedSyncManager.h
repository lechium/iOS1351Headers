...
- (void).cxx_destruct;	// IMP=0x000000010001f73c
...
- (void)syncCoordinator:(id)arg1 beginSyncSession:(id)arg2;	// IMP=0x000000010001f520
- (_Bool)handlePotentialPairedSyncForComplicationsFailedWithIdentifier:(id)arg1 error:(id)arg2;	// IMP=0x000000010001f3d4
- (void)handlePairedSyncForComplicationsAckWithIdentifier:(id)arg1 success:(_Bool)arg2;	// IMP=0x000000010001f1dc
@property(readonly) NSString *state;
- (id)init;	// IMP=0x000000010001eff4
