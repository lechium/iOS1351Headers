...
- (void).cxx_destruct;	// IMP=0x0000000100027e24
...
- (void)mergeFrom:(id)arg1;	// IMP=0x0000000100027cc8
- (unsigned long long)hash;	// IMP=0x0000000100027bf4
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100027a80
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x0000000100027958
- (void)copyTo:(id)arg1;	// IMP=0x0000000100027860
- (void)writeTo:(id)arg1;	// IMP=0x000000010002777c
- (_Bool)readFrom:(id)arg1;	// IMP=0x0000000100027774
- (id)dictionaryRepresentation;	// IMP=0x0000000100027118
- (id)description;	// IMP=0x0000000100027064
