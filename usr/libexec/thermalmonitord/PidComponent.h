...
- (void)applySeedToIntegratorFromControlEffort:(int)arg1 currentTemperature:(float)arg2;	// IMP=0x000000010000a4f4
- (_Bool)isIntegratorAtMin;	// IMP=0x000000010000a4e4
- (_Bool)isEqualMType:(int)arg1;	// IMP=0x000000010000a4d4
- (void)calculateControlEffort:(float)arg1;	// IMP=0x000000010000a454
- (void)dealloc;	// IMP=0x000000010000a408
- (id)initPIDWith:(struct __CFDictionary *)arg1;	// IMP=0x000000010000a2f4
