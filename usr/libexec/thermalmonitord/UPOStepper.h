...
+ (id)log;	// IMP=0x0000000100027114
+ (id)newStepperWithTrueRA:(int)arg1 withUPOCount:(int)arg2 fromConfiguration:(id)arg3 useWeightedRa:(_Bool)arg4;	// IMP=0x00000001000270c4
+ (id)newStepperWithTrueRA:(int)arg1 withUPOCount:(int)arg2 fromConfiguration:(id)arg3 withDefaultsDomain:(id)arg4 useWeightedRa:(_Bool)arg5;	// IMP=0x0000000100026d20
+ (void)initParameterValues:(_Bool)arg1;	// IMP=0x0000000100026c74
+ (void)readConfigurationParameters:(id)arg1 useWeightedRa:(_Bool)arg2;	// IMP=0x00000001000269a8
+ (void)initIntParameter:(int *)arg1 ForKey:(id)arg2 WithConfig:(id)arg3 useWeightedRa:(_Bool)arg4;	// IMP=0x00000001000268fc
+ (id)defaultsDomainFromKey:(id)arg1;	// IMP=0x0000000100026184
...
- (id)description;	// IMP=0x00000001000291e8
- (void)updateUPOMetricsAtTime:(long long)arg1 withTrueRa:(long long)arg2 withEffectiveRa:(long long)arg3 withProbeDuration:(long long)arg4 withMitigationState:(unsigned long long)arg5 wasMitigatedUPO:(_Bool)arg6;	// IMP=0x0000000100028e50
- (void)clearMitigatedUPOCount;	// IMP=0x0000000100028d9c
- (void)recordDataToPowerLog;	// IMP=0x0000000100028c30
- (void)notifyMitigationsEnabled;	// IMP=0x0000000100028968
- (void)disableMitigations;	// IMP=0x0000000100028948
- (void)reset:(_Bool)arg1;	// IMP=0x0000000100028814
- (void)updateTrueRA:(int)arg1;	// IMP=0x00000001000287b0
- (void)updateUPOCount:(int)arg1;	// IMP=0x000000010002874c
- (void)reduceEffectiveRA:(_Bool)arg1;	// IMP=0x000000010002855c
- (void)checkpoint;	// IMP=0x0000000100028420
- (unsigned long long)secondsSinceBoot;	// IMP=0x00000001000283f0
- (long long)convertContinuousTimeToSeconds:(unsigned long long)arg1;	// IMP=0x0000000100028398
- (void)deregisterForBatteryInformationChanges;	// IMP=0x0000000100028370
- (void)registerForBatteryInformationChanges;	// IMP=0x0000000100028150
- (id)allocBatteryShutdownData;	// IMP=0x00000001000280c0
- (_Bool)tooManyUPOs;	// IMP=0x0000000100028048
- (_Bool)upoDataIsAvailable;	// IMP=0x0000000100027fa4
- (void)obtainUPOSoC:(int *)arg1 andTemp:(int *)arg2 andTimestamp:(long long *)arg3;	// IMP=0x0000000100027d94
- (void)handleUPO;	// IMP=0x0000000100027948
- (void)updateStateWithSavedState:(id)arg1 withUPOCount:(int)arg2 haveUPOData:(_Bool)arg3;	// IMP=0x00000001000272c0
- (id)currentBootSessionUUID;	// IMP=0x0000000100027254
- (char *)currentBootSessionUUIDStr;	// IMP=0x00000001000271b4
- (void)updateMitigationState:(unsigned long long)arg1;	// IMP=0x0000000100027180
- (void)dealloc;	// IMP=0x000000010002687c
- (void)invalidate;	// IMP=0x0000000100026834
- (id)initWithTrueRA:(int)arg1 withUPOCount:(int)arg2 withDefaultsDomain:(id)arg3 useWeightedRa:(_Bool)arg4;	// IMP=0x00000001000261d4
