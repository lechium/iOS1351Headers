...
- (void).cxx_destruct;	// IMP=0x000000010002316c
- (id)initWithURL:(id)arg1 append:(_Bool)arg2;	// IMP=0x0000000100023328
- (id)initToBuffer:(char *)arg1 capacity:(long long)arg2;	// IMP=0x000000010002327c
- (id)initToMemory;	// IMP=0x000000010002320c
- (void)close;	// IMP=0x0000000100023110
- (void)open;	// IMP=0x0000000100022d9c
...
- (long long)write:(const char *)arg1 maxLength:(long long)arg2;	// IMP=0x0000000100022b24
@property(nonatomic, readonly) NSString *dataDigestForStream;
- (id)initWithOutputStream:(id)arg1;	// IMP=0x0000000100022610
- (id)init;	// IMP=0x00000001000222f0
