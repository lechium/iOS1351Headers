...
- (void).cxx_destruct;	// IMP=0x000000010002f1c4
...
- (void)_notifyDelegateOfStateChange;	// IMP=0x000000010002f13c
@property(readonly, nonatomic) unsigned int clientApplicationState;
- (id)clientStateTags:(unsigned int)arg1;	// IMP=0x000000010002ef18
- (void)close;	// IMP=0x000000010002ee60
- (void)globalStateDidChange:(id)arg1;	// IMP=0x000000010002ee54
- (id)initWithDelegate:(id)arg1 bundleID:(id)arg2 andPID:(int)arg3;	// IMP=0x000000010002ebe4
