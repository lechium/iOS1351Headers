...
#import "RemoteSearchOperationDelegate-Protocol.h"
...
- (void).cxx_destruct;	// IMP=0x00000001000d2198
...
- (void)_addSearchOperations:(unsigned long long)arg1;	// IMP=0x00000001000d1d64
- (void)remoteSearchOperation:(id)arg1 didFindResults:(_Bool)arg2;	// IMP=0x00000001000d1a6c
- (_Bool)remoteSearchOperationShouldStopEarly:(id)arg1;	// IMP=0x00000001000d1968
- (void)cancel;	// IMP=0x00000001000d18f8
- (void)performSearch;	// IMP=0x00000001000d1630
- (id)initWithAccount:(id)arg1 searchContext:(id)arg2 logIdentifier:(id)arg3 progress:(id)arg4;	// IMP=0x00000001000d141c
