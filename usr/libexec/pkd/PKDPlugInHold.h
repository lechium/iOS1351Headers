...
- (void).cxx_destruct;	// IMP=0x00000001000176c8
...
- (id)description;	// IMP=0x000000010001753c
- (unsigned long long)hash;	// IMP=0x00000001000174f0
- (_Bool)isEqual:(id)arg1;	// IMP=0x0000000100017430
- (id)initWithPlugIns:(id)arg1 forClient:(id)arg2;	// IMP=0x00000001000172b8
