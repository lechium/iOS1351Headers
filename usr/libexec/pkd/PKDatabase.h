...
- (void).cxx_destruct;	// IMP=0x0000000100012b70
...
- (void)pluginsWillUninstall:(id)arg1;	// IMP=0x00000001000125fc
- (void)pluginsDidInstall:(id)arg1;	// IMP=0x0000000100012308
- (void)autoElect:(id)arg1;	// IMP=0x0000000100012158
- (void)notifyAnnotationChange;	// IMP=0x00000001000120dc
- (id)setAnnotation:(id)arg1 forPlugIn:(id)arg2;	// IMP=0x0000000100011fa8
- (id)annotationForPlugIn:(id)arg1;	// IMP=0x0000000100011e0c
- (id)removePlugIn:(id)arg1;	// IMP=0x0000000100011c84
- (id)addPlugIn:(id)arg1;	// IMP=0x0000000100011afc
- (id)plugInsWithinApplication:(id)arg1;	// IMP=0x0000000100011858
- (id)findPlugInAtPath:(id)arg1;	// IMP=0x0000000100011768
- (id)findPlugIn:(id)arg1;	// IMP=0x00000001000113b0
- (id)findPlugIns:(id)arg1 discoveryInstanceUUID:(id)arg2;	// IMP=0x0000000100010398
- (void)purgeCachesToLimit:(long long)arg1;	// IMP=0x000000010001020c
- (id)createPlugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x000000010000ffc4
- (id)plugInForProxy:(id)arg1 knowledgeUUID:(id)arg2 discoveryInstanceUUID:(id)arg3 extensionPointCache:(id)arg4;	// IMP=0x000000010000fb6c
- (id)initWithDatabase:(const char *)arg1;	// IMP=0x000000010000f7fc
