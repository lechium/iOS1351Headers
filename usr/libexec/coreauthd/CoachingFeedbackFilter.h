...
- (void)_dispatchPendingBlocks;	// IMP=0x0000000100005038
- (void)dispatchNowOrWhenFeedbackDurationAchieved:(_Bool)arg1 finish:(_Bool)arg2 block:(CDUnknownBlockType)arg3;	// IMP=0x0000000100004dfc
- (void)_doneWaiting;	// IMP=0x0000000100004d30
- (void)_sendFeedback:(long long)arg1;	// IMP=0x0000000100004a34
- (double)_timeoutForFeedback:(long long)arg1;	// IMP=0x0000000100004a10
- (void)scheduleFeedback:(long long)arg1;	// IMP=0x0000000100004804
- (id)initWithDelegate:(id)arg1 feedbackSet:(id)arg2 feedbackDuration:(double)arg3 iconDuration:(double)arg4;	// IMP=0x000000010000473c
