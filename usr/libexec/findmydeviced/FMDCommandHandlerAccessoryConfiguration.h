...
- (void).cxx_destruct;	// IMP=0x000000010002cc14
...
- (void)handleCommand;	// IMP=0x000000010002cb40
- (id)initWithParams:(id)arg1 supportedAccessoryRegistry:(id)arg2;	// IMP=0x000000010002caa4
