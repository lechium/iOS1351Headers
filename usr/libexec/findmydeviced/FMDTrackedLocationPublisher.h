...
- (void).cxx_destruct;	// IMP=0x000000010002d4c8
...
- (void)flushLocations;	// IMP=0x000000010002d358
- (void)_publishResultLocation:(id)arg1 reason:(long long)arg2;	// IMP=0x000000010002d23c
- (void)updatedLocations:(id)arg1 reason:(long long)arg2;	// IMP=0x000000010002cc6c
- (void)updatedLocations:(id)arg1;	// IMP=0x000000010002cc5c
- (void)startPublishingWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x000000010002cc24
