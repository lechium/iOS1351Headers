...
- (void).cxx_destruct;	// IMP=0x000000010001ac44
...
- (_Bool)canReplace:(id)arg1;	// IMP=0x000000010001aa34
- (id)requestBody;	// IMP=0x000000010001a6c8
- (id)requestUrl;	// IMP=0x000000010001a6bc
- (id)initWithProvider:(id)arg1 lostCommand:(id)arg2 cmdStatusCode:(long long)arg3 locationServicesStateChanged:(_Bool)arg4 ackURL:(id)arg5;	// IMP=0x000000010001a580
