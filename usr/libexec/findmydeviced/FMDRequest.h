...
- (void).cxx_destruct;	// IMP=0x000000010003589c
...
- (_Bool)canReplace:(id)arg1;	// IMP=0x00000001000352a4
...
- (id)description;	// IMP=0x0000000100034c5c
- (id)initWithAccount:(id)arg1;	// IMP=0x0000000100034b44
- (void)deinitializeRequest;	// IMP=0x0000000100034a30
- (void)dealloc;	// IMP=0x0000000100034998
