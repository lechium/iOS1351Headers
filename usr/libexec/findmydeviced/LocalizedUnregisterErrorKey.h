...
- (id)deviceTypeStringForDeviceClass:(long long)arg1;	// IMP=0x000000010002aa98
- (id)errorContextStringForDisableContext:(unsigned long long)arg1;	// IMP=0x000000010002aa30
- (id)errorTypeString;	// IMP=0x000000010002a9f0
- (id)keyForType:(id)arg1;	// IMP=0x000000010002a8c0
...
- (id)initWithUnregisterError:(long long)arg1 context:(unsigned long long)arg2 deviceClass:(long long)arg3;	// IMP=0x000000010002a73c
