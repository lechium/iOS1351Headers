...
+ (_Bool)supportsSecureCoding;	// IMP=0x000000010006f940
- (void).cxx_destruct;	// IMP=0x000000010006f998
...
- (void)encodeWithCoder:(id)arg1;	// IMP=0x000000010006f79c
- (id)initWithCoder:(id)arg1;	// IMP=0x000000010006f580
