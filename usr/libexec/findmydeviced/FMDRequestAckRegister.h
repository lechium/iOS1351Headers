...
- (void).cxx_destruct;	// IMP=0x00000001000291c0
...
- (_Bool)canReplace:(id)arg1;	// IMP=0x0000000100029000
- (id)requestBody;	// IMP=0x0000000100028f20
- (id)requestUrl;	// IMP=0x0000000100028f14
- (id)initWithAccount:(id)arg1 registerCommand:(id)arg2 ackURL:(id)arg3;	// IMP=0x0000000100028e3c
