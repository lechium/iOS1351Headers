...
- (void).cxx_destruct;	// IMP=0x0000000100070074
...
- (_Bool)canReplace:(id)arg1;	// IMP=0x000000010006fe70
- (_Bool)canRequestBeRetriedNow;	// IMP=0x000000010006fe68
- (id)requestBody;	// IMP=0x000000010006fb10
- (id)requestUrl;	// IMP=0x000000010006fb04
- (id)initWithAccount:(id)arg1 locateCommand:(id)arg2 ackURL:(id)arg3 cmdStatusCode:(long long)arg4 cmdStatusMessage:(id)arg5;	// IMP=0x000000010006f9e0
