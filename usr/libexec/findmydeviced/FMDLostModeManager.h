...
+ (id)sharedInstance;	// IMP=0x000000010001bb74
- (void).cxx_destruct;	// IMP=0x000000010001cc48
...
- (void)disableLostMode;	// IMP=0x000000010001c9ac
- (void)_loadLostModeInfo;	// IMP=0x000000010001c7c4
- (void)_storeLostModeInfo;	// IMP=0x000000010001c508
- (void)_updateLocationServicesState;	// IMP=0x000000010001c34c
- (void)enableLostModeWithMessage:(id)arg1 ownerNumber:(id)arg2 facetimeCapable:(_Bool)arg3 enableLocationServices:(_Bool)arg4 turnOffStatusBarIconAfterLostMode:(_Bool)arg5;	// IMP=0x000000010001bef0
- (void)dealloc;	// IMP=0x000000010001be6c
- (id)initSingleton;	// IMP=0x000000010001bce4
- (id)init;	// IMP=0x000000010001bc8c
