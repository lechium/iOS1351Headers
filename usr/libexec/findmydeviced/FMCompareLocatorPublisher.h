...
- (void).cxx_destruct;	// IMP=0x0000000100068c80
...
- (void)flushLocations;	// IMP=0x0000000100068b94
- (void)publishers:(id)arg1 performBlock:(CDUnknownBlockType)arg2;	// IMP=0x0000000100068ab8
- (void)logPublishedLocation:(id)arg1 reason:(long long)arg2 publisher:(id)arg3;	// IMP=0x00000001000686ec
- (void)startPublishingWithBlock:(CDUnknownBlockType)arg1;	// IMP=0x0000000100067b28
- (void)updatedLocations:(id)arg1 reason:(long long)arg2;	// IMP=0x0000000100067a08
- (void)updatedLocations:(id)arg1;	// IMP=0x00000001000679f8
- (id)initWithPrimaryPublisher:(id)arg1 compareToPublishers:(id)arg2;	// IMP=0x0000000100067950
