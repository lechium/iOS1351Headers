...
+ (_Bool)supportsSecureCoding;	// IMP=0x0000000100012710
+ (id)timeWithUtc_s:(double)arg1 utcUnc_s:(double)arg2 rtc_s:(double)arg3 sf:(double)arg4 source:(id)arg5;	// IMP=0x0000000100012488
+ (id)timeWithDictionary:(id)arg1;	// IMP=0x0000000100012b7c
...
- (_Bool)isEquivalent:(id)arg1;	// IMP=0x0000000100012a08
- (id)description;	// IMP=0x000000010001295c
- (id)initWithCoder:(id)arg1;	// IMP=0x0000000100012818
- (void)encodeWithCoder:(id)arg1;	// IMP=0x0000000100012718
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000126b8
- (void)dealloc;	// IMP=0x0000000100012440
- (id)initWithUtc_ns:(long long)arg1 utcUnc_s:(double)arg2 rtc_ns:(long long)arg3 sf:(double)arg4 sfUnc:(double)arg5 source:(id)arg6;	// IMP=0x000000010001239c
- (id)init;	// IMP=0x0000000100012378
- (id)dictionary;	// IMP=0x0000000100012cb4
