...
- (void).cxx_destruct;	// IMP=0x00000001000e96c4
...
- (id)description;	// IMP=0x00000001000e9450
...
- (id)copyWithZone:(struct _NSZone *)arg1;	// IMP=0x00000001000e8dfc
- (id)initWithEventRepresentation:(id)arg1;	// IMP=0x00000001000e8c98
- (void)_setCommandKeyPressed:(_Bool)arg1;	// IMP=0x00000001000e9700
