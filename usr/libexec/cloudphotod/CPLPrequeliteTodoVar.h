...
+ (id)todoVariableWithName:(id)arg1 defaultExpirationInterval:(double)arg2;	// IMP=0x0000000100058900
+ (id)todoVariableWithName:(id)arg1;	// IMP=0x00000001000588f0
- (void).cxx_destruct;	// IMP=0x0000000100059580
...
- (id)setHasCompletedGeneration:(long long)arg1 now:(id)arg2;	// IMP=0x000000010005946c
- (id)hasSomethingTodoNow:(id)arg1;	// IMP=0x00000001000593d8
- (id)setHasCompletedGeneration:(long long)arg1;	// IMP=0x0000000100059360
@property(readonly, nonatomic) id <PQLInjecting> hasSomethingTodo;
- (id)initWithName:(id)arg1 defaultExpirationInterval:(double)arg2;	// IMP=0x0000000100058960
