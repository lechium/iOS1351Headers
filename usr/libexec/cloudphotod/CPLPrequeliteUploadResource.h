...
- (void).cxx_destruct;	// IMP=0x0000000100049a08
...
- (id)resource;	// IMP=0x0000000100049848
- (id)initWithResource:(id)arg1;	// IMP=0x0000000100049658
- (id)initFromPQLResultSet:(id)arg1 error:(id *)arg2;	// IMP=0x00000001000494b4
