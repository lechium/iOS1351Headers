...
+ (id)testObjectWithInfo:(id)arg1;	// IMP=0x000000010000ba9c
- (void).cxx_destruct;	// IMP=0x000000010000bfa8
...
- (unsigned long long)deletes;	// IMP=0x000000010000be2c
- (void)addDeletes:(unsigned long long)arg1;	// IMP=0x000000010000bd60
- (void)addTerminationFailure:(id)arg1;	// IMP=0x000000010000bc98
- (void)addRemoveFailure:(id)arg1;	// IMP=0x000000010000bbd0
- (id)description;	// IMP=0x000000010000baf0
- (id)initWithInfo:(id)arg1;	// IMP=0x000000010000b780
