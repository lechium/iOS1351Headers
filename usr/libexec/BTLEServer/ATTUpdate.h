...
+ (id)updateWithValue:(id)arg1 characteristic:(id)arg2 centrals:(id)arg3;	// IMP=0x0000000100048670
- (void).cxx_destruct;	// IMP=0x000000010004871c
...
- (id)initWithValue:(id)arg1 characteristic:(id)arg2 centrals:(id)arg3;	// IMP=0x00000001000485a0
