...
@interface NWAWDLBConnectionReport : PBCodable <NSCopying> {
	...
	SCD_Struct_NW19* _connectionReadyTimes;
	SCD_Struct_NW16* _resumptionFailureErrors;
	SCD_Struct_NW19* _resumptionFailureTimes;
	SCD_Struct_NW19* _resumptionSuccessTimes;
