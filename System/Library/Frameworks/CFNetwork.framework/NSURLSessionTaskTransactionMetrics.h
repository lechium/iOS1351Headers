...
@interface NSURLSessionTaskTransactionMetrics : NSObject <NSSecureCoding> {
	...
	SCD_Struct_NS63 __connectionTiming;
...
@property (assign,nonatomic) SCD_Struct_NS63 _connectionTiming;                    //@synthesize _connectionTiming=__connectionTiming - In the implementation block
...
-(SCD_Struct_NS63)_connectionTiming;
-(void)set_connectionTiming:(SCD_Struct_NS63)arg1 ;
