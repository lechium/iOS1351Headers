...
-(NSString *)variant;
-(BOOL)isEraser;
-(double)radiusForPoint:(SCD_Struct_PK7)arg1 context:(SCD_Struct_PK15*)arg2 ;
-(double)edgeWidthForPoint:(SCD_Struct_PK7)arg1 context:(SCD_Struct_PK15*)arg2 ;
...
-(double)solve:(vector<PKOutputFunction, std::__1::allocator<PKOutputFunction> >*)arg1 forPoint:(SCD_Struct_PK7)arg2 context:(SCD_Struct_PK15*)arg3 weight:(double)arg4 ;
...
-(double)brushOpacityForPoint:(SCD_Struct_PK7)arg1 context:(SCD_Struct_PK15*)arg2 ;
-(double)alphaForStroke:(id)arg1 ;
-(PKStrokePoint)outputForPoint:(SCD_Struct_PK7)arg1 context:(SCD_Struct_PK15*)arg2 ;
