...
@class NSString, CKRecordID, NSDate, CKReference, CKContainerID, CKEncryptedData, NSData, NSArray, NSURL, CKRecordValueStore, CKEncryptedRecordValueStore, NSDictionary, NSNumber, NSUUID, NSSet;
