...
@protocol OS_dispatch_source, OS_os_log, TKSmartCardSlotDelegate, OS_dispatch_queue;
...
@property (assign) BOOL synchronousSetup;                               //@synthesize synchronousSetup=_synchronousSetup - In the implementation block
