...
@class UILongPressGestureRecognizer, UITapGestureRecognizer, UIView, EKDayOccurrenceView, EKEvent, EKCalendarDate, NSTimer, EKUIRecurrenceAlertController, _UIDragSnappingFeedbackGenerator, EKICSPreviewController, UIDropInteraction, UIDragInteraction, NSString;
