...
@class NSURL, NSNumber, NSString, NSSet, NSPersonNameComponents, NSArray, NSDate, NSDictionary, NSData, NSError, NSFileProviderItemVersion, NSProgress, FPSandboxingURLWrapper, FPItemID;
