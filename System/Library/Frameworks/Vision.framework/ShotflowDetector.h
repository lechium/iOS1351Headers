...
+(id)processingDeviceDetectorWithEspressoNetwork:(SCD_Struct_Sh36*)arg1 espressoPlan:(void*)arg2 networkThreshold:(float)arg3 filterThreshold:(id)arg4 ;
+(id)processingDeviceDetectorWithEspressoNetwork:(SCD_Struct_Sh36*)arg1 espressoPlan:(void*)arg2 ;
