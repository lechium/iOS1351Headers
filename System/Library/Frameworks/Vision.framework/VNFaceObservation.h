...
@class VNFaceLandmarks2D, VNFaceLandmarks3D, VNFaceRegionMap, VNFaceAttributes, VNFaceprint, VNTorsoprint, VNFaceTorsoprint, VNFaceSegments, NSDictionary, NSData, NSArray, NSNumber;
...
@property (nonatomic,readonly) SCD_Struct_VN41 pose; 
...
+(BOOL)computeYawPitchRollFromPoseMatrix:(SCD_Struct_VN41)arg1 outputYaw:(float*)arg2 outputPitch:(float*)arg3 outputRoll:(float*)arg4 ;
