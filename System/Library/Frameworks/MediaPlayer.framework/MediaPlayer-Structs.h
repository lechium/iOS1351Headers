...
typedef struct {
	...
	SCD_Struct_MP48 album;
	SCD_Struct_MP14 artist;
	SCD_Struct_MP14 composer;
	SCD_Struct_MP14 genre;
	SCD_Struct_MP49 homeSharingAsset;
	SCD_Struct_MP50 lyrics;
} SCD_Struct_MP51;
