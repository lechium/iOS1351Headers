...
@property (nonatomic,retain) PUAlbumDropSessionController * dropSessionController;                                                                                   //@synthesize dropSessionController=_dropSessionController - In the implementation block
...
-(PUCollageView *)_feedCollageView;
-(void)set_feedCollageView:(PUCollageView *)arg1 ;
...
-(void)setDropSessionController:(PUAlbumDropSessionController *)arg1 ;
