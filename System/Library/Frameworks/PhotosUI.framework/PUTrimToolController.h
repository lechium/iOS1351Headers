...
@class PXLivePhotoTrimScrubber, PLSlalomRegionEditor, PUTimeCodeOverlayView, NSLayoutConstraint, PXLivePhotoTrimScrubberSpec, UIButton, PICompositionController, PLEditSource, PULivePhotoKeyFrameSelectionViewController, PLPhotoEditRenderer, AVPlayerItem, PXLivePhotoTrimScrubberSnapStripController, NSNumber, UILabel, UIView, UIImage, NSString;
