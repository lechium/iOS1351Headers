...
@property (nonatomic,readonly) PUCPAnalyticsBrowsingViewModelChangeObserver * cpAnalyticsChangeObserver;                                                                                  //@synthesize cpAnalyticsChangeObserver=_cpAnalyticsChangeObserver - In the implementation block
...
-(PUCPAnalyticsBrowsingViewModelChangeObserver *)cpAnalyticsChangeObserver;
