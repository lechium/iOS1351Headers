...
@property (assign,nonatomic) SCD_Struct_MK8 region; 
...
+(SCD_Struct_MK8)_regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 viewInsets:(UIEdgeInsets)arg3 edgePadding:(UIEdgeInsets)arg4 region:(SCD_Struct_MK8)arg5 minZoomLevel:(double)arg6 maxZoomLevel:(double)arg7 snapToZoomLevel:(BOOL)arg8 ;
+(SCD_Struct_MK8)regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 edgeInsets:(UIEdgeInsets)arg3 region:(SCD_Struct_MK8)arg4 ;
...
+(SCD_Struct_MK8)regionThatFitsMapType:(unsigned long long)arg1 viewSize:(CGSize)arg2 region:(SCD_Struct_MK8)arg3 ;
...
-(void)_displayWorld;
-(void)setRegion:(SCD_Struct_MK8)arg1 animated:(BOOL)arg2 ;
...
-(CGRect)_convertRegion:(SCD_Struct_MK8)arg1 toRectToView:(id)arg2 ;
-(SCD_Struct_MK8)_convertRect:(CGRect)arg1 toRegionFromView:(id)arg2 ;
...
-(double)_zoomLevelForRegion:(SCD_Struct_MK8)arg1 includeAccessoryPadding:(BOOL)arg2 ;
...
-(SCD_Struct_MK9)_zoomRegionForMapRect:(SCD_Struct_MK6)arg1 edgePadding:(UIEdgeInsets)arg2 maxZoomLevel:(long long)arg3 minZoomLevel:(long long)arg4 ;
...
-(void)setVehicleState:(SCD_Struct_MK10)arg1 ;
...
-(CGRect)convertRegion:(SCD_Struct_MK8)arg1 toRectToView:(id)arg2 ;
-(SCD_Struct_MK8)convertRect:(CGRect)arg1 toRegionFromView:(id)arg2 ;
...
-(SCD_Struct_MK8)regionThatFits:(SCD_Struct_MK8)arg1 ;
