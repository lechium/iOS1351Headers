...
@class MKPlaceCardHeaderViewController, MKPlaceHeaderButtonsViewController, MKETAProvider, MKInfoCardLoadingView, MKNearestStationViewController, MKMapItem, NSString, MKPlaceActionManager, MKPlaceCardActionsViewController, NSNumber, MKPlaceCardActionItem, GEOAutomobileOptions, GEOTransitOptions;
