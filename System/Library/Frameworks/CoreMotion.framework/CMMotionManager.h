...
+(SCD_Struct_CM37)gyroCalibrationDatabaseGetBiasFit;
...
+(SCD_Struct_CM37)gyroCalibrationDatabaseGetBiasFitAndEstimate:(SCD_Struct_CM9*)arg1 atTemperature:(float)arg2 ;
+(BOOL)hasRunMiniCal;
-(id)init;
-(void)dealloc;
-(void)connect;
...
-(void)onGeomagneticModel:(const SCD_Struct_CM28*)arg1 ;
-(void)deallocPrivate;
...
-(void)startDeviceMotionLiteUpdatesForDeviceID:(id)arg1 usingConfiguration:(SCD_Struct_CM38)arg2 toQueue:(id)arg3 withFusedHandler:(/*^block*/id)arg4 ;
