...
@interface SCNAuthoringEnvironment : NSObject {
	...
	SCD_Struct_SC131* _logsInfo;
	SCD_Struct_SC131* _boldLogsInfo;
	SCD_Struct_SC131* _dynamicLinesInfo;
	SCD_Struct_SC131* _dynamicLinesNoDepthTestInfo;
	SCD_Struct_SC131* _dynamicTrianglesInfo;
	SCD_Struct_SC131* _overlayDynamicLinesInfo;
	SCD_Struct_SC131* _overlayDynamicTriangleInfo;
	SCD_Struct_SC131* _textInfo;
	SCD_Struct_SC131* _lightProbesInfo;
	SCD_Struct_SC133* _normalTextInfo;
	SCD_Struct_SC133* _boldTextInfo;
	...
	SCD_Struct_SC135* _statisticsInfo;
	float _drawScale;
	id _delegate;
