...
@interface SCNMTLRenderContext : NSObject <SCNBufferStream> {
	...
	SCD_Struct_SC50 _renderPassParameters;
	SCD_Struct_SC51 _currentStreamBufferIndices;
	...
	SCD_Struct_SC52* _processingContext;
	unsigned _seed;
	SCNSceneBuffer _frameUniforms[6];
	SCD_Struct_SC55 _sceneUniforms;
	SCD_Struct_SC56 _lightsData;
	SCD_Struct_SC58* _nodeUniforms;
	SCD_Struct_SC73* _lighting;
	Cache* _cache;
	SCD_Struct_SC75* _deferredRendering;
	SCD_Struct_SC76 _compositeRendering[2];
	SCNMTLRenderPipeline* _downSamplePipeline;
	SCD_Struct_SC77 _skCompositing;
	SCD_Struct_SC78 _debug;
	BOOL _showsAuthoringEnvironment;
	SCD_Struct_SC79 _compilationIssues;
...
-(void)beginRenderPass:(id)arg1 renderEncoder:(void*)arg2 parameters:(SCD_Struct_SC50)arg3 ;
-(void)endRenderPass;
