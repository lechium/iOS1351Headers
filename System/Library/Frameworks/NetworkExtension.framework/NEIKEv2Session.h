...
@property (nonatomic,retain) NSMutableArray * pendingInformationalContexts;              //@synthesize pendingInformationalContexts=_pendingInformationalContexts - In the implementation block
...
-(void)initiatePrivateNotifies:(id)arg1 maxRetries:(unsigned)arg2 retryIntervalInMilliseconds:(unsigned long long)arg3 callbackQueue:(id)arg4 callback:(/*^block*/id)arg5 ;
...
-(void)initiateMOBIKEWithRetries:(unsigned)arg1 retryInterval:(unsigned long long)arg2 invalidateTransport:(BOOL)arg3 callbackQueue:(id)arg4 callback:(/*^block*/id)arg5 ;
-(int)sendRequest:(id)arg1 isKeepalive:(BOOL)arg2 retryIntervalInMilliseconds:(unsigned long long)arg3 maxRetries:(unsigned)arg4 timeoutError:(id)arg5 resend:(BOOL)arg6 sendMessageID:(int)arg7 sendCompletionHandler:(/*^block*/id)arg8 replyHandler:(/*^block*/id)arg9 ;
-(void)reportShortDPD;
...
-(BOOL)initiateDelete:(/*^block*/id)arg1 sendCompletionHandler:(/*^block*/id)arg2 ;
...
-(void)resendPreviousMOBIKEInnerWithRetries:(unsigned)arg1 retryInterval:(unsigned long long)arg2 callbackQueue:(id)arg3 callback:(/*^block*/id)arg4 handler:(/*^block*/id)arg5 ;
-(NEIKEv2RTT *)rttState;
-(void)initiateMOBIKEInnerWithRetries:(unsigned)arg1 retryInterval:(unsigned long long)arg2 callbackQueue:(id)arg3 callback:(/*^block*/id)arg4 ;
...
-(void)initiateKeepaliveWithRetries:(unsigned)arg1 retryIntervalInMilliseconds:(unsigned long long)arg2 callbackQueue:(id)arg3 callback:(/*^block*/id)arg4 ;
...
-(void)initiateDelete:(BOOL)arg1 replyCompleteBlock:(/*^block*/id)arg2 ;
-(void)initiateDelete:(BOOL)arg1 sendCompleteBlock:(/*^block*/id)arg2 ;
...
-(NSMutableArray *)pendingInformationalContexts;
-(void)setPendingInformationalContexts:(NSMutableArray *)arg1 ;
