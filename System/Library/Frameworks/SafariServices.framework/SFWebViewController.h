...
@protocol _SFAuthenticatorDialog, SFWebViewControllerDelegate;
@class _SFFormAutoFillController, NSString, _SFDialog, WKWebViewConfiguration, _SFDialogController, NSUUID, WKWebView, _SFAuthenticationContext;
