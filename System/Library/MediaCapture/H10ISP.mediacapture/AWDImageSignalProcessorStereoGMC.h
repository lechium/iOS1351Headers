...
@property (assign,nonatomic) BOOL hasEflScale; 
@property (assign,nonatomic) int eflScale;                              //@synthesize eflScale=_eflScale - In the implementation block
...
-(void)setEflScale:(int)arg1 ;
-(void)setHasEflScale:(BOOL)arg1 ;
-(BOOL)hasEflScale;
-(int)eflScale;
@end
