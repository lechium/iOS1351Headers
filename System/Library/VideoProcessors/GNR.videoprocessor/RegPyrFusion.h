...
@interface RegPyrFusion : NSObject {
	...
	SCD_Struct_Re5* _teleIsRefCalibData;
	SCD_Struct_Re5* _wideIsRefCalibData;
...
-(int)registerImagesWithReferenceCam:(int)arg1 calibInfo:(SCD_Struct_Re9*)arg2 ;
...
-(void)scaleHomographyUsingCalib:(SCD_Struct_Re5*)arg1 to:(id*)arg2 ;
