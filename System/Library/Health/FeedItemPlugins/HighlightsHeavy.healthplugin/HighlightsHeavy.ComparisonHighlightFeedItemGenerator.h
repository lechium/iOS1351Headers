...
@interface HighlightsHeavy.ComparisonHighlightFeedItemGenerator : HealthExperience.AsynchronousOperation {

	 underlyingResult;
	 healthStore;
	 operationQueue;
	 pluginFeedItemProvider;
	 changedSampleTypeToRegenerationStrategy;
	 $__lazy_storage_$_collatorOperation;
