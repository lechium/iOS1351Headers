...
@class ASActivitySharingManager, ASContactsManager, NSObject, APSConnection, CKShare, NSHashTable, ASNotificationStep, NSArray, ASCloudKitServerChangeTokenCache, NSDictionary, ASCloudKitUtility, CKContainer, NSDate, NSString;
