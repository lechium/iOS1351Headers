...
@protocol NoteContentLayerDelegate, NoteContentLayerAttachmentPresentationDelegate, NotesTextureScrolling;
...
@property (assign,nonatomic,__weak) id<NotesTextureScrolling> textureScrollingDelegate;                                             //@synthesize textureScrollingDelegate=_textureScrollingDelegate - In the implementation block
