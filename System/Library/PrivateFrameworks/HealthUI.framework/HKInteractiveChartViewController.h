...
#import <libobjc.A.dylib/HKInteractiveChartCurrentValueViewDelegate.h>
...
#import <libobjc.A.dylib/HKCurrentValueViewDataSourceValueRangeFormatter.h>

@protocol HKInteractiveChartCurrentValueViewHandler, HKInteractiveChartCurrentValueViewCallbacks;
