...
@class PKDashboardStackedImageCollectionViewCell, PKPeerPaymentWebService, PKPeerPaymentController, PKPeerPaymentContactResolver, PKPaymentDefaultDataProvider, PKPaymentTransactionDetailsFactory, NSString;
