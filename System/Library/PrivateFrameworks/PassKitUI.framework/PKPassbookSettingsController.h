...
-(void)_refreshCredentialInvitationsWithCompletion:(/*^block*/id)arg1 ;
...
-(void)_presentCredentialSetupViewControllerForPaymentPass:(id)arg1 invitation:(id)arg2 shouldRequestInvitation:(BOOL)arg3 completion:(/*^block*/id)arg4 ;
