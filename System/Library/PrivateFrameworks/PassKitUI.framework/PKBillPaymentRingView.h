...
@interface PKBillPaymentRingView : UIView <UIGestureRecognizerDelegate, PKRenderLoopDelegate> {
	...
	SCD_Struct_PK13 _spring;
	SCD_Struct_PK14 _angleState;
	SCD_Struct_PK13 _responseSpring;
	SCD_Struct_PK14 _responseState;
	double _responseSpringElapsedDuration;
	SCD_Struct_PK13 _scaleSpring;
	SCD_Struct_PK14 _scaleState;
	BOOL _dragging;
	BOOL _pressed;
