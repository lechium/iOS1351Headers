...
@interface PKStackedTextItemView : UIView {
	...
	SCD_Struct_PK21 _contentConstraints;
...
@property (assign,nonatomic) SCD_Struct_PK21 contentConstraints;              //@synthesize contentConstraints=_contentConstraints - In the implementation block
...
-(SCD_Struct_PK22)_titleFontMetrics;
...
-(SCD_Struct_PK21)boundingMetricForWidth:(double)arg1 ;
-(void)setContentConstraints:(SCD_Struct_PK21)arg1 ;
-(SCD_Struct_PK21)contentConstraints;
@end
