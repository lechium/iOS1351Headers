...
-(SCD_Struct_PK16)_layoutStateForHeaderContextInTable:(id)arg1 withBounds:(CGRect)arg2 ;
...
-(SCD_Struct_PK17)discoveryGalleryLayoutStateForCurrentLayoutState;
