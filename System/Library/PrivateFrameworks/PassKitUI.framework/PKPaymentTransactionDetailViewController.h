...
@class PKPaymentTransaction, NSArray, PKTransactionReceipt, PKPaymentTransactionCellController, PKAccountServiceAccountResolutionController, NSString, PKPaymentPass, PKPaymentTransactionDetailHeaderView, PKPeerPaymentContactResolver, PKPeerPaymentController, UIImage, PKPeerPaymentStatusResponse, NSDateFormatter, NSTimeZone;
