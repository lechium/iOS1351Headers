...
-(CGRect)_targetNavigationControllerFrameForInfo:(SCD_Struct_PK26)arg1 ;
-(void)updateChildViewControllerSizeAnimated:(BOOL)arg1 forceUpdate:(BOOL)arg2 ;
-(void)_endLayoutGroup;
-(CGSize)_navigationControllerSizeForChildViewControllerInfo:(SCD_Struct_PK26)arg1 withCurrentInfo:(SCD_Struct_PK26)arg2 ;
-(void)updateChildViewControllerSizeAnimated:(BOOL)arg1 ;
-(SCD_Struct_PK26)_infoForViewController:(id)arg1 ;
