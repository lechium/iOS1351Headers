...
@class PKPaymentWebService, NSMutableArray, PKPaymentService, NSArray, NSMutableSet, PKAccount, NSObject, NSString, DIVerificationSession, PKAssertion, PKFeatureApplication, PKPaymentProvisioningController, PKPaymentInstallmentConfiguration;
