...
-(void)_handleIncomingMessage:(id)arg1 securityToken:(SCD_Struct_AX13)arg2 auditToken:(SCD_Struct_AX4)arg3 clientPort:(unsigned)arg4 completion:(/*^block*/id)arg5 ;
@end
