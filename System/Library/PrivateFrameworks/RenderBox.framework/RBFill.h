...
-(void)setImage:(CGImageRef)arg1 transform:(CGAffineTransform)arg2 interpolation:(int)arg3 tintColor:(SCD_Struct_RB26)arg4 flags:(unsigned)arg5 ;
-(void)setTiledImage:(CGImageRef)arg1 transform:(CGAffineTransform)arg2 sourceRect:(CGRect)arg3 interpolation:(int)arg4 tintColor:(SCD_Struct_RB26)arg5 flags:(unsigned)arg6 ;
-(void)set9PartImage:(CGImageRef)arg1 transform:(CGAffineTransform)arg2 destinationRect:(CGRect)arg3 capInsets:(SCD_Struct_RB3)arg4 repeat:(BOOL)arg5 interpolation:(int)arg6 tintColor:(SCD_Struct_RB26)arg7 flags:(unsigned)arg8 ;
@end
