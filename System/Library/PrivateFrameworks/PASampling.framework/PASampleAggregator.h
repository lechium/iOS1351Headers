...
@property (readonly) double sampleIntervalLimit;                                //@synthesize sampleIntervalLimit=_sampleIntervalLimit - In the implementation block
@property (copy) PASampleAggregatorOptions * options;                           //@synthesize options=_options - In the implementation block
...
@property (assign) BOOL aggregateStacksByThread; 
@property (assign) BOOL aggregateStacksByProcess; 
...
@property (assign) BOOL displayBlockedReasons; 
@property (assign) BOOL displayBlockedReasonsLackingProcessOwners; 
@property (assign) BOOL displayAddressesInBlockedReasons; 
@property (assign) BOOL displayEmptyBootArgs; 
@property (assign) BOOL displayAllHIDEvents; 
