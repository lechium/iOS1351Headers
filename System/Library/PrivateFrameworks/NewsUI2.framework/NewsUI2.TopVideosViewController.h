...
@interface NewsUI2.TopVideosViewController : UIViewController <TUDeselectable, TUKeyCommandTraversable, TSTabBarSplitViewAutoObserver, TSBlueprintInspectable, TUPluggable, TSVideoGroupViewControllerType> {
