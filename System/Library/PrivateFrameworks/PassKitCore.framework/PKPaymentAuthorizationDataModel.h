...
@class NSMutableArray, NSMutableDictionary, NSArray, NSMapTable, NSString, PKPaymentPass, PKRemoteDevice, PKPaymentRequest, CNContact, PKShippingMethod, PKPayment, PKPaymentOptionsDefaults, PKPaymentOptionsRecents, PKPassLibrary, PKPaymentWebService, PKPeerPaymentService, PKPeerPaymentQuote, PKDisbursementApplicationInformation, PKBankAccountInformation, PKCurrencyAmount, NSDecimalNumber, PKPaymentApplication, PKPaymentInstructions, PKRemotePaymentInstrument, NSSet;
