...
@class NSMutableDictionary, NSMutableSet, NSProgress, WKWebView, NSArray, EMMailDropMetadata, NSString;
...
@property (nonatomic,retain) EMMailDropMetadata * mailDropBannerMetadata;                                         //@synthesize mailDropBannerMetadata=_mailDropBannerMetadata - In the implementation block
...
-(void)setMailDropBannerMetadata:(EMMailDropMetadata *)arg1 ;
