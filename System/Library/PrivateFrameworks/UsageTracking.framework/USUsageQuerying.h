...
@property (readonly) id<_DKKnowledgeQuerying> eventStorage;              //@synthesize eventStorage=_eventStorage - In the implementation block
...
-(id<_DKKnowledgeQuerying>)eventStorage;
...
-(void)_computeUncategorizedLocalWebUsageWithApplicationUsageEvents:(id)arg1 webUsageEvents:(id)arg2 uncategorizedDomains:(id)arg3 interval:(id)arg4 referenceDate:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
...
-(void)_enumerateCurrentApplicationUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(/*^block*/id)arg3 ;
...
-(void)_enumerateCurrentWebUsageIntervalsDuringInterval:(id)arg1 referenceDate:(id)arg2 block:(/*^block*/id)arg3 ;
