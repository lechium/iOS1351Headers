...
-(unsigned long long)acceptabilityOfWordBuffer:(char*)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned)arg4 forPrediction:(BOOL)arg5 ;
...
-(id)_accentCorrectionResultForString:(id)arg1 range:(NSRange)arg2 inString:(id)arg3 offset:(unsigned long long)arg4 language:(id)arg5 onlyAtInsertionPoint:(BOOL)arg6 keyEventArray:(id)arg7 selectedRangeValue:(id)arg8 ;
...
-(unsigned long long)acceptabilityOfWordBuffer:(char*)arg1 length:(unsigned long long)arg2 language:(id)arg3 encoding:(unsigned)arg4 forPrediction:(BOOL)arg5 depth:(unsigned long long)arg6 ;
