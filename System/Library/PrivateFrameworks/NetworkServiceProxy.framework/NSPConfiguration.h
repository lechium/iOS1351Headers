...
@property (retain) NSURLSession * waldoSession;                     //@synthesize waldoSession=_waldoSession - In the implementation block
@property (assign) BOOL ignoreInvalidCerts;                         //@synthesize ignoreInvalidCerts=_ignoreInvalidCerts - In the implementation block
@property (retain) NSDictionary * edgeSets;                         //@synthesize edgeSets=_edgeSets - In the implementation block
