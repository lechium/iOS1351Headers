...
@class SGSqliteDatabaseImpl, NSMutableDictionary, NSString;
...
-(BOOL)prepAndRunQuery:(id)arg1 arrays:(id)arg2 onPrep:(/*^block*/id)arg3 onRow:(/*^block*/id)arg4 onError:(/*^block*/id)arg5 ;
