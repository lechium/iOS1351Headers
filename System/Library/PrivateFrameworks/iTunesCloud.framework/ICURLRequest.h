...
@class NSProgress, NSMutableArray, NSMutableDictionary, NSObject, ICRequestContext, NSData, ICURLResponseHandler, NSURLRequest, NSURLSessionTask, NSURLResponse, NSMutableData, NSURL, NSError, NSDictionary, NSString;
