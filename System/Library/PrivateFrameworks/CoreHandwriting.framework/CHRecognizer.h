...
@class NSLocale, NSCharacterSet, CHRecognitionInsightRequest, CHRecognitionInsight, NSArray, CHStrokeTransitionModel, CHCutpointModel, NSObject, CHPatternNetwork, CHRecognizerConfiguration, NSDictionary, NSMutableDictionary, CHSpellChecker, NSURL, CHDrawing, NSString, NSMutableIndexSet;
...
-(unsigned)normalizeLMTokenIDForWord:(id)arg1 withTokenID:(unsigned)arg2 isFromPattern:(BOOL)arg3 outScore:(double*)arg4 ;
...
-(id)_lexiconCorrectionsForToken:(id)arg1 withLexicon:(LXLexiconRef)arg2 textReplacements:(id)arg3 consumableStrokesSet:(id)arg4 minimumTokenScore:(double)arg5 activeHistoryRange:(NSRange)arg6 outBestTokenScore:(double*)arg7 shouldCapitalizeWord:(BOOL)arg8 ;
