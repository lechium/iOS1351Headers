...
@interface BWMultiStreamCameraSourceNode : BWSourceNode <BWFigCameraSourceNode> {
	...
	opaqueCMFormatDescriptionRef _pointCloudOutputFormatDescription;
	unsigned _sensorInterfaceRawPixelFormat;
	...
	SCD_Struct_BW112 _sphereShiftState;
