...
-(id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM45*)arg2 error:(id*)arg3;
...
-(id)newComputePipelineStateWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM45*)arg2 error:(id*)arg3;
...
-(BOOL)mapShaderSampleBufferWithBuffer:(SCD_Struct_CM47*)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3;
...
-(id)newLibraryWithCIFilters:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM45*)arg2 error:(id*)arg3;
-(id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_CM45*)arg2 error:(id*)arg3;
...
-(SCD_Struct_CM48*)tileSizeWithSparsePageSize:(unsigned long long)arg1 textureType:(unsigned long long)arg2 pixelFormat:(unsigned long long)arg3 sampleCount:(unsigned long long)arg4;
...
-(SCD_Struct_CM50*)libraryCacheStats;
-(SCD_Struct_CM50*)pipelineCacheStats;
