...
@interface FigCapturePreviewSinkPipelineConfiguration : NSObject {
	...
	SCD_Struct_BW99 _sceneClassifierPipelineVersion;
...
@property (assign,nonatomic) SCD_Struct_BW99 sceneClassifierPipelineVersion;                                                       //@synthesize sceneClassifierPipelineVersion=_sceneClassifierPipelineVersion - In the implementation block
...
-(void)setSceneClassifierPipelineVersion:(SCD_Struct_BW99)arg1 ;
...
-(SCD_Struct_BW99)sceneClassifierPipelineVersion;
