...
-(void)setSmartCameraVersion:(SCD_Struct_BW99)arg1 ;
...
-(id)initWithAttributes:(id)arg1 synchronizedStreamsAttributes:(id)arg2 multiCamEnabled:(BOOL)arg3 applicationID:(id)arg4 clientAuditToken:(SCD_Struct_BW65)arg5 deviceVendorClientID:(int)arg6 overCaptureEnabledTemporaryHack:(BOOL)arg7 error:(int*)arg8 ;
