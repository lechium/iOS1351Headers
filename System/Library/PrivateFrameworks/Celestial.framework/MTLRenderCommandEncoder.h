...
-(void)dispatchThreadsPerTile:(SCD_Struct_CM48)arg1;
...
-(void)setViewport:(SCD_Struct_CM52)arg1;
...
-(void)setScissorRect:(SCD_Struct_CM53)arg1;
...
-(void)setViewports:(const SCD_Struct_CM52*)arg1 count:(unsigned long long)arg2;
-(void)setVertexAmplificationCount:(unsigned long long)arg1 viewMappings:(const SCD_Struct_CM50*)arg2;
-(void)setDepthClipMode:(unsigned long long)arg1;
-(void)setScissorRects:(const SCD_Struct_CM53*)arg1 count:(unsigned long long)arg2;
