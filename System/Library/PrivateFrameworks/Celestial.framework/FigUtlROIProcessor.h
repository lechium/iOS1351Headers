...
@interface FigUtlROIProcessor : NSObject {
	...
	SCD_Struct_Fi22 _originalToRoiMatrix;
	SCD_Struct_Fi22 _roiToOriginalMatrix;

}

@property (nonatomic,readonly) SCD_Struct_Fi22 originalToRoiMatrix;              //@synthesize originalToRoiMatrix=_originalToRoiMatrix - In the implementation block
@property (nonatomic,readonly) SCD_Struct_Fi22 roiToOriginalMatrix;              //@synthesize roiToOriginalMatrix=_roiToOriginalMatrix - In the implementation block
...
-(SCD_Struct_Fi22)matrix:(int)arg1 rectangle:(CGRect)arg2 scaleX:(double)arg3 scaleY:(double)arg4 inverse:(SCD_Struct_Fi22*)arg5 ;
...
-(SCD_Struct_Fi22)originalToRoiMatrix;
-(SCD_Struct_Fi22)roiToOriginalMatrix;
-(CGRect)roiRectangle;
@end
