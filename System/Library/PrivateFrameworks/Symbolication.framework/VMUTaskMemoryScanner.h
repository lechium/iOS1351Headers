...
@class VMUClassInfoMap, NSString, VMUTaskMemoryCache, VMUObjectIdentifier, VMUVMRegionIdentifier, VMURangeArray, NSMutableArray, NSMutableDictionary, VMUDebugTimer, VMUProcessObjectGraph;
