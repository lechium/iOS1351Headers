...
@class NSString, NSNumber, NSFileHandle, NSDictionary, AFMyriadContext, NSXPCListenerEndpoint, NSURL, AFSpeechSynthesisRecord, CLLocation, AFLanguageDetectionUserContext, NSUUID;
