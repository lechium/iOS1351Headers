...
-(id)_handleOptionalAtIndex:(unsigned)arg1 withBuffer:(SCD_Struct_AF4*)arg2 totalLength:(unsigned long long)arg3 consumedLength:(unsigned*)arg4 containsPrivacySensitiveContents:(BOOL*)arg5 externalProviders:(BOOL*)arg6 ;
-(id)_handleProviderAtIndex:(unsigned)arg1 withBuffer:(SCD_Struct_AF4*)arg2 totalLength:(unsigned long long)arg3 consumedLength:(unsigned*)arg4 containsPrivacySensitiveContents:(BOOL*)arg5 hadEmpties:(BOOL*)arg6 externalProviders:(BOOL*)arg7 ;
-(id)_handleControlCodeAtIndex:(unsigned)arg1 withBuffer:(SCD_Struct_AF4*)arg2 totalLength:(unsigned long long)arg3 consumedLength:(unsigned*)arg4 hadEmpties:(BOOL*)arg5 containsPrivacySensitiveContents:(BOOL*)arg6 externalProviders:(BOOL*)arg7 ;
