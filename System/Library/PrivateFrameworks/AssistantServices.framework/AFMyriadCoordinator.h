...
@class NSData, NSMutableDictionary, NSString, NSObject, AFWatchdogTimer, AFPowerAssertionManager, AFMyriadRecord, NSDateFormatter, WPHeySiri, _DKKnowledgeStore, NSUUID, NSDate, AFMyriadEmergencyCallPunchout, SFDiagnostics;
...
@interface AFMyriadCoordinator : NSObject <WPHeySiriProtocol> {
	...
	SCD_Struct_AF9 _heySiriBTLEState;
