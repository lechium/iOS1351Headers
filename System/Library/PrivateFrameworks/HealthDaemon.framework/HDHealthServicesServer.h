...
@property (nonatomic,retain) id<HKHealthStoreClientInterface> clientRemoteObjectProxy;              //@synthesize clientRemoteObjectProxy=_clientRemoteObjectProxy - In the implementation block
...
-(id<HKHealthStoreClientInterface>)clientRemoteObjectProxy;
-(void)setClientRemoteObjectProxy:(id<HKHealthStoreClientInterface>)arg1 ;
@end
