...
-(BOOL)performGraphDatabaseWork:(/*^block*/id)arg1 usingTransaction:(BOOL)arg2 error:(id*)arg3 ;
-(id)conceptsForIdentifiers:(id)arg1 expectedOntologyVersion:(id)arg2 error:(id*)arg3 ;
-(id)_queue_conceptsWithGraphDatabaseCall:(/*^block*/id)arg1 error:(id*)arg2 ;
-(id)_conceptWithGraphDatabaseCall:(/*^block*/id)arg1 error:(id*)arg2 ;
-(id)_conceptsWithGraphDatabaseCall:(/*^block*/id)arg1 error:(id*)arg2 ;
