...
@class NSString, ACAccountStore, ACAccount, NSDictionary, ACAccountCredential, NSArray;
...
@property (nonatomic,copy) ACAccount * systemAccount;                                    //@synthesize systemAccount=_systemAccount - In the implementation block
