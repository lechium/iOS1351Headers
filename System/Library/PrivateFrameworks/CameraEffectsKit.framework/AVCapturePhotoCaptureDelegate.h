...
-(void)captureOutput:(id)arg1 didFinishProcessingLivePhotoToMovieFileAtURL:(id)arg2 duration:(SCD_Struct_JT6)arg3 photoDisplayTime:(SCD_Struct_JT6)arg4 resolvedSettings:(id)arg5 error:(id)arg6;
