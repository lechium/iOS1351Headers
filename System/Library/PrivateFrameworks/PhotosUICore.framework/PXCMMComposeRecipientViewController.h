...
@property (nonatomic,retain) PXCMMAddRecipientButton * addRecipientButton;                                        //@synthesize addRecipientButton=_addRecipientButton - In the implementation block
...
-(void)setAddRecipientButton:(PXCMMAddRecipientButton *)arg1 ;
