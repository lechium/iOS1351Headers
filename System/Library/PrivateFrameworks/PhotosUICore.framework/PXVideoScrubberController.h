...
@interface PXVideoScrubberController : PXObservable {
	...
	SCD_Struct_PX80 _videoScrubberDelegateFlags;
	SCD_Struct_PX38 _targetFlags;
	...
	SCD_Struct_PX26 __avPlayerCurrentTime;
	SCD_Struct_PX26 __avPlayerDuration;
...
@property (assign,setter=_setAvPlayerCurrentTime:,nonatomic) SCD_Struct_PX26 _avPlayerCurrentTime;                    //@synthesize _avPlayerCurrentTime=__avPlayerCurrentTime - In the implementation block
@property (assign,setter=_setAvPlayerDuration:,nonatomic) SCD_Struct_PX26 _avPlayerDuration;                          //@synthesize _avPlayerDuration=__avPlayerDuration - In the implementation block
...
-(SCD_Struct_PX26)_avPlayerCurrentTime;
-(void)_setAvPlayerCurrentTime:(SCD_Struct_PX26)arg1 ;
-(SCD_Struct_PX26)_avPlayerDuration;
-(void)_setAvPlayerDuration:(SCD_Struct_PX26)arg1 ;
@end
