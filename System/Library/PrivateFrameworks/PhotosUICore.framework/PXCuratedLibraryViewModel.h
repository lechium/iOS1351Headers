...
@interface PXCuratedLibraryViewModel : PXObservable <PXUIKeyCommandNamespace, PXMutablePhotosLibraryViewModel, PXCuratedLibraryAssetsDataSourceManagerDelegate, PXChangeObserver, PXAssetsDataSourceManagerObserver, PXInfoProvider, PXInfoUpdaterObserver> {
	...
	SCD_Struct_PX82 _selectedAssetsTypedCount;
	SCD_Struct_PX83 _pinchState;
	SCD_Struct_PX84 _allPhotosZoomState;
...
@property (assign,nonatomic) SCD_Struct_PX85 allPhotosZoomState;                                               //@synthesize allPhotosZoomState=_allPhotosZoomState - In the implementation block
...
@property (nonatomic,readonly) PXInfoUpdater * selectedAssetsTypeCountUpdater;                                 //@synthesize selectedAssetsTypeCountUpdater=_selectedAssetsTypeCountUpdater - In the implementation block
@property (nonatomic,readonly) NSObject*<OS_dispatch_queue> countUpdateQueue;                                  //@synthesize countUpdateQueue=_countUpdateQueue - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_PX81 pinchState;                                                     //@synthesize pinchState=_pinchState - In the implementation block
...
@property (nonatomic,readonly) BOOL allPhotosCaptionsVisible;                                                  //@synthesize allPhotosCaptionsVisible=_allPhotosCaptionsVisible - In the implementation block
...
@property (nonatomic,readonly) id<PXFilterState> currentFilterState;                                           //@synthesize currentFilterState=_currentFilterState - In the implementation block
@property (nonatomic,readonly) id<PXFilterState> allPhotosFilterState;                                         //@synthesize allPhotosFilterState=_allPhotosFilterState - In the implementation block
@property (nonatomic,readonly) SCD_Struct_PX82 selectedAssetsTypedCount;                                       //@synthesize selectedAssetsTypedCount=_selectedAssetsTypedCount - In the implementation block
...
-(void)setCurrentFilterState:(id<PXFilterState>)arg1 ;
...
-(void)setAllPhotosZoomState:(SCD_Struct_PX85)arg1 ;
...
-(void)setSelectedAssetsTypedCount:(SCD_Struct_PX82)arg1 ;
...
-(id<PXFilterState>)currentFilterState;
-(SCD_Struct_PX82)selectedAssetsTypedCount;
...
-(PXInfoUpdater *)selectedAssetsTypeCountUpdater;
-(NSObject*<OS_dispatch_queue>)countUpdateQueue;
