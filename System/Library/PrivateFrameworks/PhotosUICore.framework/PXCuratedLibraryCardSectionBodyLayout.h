...
#import <libobjc.A.dylib/PXGGradientSource.h>
...
@class NSIndexSet, PXAssetsDataSource, PXCuratedLibraryCardSectionBodyLayoutSpec, PXGLayoutGuide, PXCuratedLibrarySectionGeometryDescriptor, NSString;
