...
@property (assign,nonatomic) SCD_Struct_PX19 cornerRadius;                                                    //@synthesize cornerRadius=_cornerRadius - In the implementation block
...
-(void)setCornerRadius:(SCD_Struct_PX19)arg1 ;
