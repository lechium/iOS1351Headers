...
@class NSObject, PXGThumbnailRequestQueue, NSMapTable, NSMutableIndexSet, PXGImageRequestQueue, NSMutableDictionary, PXGAssetImageCache, NSArray, PXMediaProvider, NSString;
