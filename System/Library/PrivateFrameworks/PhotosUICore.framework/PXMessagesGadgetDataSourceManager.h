...
@class PXMessagesExtensionViewModel, PXCloudWelcomeGadgetProvider, PXMessagesCMMSuggestionsCollectionGadgetProvider, NSArray, PXCPLStatus, PXCMMSuggestionsDataSourceManager, UIViewController, NSString, PXMessagesRecentPhotosGadgetProvider, PXGadgetNavigationHelper;
