...
@class PXPlacesMapViewPort, NSMutableDictionary, UIFont, PXPhotosDetailsContext, PXWidgetSpec, PXUIWidgetContainerView, UIView, PXImageUIView, PXPlacesMapFetchResultViewController, NSString, UIButton, PHAsset, NSMutableArray, PXPlacesSnapshotFactory, PXTilingController, PXSectionedSelectionManager, PXOneUpPresentation;
...
@property (nonatomic,readonly) PXUIWidgetContainerView * _containerView;                               //@synthesize _containerView=__containerView - In the implementation block
...
-(PXUIWidgetContainerView *)_containerView;
