...
-(void)interactionStateDidChange:(SCD_Struct_PX20)arg1 ;
-(void)didFinishRequestingTextures;
-(void)cancelTextureRequests:(id)arg1 ;
-(long long)registerImageDataSpec:(SCD_Struct_PX79)arg1 ;
...
-(SCD_Struct_PX79)imageDataSpecAtIndex:(long long)arg1 ;
-(long long)requestQueue_indexForImageDataSpec:(SCD_Struct_PX79)arg1 ;
