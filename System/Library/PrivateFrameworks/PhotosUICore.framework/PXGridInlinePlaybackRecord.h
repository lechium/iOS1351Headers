...
@interface PXGridInlinePlaybackRecord : NSObject {
	...
	SCD_Struct_PX35 _bestVideoTimeRange;
...
@property (nonatomic,readonly) SCD_Struct_PX35 bestVideoTimeRange;              //@synthesize bestVideoTimeRange=_bestVideoTimeRange - In the implementation block
...
-(BOOL)isInvalid;
-(float)curationScore;
-(SCD_Struct_PX35)bestVideoTimeRange;
-(float)videoScore;
