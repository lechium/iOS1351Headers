...
@interface PXGSpriteMetadataStore : NSObject {
	...
	SCD_Struct_PX17* _resizableCapInsets;
	unsigned short _effectsCapacity;
	SCD_Struct_PX91* _effectData;
...
@property (nonatomic,readonly) const SCD_Struct_PX17* resizableCapInsets;              //@synthesize resizableCapInsets=_resizableCapInsets - In the implementation block
...
@property (nonatomic,readonly) const SCD_Struct_PX91* effectData;                      //@synthesize effectData=_effectData - In the implementation block
...
-(id)init;
-(void)dealloc;
-(const SCD_Struct_PX91*)effectData;
-(unsigned short)addResizableCapInsets:(SCD_Struct_PX17)arg1 ;
-(unsigned short)_indexOfResizableCapInsets:(SCD_Struct_PX17)arg1 ;
-(unsigned short)addEffectWithShaderFlags:(int)arg1 ;
-(void)removeEffectWithId:(unsigned short)arg1 ;
-(SCD_Struct_PX91*)dataForEffectId:(unsigned short)arg1 ;
-(unsigned short)numberOfResizableCapInsets;
-(const SCD_Struct_PX17*)resizableCapInsets;
