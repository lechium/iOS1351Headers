...
#import <libobjc.A.dylib/PXCuratedLibraryAllPhotosBodyLayout.h>
...
@interface PXGGridLayout : PXGItemsLayout <PXCuratedLibraryAllPhotosBodyLayout, PXGItemsGeometry, PXGDiagnosticsProvider> {
	...
	SCD_Struct_PX18 _itemCornerRadius;
	SCD_Struct_PX18 _edgeCornerRadius;
...
@property (assign,nonatomic) SCD_Struct_PX19 itemCornerRadius;                     //@synthesize itemCornerRadius=_itemCornerRadius - In the implementation block
@property (assign,nonatomic) SCD_Struct_PX19 edgeCornerRadius;                     //@synthesize edgeCornerRadius=_edgeCornerRadius - In the implementation block
...
-(void)setItemCornerRadius:(SCD_Struct_PX19)arg1 ;
-(void)setEdgeCornerRadius:(SCD_Struct_PX19)arg1 ;
...
-(SCD_Struct_PX19)itemCornerRadius;
-(SCD_Struct_PX19)edgeCornerRadius;
@end
