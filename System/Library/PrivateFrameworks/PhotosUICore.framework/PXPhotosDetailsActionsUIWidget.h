...
@class PXOneUpPresentation, PXWidgetSpec, PXPhotosDetailsContext, PXTilingController, PXUIScrollViewController, NSMutableSet, PXReusableObjectPool, PXPhotosDataSource, PHFetchResult, PXPhotoKitAssetCollectionActionManager, NSArray, PXPhotosDetailsViewModel, PXPhotosDetailsActionsSpecManager, PXActionRowTile, PXActionPerformer, NSString, PXSectionedSelectionManager;
