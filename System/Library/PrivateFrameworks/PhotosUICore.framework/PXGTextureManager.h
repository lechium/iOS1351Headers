...
@interface PXGTextureManager : NSObject <PXGTextureProviderDelegate> {
	...
	SCD_Struct_PX74* _streamInfoBySpriteIndex;
...
-(void)streamTexturesForSpritesInDataStore:(id)arg1 presentationDataStore:(id)arg2 changeDetails:(id)arg3 layout:(id)arg4 interactionState:(SCD_Struct_PX20)arg5 ;
-(void)_pruneTextures:(id)arg1 ;
-(void)_blockOnThumbnailsIfNeededWithGeometries:(SCD_Struct_PX33*)arg1 visibleRect:(CGRect)arg2 interactionState:(SCD_Struct_PX20)arg3 fences:(id)arg4 ;
-(void)_lookupLock_requestTexturesForSpritesInRange:(PXGSpriteIndexRange)arg1 textureProvider:(id)arg2 mediaKind:(int)arg3 presentationType:(int)arg4 isAppearing:(BOOL)arg5 layout:(id)arg6 leafSpriteIndexRange:(PXGSpriteIndexRange)arg7 sprites:(SCD_Struct_PX75*)arg8 textureStreamInfos:(SCD_Struct_PX74*)arg9 ;
...
-(id)_textureAtlasManagerForImageDataSpec:(SCD_Struct_PX39)arg1 ;
...
-(BOOL)_getRequestDetails:(out SCD_Struct_PX76*)arg1 forRequestID:(int)arg2 ;
