...
typedef struct _cxx_atomic_impl<DocLoadStatus, std::__1::__cxx_atomic_base_impl<DocLoadStatus> > {
	Ai __a_value;
} cxx_atomic_impl<DocLoadStatus, std::__1::__cxx_atomic_base_impl<DocLoadStatus> >;

typedef struct atomic<DocLoadStatus> {
	cxx_atomic_impl<DocLoadStatus, std::__1::__cxx_atomic_base_impl<DocLoadStatus> > __a_;
