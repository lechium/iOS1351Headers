...
-(BOOL)updateFaceMeshWithfaceKitData:(id)arg1 screenProjectionMatrix:(SCD_Struct_Ga0)arg2 inputImageSize:(SCD_Struct_Ga1)arg3 outputImageSize:(SCD_Struct_Ga1)arg4 inputIntrinsics:(SCD_Struct_Ga2)arg5 outputIntrinsics:(SCD_Struct_Ga2)arg6 extrinsics:(SCD_Struct_Ga0)arg7 correctionEnabled:(BOOL)arg8 groundTruthMode:(BOOL)arg9 gazeMesh:(id)arg10 uniforms:(SCD_Struct_Ga3*)arg11 latest_vertices:(vector<cva::Matrix<float, 3, 1, false>, std::__1::allocator<cva::Matrix<float, 3, 1, false> > >*)arg12 ;
