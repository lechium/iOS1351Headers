...
@class HKDisplayCategory, HKDisplayType, WDProfile, HKHealthStore, WDSourceOrderController, NSMutableSet, NSArray, NSMutableDictionary, HKTitledIconHeaderView, HKSourceListDataSource, NSMutableArray, NSSet, NSDictionary;
