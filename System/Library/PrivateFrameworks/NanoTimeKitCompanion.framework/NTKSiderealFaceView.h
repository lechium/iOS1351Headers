...
#import <libobjc.A.dylib/NTKSiderealDataSourceDelegate.h>
#import <libobjc.A.dylib/CLKMonochromeFilterProvider.h>

@class NSCalendar, NTKWhistlerAnalogFaceViewComplicationFactory, NSTimer, NTKSiderealDataSource, NSNumber, NTKSiderealDialBackgroundView, NTKSiderealAuxiliaryDialLabels, NTKSiderealTimeView, UILabel, UIView, CAShapeLayer, CALayer, NSDateFormatter, NTKFaceViewTapControl, NSString;
