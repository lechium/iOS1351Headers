...
@class NTKStopwatchButton, NTKChronoButton, NTKUtilityComplicationFactory, NTKChronoPalette, UIColor, UILabel, NTKColoringLabel, _LapLabel, NSTimer, CLKRelativeDateTextProvider, NSDate, NTKChronoScene, NTKChronoHandsView, NSString;
