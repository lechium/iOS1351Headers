...
@class NTKWhistlerAnalogFaceViewComplicationFactory, NTKUtilityComplicationFactory, NTKSpectrumAnalogDialView, NTKSpectrumConicQuad, CLKUIQuadView, UIView, NTKSpectrumAnalogColorEditOption, NSString;
...
@interface NTKSpectrumAnalogFaceView : NTKAnalogFaceView <CLKMonochromeFilterProvider, NTKUtilityFlatComplicationViewDelegate, CLKUIQuadViewDelegate> {
	...
	float _endHourAngle;
	NTKSpectrumAnalogColorEditOption* _pride2020SensitiveShroudColor;
