...
@class NSDate, NSCalendar, NSNumber, CAReplicatorLayer, UIView, CALayer, NSArray, NTKDigitalTimeLabelStyle, CLKFont, CLKDevice, NTKAnalogHandsView, NTKDigitalTimeLabel, NSString;
