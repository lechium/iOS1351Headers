...
@class NTKDigitialUtilitarianFaceViewComplicationFactory, NTKColorCurve, NTKDigitalTimeLabelStyle, UIView, NTKBezierPathView, NTKSolarDiskView, UIImageView, UILabel, NSDictionary, NTKSolarTimeModel, NTKFloatCurve, NTKSolarPath, UITapGestureRecognizer, NSNumber, NTKComplicationController, NTKDateComplicationLabel, NTKLayoutRule, NSString, NSDateFormatter, NSMutableSet, NSTimer;
