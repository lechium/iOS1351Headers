...
@class UIView, NTKCaliforniaContentView, NTKRoundedCornerOverlayView, NTKCaliforniaColorPalette, UIImageView, NTKCircularAnalogDialView, NTKCaliforniaColorEditOption, NSString;
...
@property (nonatomic,retain) NTKCaliforniaColorEditOption * pride2020SensitiveShroudColor;              //@synthesize pride2020SensitiveShroudColor=_pride2020SensitiveShroudColor - In the implementation block
...
-(NTKCaliforniaColorEditOption *)pride2020SensitiveShroudColor;
-(void)setPride2020SensitiveShroudColor:(NTKCaliforniaColorEditOption *)arg1 ;
@end
