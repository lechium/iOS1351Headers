...
@interface NTKPrideCircularQuad : NTKPrideSplinesQuad {
	...
	SCD_Struct_NT36* _perSplineData;
	float _displayMode;
	float _currentFade;
	BOOL _fading;
	...
	float _velocity;
	SCD_Struct_NT37 _currentColorConfig;
...
-(void)setColorConfig:(SCD_Struct_NT37)arg1 ;
-(SCD_Struct_NT37)advanceConfig:(SCD_Struct_NT37)arg1 ;
-(SCD_Struct_NT37)generateNextRandomConfigFromConfig:(SCD_Struct_NT37)arg1 ;
-(void)initializePerSplineData;
-(void)randomizeSplineColors;
-(float)currentSplineWidth;
-(SCD_Struct_NT37)advanceCurrentConfig;
-(SCD_Struct_NT37)generateNextRandomConfigFromCurrentConfig;
