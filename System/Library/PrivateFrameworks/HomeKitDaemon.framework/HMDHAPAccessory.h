...
@property (nonatomic,copy,readonly) AWDHomeKitHAPService * awdPrimaryHAPService; 
@property (nonatomic,copy,readonly) NSArray * awdHAPServicesList; 
...
-(void)writeCharacteristicValues:(id)arg1 source:(unsigned long long)arg2 queue:(id)arg3 logEventSession:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
-(long long)linkSpeed;
-(void)readCharacteristicValues:(id)arg1 source:(unsigned long long)arg2 queue:(id)arg3 logEventSession:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
...
-(NSArray *)awdHAPServicesList;
-(AWDHomeKitHAPService *)awdPrimaryHAPService;
...
-(void)_performOperation:(long long)arg1 linkType:(long long)arg2 logEventSession:(id)arg3 operationBlock:(/*^block*/id)arg4 errorBlock:(/*^block*/id)arg5 ;
...
-(void)_writeCharacteristicValues:(id)arg1 localOperationRequired:(BOOL)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 errorBlock:(/*^block*/id)arg7 ;
-(void)wirelessPowerOn:(/*^block*/id)arg1 ;
-(void)_writeCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
-(void)_evaluateLocalOperation:(long long)arg1 state:(id)arg2 logEventSession:(id)arg3 completion:(/*^block*/id)arg4 ;
-(id)getFullError:(id)arg1 source:(unsigned long long)arg2 suspended:(BOOL)arg3 ;
-(void)_readCharacteristicValues:(id)arg1 localOperationRequired:(BOOL)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 errorBlock:(/*^block*/id)arg7 ;
-(void)autoUpdateCachedCountDownCharacteristics:(id)arg1 ;
-(void)_readCharacteristicValues:(id)arg1 hapAccessory:(id)arg2 source:(unsigned long long)arg3 queue:(id)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
