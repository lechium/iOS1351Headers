...
@class HMDKeyTransferAgent, HMDSoftwareUpdateManager, HMDAssistantGather, HMDHomeManagerObjectLookup, HMDCameraRecordingResidentElector, HMFTimer, HMDCompanionManager, NSMutableDictionary, NSMutableArray, NSDictionary, NSMutableSet, HMDAccessoryBrowser, HMDMobileAssetManager, HMDUserCloudShareManager, HMDHomeManagerObjectChangeHandler, NSUUID, NSObject, HMFMessageDispatcher, HMDMessageDispatcher, HMDPairedSync, HMDNameValidator, HMDPendingCloudSyncTransactions, HMDPowerManager, HMDCloudManager, HMDWatchManager, HMDBackingStore, HMDMessageFilterChain, HMDIdentityRegistry, HMDCloudDataSyncStateFilter, HMDLocation, HMDFMFHandler, HMDAccountRegistry, HMFDumpCategory, HMDClientConnection, HMDTimeInformationMonitor, HMDApplicationData, HMDResidentMesh, HMDSyncOperationManager, HMDCloudAccount, HMDAWDLogEventObserver, HMDDevice, NSString;
...
-(void)_runUploadHomeToCloud:(id)arg1 objectChange:(id)arg2 syncCompletion:(/*^block*/id)arg3 ;
