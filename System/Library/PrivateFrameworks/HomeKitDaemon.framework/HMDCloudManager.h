...
@class NSObject, CKContainer, CKDatabase, HMDCloudCache, HMFMessageDispatcher, APSConnection, HMDCloudDataSyncStateFilter, HMDHomeManager, HMDSyncOperationManager, NSMutableArray, HMDCloudLegacyZone, HMDCloudMetadataZone, HMDCloudHomeManagerZone, NSData, NSString;
