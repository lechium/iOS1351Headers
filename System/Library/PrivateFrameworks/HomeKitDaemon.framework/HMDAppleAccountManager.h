...
@class HMDBackingStore, HMFUnfairLock, HMDAccount, HMDAppleAccountContext, ACAccountStore, NSObject, APSConnection, HMFExponentialBackoffTimer, HMFTimer, IDSService, HMDCloudCache, HMDDevice, HMDAppleAccountSettings, NSString, NSUUID;
