...
-(void)accumDispatchDistribution:(unsigned long long)arg1 threadgroupsPerGrid:(SCD_Struct_MT68)arg2 threadsPerThreadgroup:(SCD_Struct_MT68)arg3 threadsPerGrid:(SCD_Struct_MT68)arg4 ;
@end
