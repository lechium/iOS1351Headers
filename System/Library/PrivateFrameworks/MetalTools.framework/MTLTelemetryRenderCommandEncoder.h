...
-(void)accumViewportTelemetry:(const SCD_Struct_MT3*)arg1 count:(unsigned long long)arg2 ;
-(void)accumScissorRectTelemetry:(const SCD_Struct_MT185*)arg1 count:(unsigned long long)arg2 ;
@end
