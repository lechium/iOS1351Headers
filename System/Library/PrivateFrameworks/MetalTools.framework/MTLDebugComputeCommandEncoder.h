...
@interface MTLDebugComputeCommandEncoder : MTLToolsComputeCommandEncoder {
	...
	SCD_Struct_MT67 _buffers[31];
	SCD_Struct_MT67 _textures[128];
	SCD_Struct_MT67 _samplers[16];
	SCD_Struct_MT67 _threadgroupMemoryLengths[31];
	SCD_Struct_MT68 _imageBlockSize;
	const SCD_Struct_MT16* _limits;
	BOOL canDealloc;
	BOOL canEndEncoding;
...
-(void)setStageInRegion:(SCD_Struct_MT69)arg1 ;
...
-(void)_validateThreadsPerThreadgroup:(SCD_Struct_MT68)arg1 ;
-(void)validateStageInRegion:(SCD_Struct_MT68)arg1 ;
