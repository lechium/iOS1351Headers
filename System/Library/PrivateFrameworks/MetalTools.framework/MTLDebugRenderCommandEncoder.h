...
@interface MTLDebugRenderCommandEncoder : MTLToolsRenderCommandEncoder {
	...
	SCD_Struct_MT67 _vertexBuffers[36];
	SCD_Struct_MT67 _vertexTextures[128];
	SCD_Struct_MT67 _vertexSamplers[16];
	SCD_Struct_MT67 _fragmentBuffers[31];
	SCD_Struct_MT67 _fragmentTextures[128];
	SCD_Struct_MT67 _fragmentSamplers[16];
	SCD_Struct_MT67 _tileBuffers[31];
	SCD_Struct_MT67 _tileTextures[128];
	SCD_Struct_MT67 _tileSamplers[16];
	SCD_Struct_MT67 _threadgroupMemoryArguments[31];
	SCD_Struct_MT186 _limits;
	...
	SCD_Struct_MT67 _tessellationFactorBufferArgument;
...
@property (nonatomic,readonly) SCD_Struct_MT3 viewport; 
@property (nonatomic,readonly) SCD_Struct_MT185 scissorRect; 
...
@property (nonatomic,readonly) SCD_Struct_MT67 tessellationFactorBufferArgument;                       //@synthesize tessellationFactorBufferArgument=_tessellationFactorBufferArgument - In the implementation block
...
-(void)dispatchThreadsPerTile:(SCD_Struct_MT68)arg1 ;
-(MTLRenderPassDescriptor *)descriptor;
-(void)setLineWidth:(float)arg1 ;
-(float)lineWidth;
-(SCD_Struct_MT3)viewport;
...
-(void)setScissorRect:(SCD_Struct_MT185)arg1 ;
...
-(void)setVertexAmplificationCount:(unsigned long long)arg1 viewMappings:(const mach_timebase_info*)arg2 ;
-(void)setDepthClipMode:(unsigned long long)arg1 ;
-(void)setScissorRects:(const SCD_Struct_MT185*)arg1 count:(unsigned long long)arg2 ;
...
-(SCD_Struct_MT67)tessellationFactorBufferArgument;
