...
@class NSArray, MTLToolsPointerArray, NSString;
...
@property (nonatomic,readonly) MTLToolsPointerArray * events;                                                               //@synthesize events=_events - In the implementation block
@property (nonatomic,readonly) MTLToolsPointerArray * pipelineLibraries;                                                    //@synthesize pipelineLibraries=_pipelineLibraries - In the implementation block
...
@property (nonatomic,readonly) MTLToolsPointerArray * indirectCommandBuffers;                                               //@synthesize indirectCommandBuffers=_indirectCommandBuffers - In the implementation block
@property (nonatomic,readonly) MTLToolsPointerArray * resourceGroups;                                                       //@synthesize resourceGroups=_resourceGroups - In the implementation block
@property (nonatomic,readonly) MTLToolsPointerArray * rasterizationRateMaps;                                                //@synthesize rasterizationRateMaps=_rasterizationRateMaps - In the implementation block
...
@property (readonly) const SCD_Struct_MT16* limits; 
...
-(id)newLibraryWithImageFilterFunctionsSPI:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT20*)arg2 error:(id*)arg3 ;
-(unsigned long long)readWriteTextureSupport;
-(id)newLibraryWithURL:(id)arg1 error:(id*)arg2 ;
-(id)newLibraryWithData:(id)arg1 error:(id*)arg2 ;
-(MTLToolsPointerArray *)events;
-(BOOL)isRemovable;
...
-(SCD_Struct_MT21)heapTextureSizeAndAlignWithDescriptor:(id)arg1 ;
-(SCD_Struct_MT21)heapBufferSizeAndAlignWithLength:(unsigned long long)arg1 options:(unsigned long long)arg2 ;
...
-(void)getDefaultSamplePositions:(SCD_Struct_MT22*)arg1 count:(unsigned long long)arg2 ;
...
-(void)convertSparsePixelRegions:(const SCD_Struct_MT5*)arg1 toTileRegions:(SCD_Struct_MT5*)arg2 withTileSize:(SCD_Struct_MT0)arg3 alignmentMode:(unsigned long long)arg4 numRegions:(unsigned long long)arg5 ;
-(void)convertSparseTileRegions:(const SCD_Struct_MT5*)arg1 toPixelRegions:(SCD_Struct_MT5*)arg2 withTileSize:(SCD_Struct_MT0)arg3 numRegions:(unsigned long long)arg4 ;
...
-(SCD_Struct_MT6)libraryCacheStats;
-(SCD_Struct_MT6)pipelineCacheStats;
...
-(BOOL)mapShaderSampleBufferWithBuffer:(SCD_Struct_MT19*)arg1 capacity:(unsigned long long)arg2 size:(unsigned long long)arg3 ;
...
-(id)newLibraryWithCIFiltersForComputePipeline:(id)arg1 imageFilterFunctionInfo:(const SCD_Struct_MT20*)arg2 error:(id*)arg3 ;
...
-(MTLToolsPointerArray *)pipelineLibraries;
-(MTLToolsPointerArray *)indirectArgumentEncoders;
-(MTLToolsPointerArray *)argumentEncoders;
-(MTLToolsPointerArray *)indirectCommandBuffers;
-(MTLToolsPointerArray *)resourceGroups;
-(MTLToolsPointerArray *)rasterizationRateMaps;
@end
