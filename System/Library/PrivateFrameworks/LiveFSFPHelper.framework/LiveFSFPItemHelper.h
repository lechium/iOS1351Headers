...
@class NSURL, NSNumber, NSString, NSSet, NSPersonNameComponents, NSDate, NSMutableDictionary, NSObject, NSData, LiveFSFPExtensionHelper, LiveFSFPEnumeratorDataContainer, NSMapTable, NSDictionary, NSError, NSFileProviderItemVersion;
