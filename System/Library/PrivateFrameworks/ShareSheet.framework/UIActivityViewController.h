...
@class SFShareSheetSlotManager, NSArray, UISUIActivityViewControllerConfiguration, SFAirDropViewController, NSMutableDictionary, _UIActivityHelper, UIPresentationController, UIAlertController, UIAlertAction, NSOperationQueue, NSString, UIViewController, UIView, UINavigationController, ObjectManipulationViewController, NSLayoutConstraint, _UIActivityNavigationController, UIActivityContentViewController, _UICollectionViewDiffableDataSource, NSUserDefaults, UIActivity, LPLinkMetadata, NSDictionary, NSSet;
