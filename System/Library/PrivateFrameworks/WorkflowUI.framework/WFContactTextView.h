...
@class NSSet, NSString, NSAttributedString, UIFont, UIColor, WFVariableInputCoordinator, UITextInputPasswordRules, UITextRange, NSDictionary, UITextPosition, UIView;
