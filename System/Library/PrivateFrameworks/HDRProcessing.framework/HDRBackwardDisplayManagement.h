...
@interface HDRBackwardDisplayManagement : NSObject {
	...
	SCD_Struct_HD1 _cachedFullRegion;
	SCD_Struct_HD1 _cachedVideoDstRegion[3];
	SCD_Struct_HD1 _cachedVideoSrcRegion[3];
	SCD_Struct_HD1 _cachedUIDstRegion[3];
	SCD_Struct_HD1 _cachedUISrcRegion[3];
	...
	SCD_Struct_HD2 _cachedHDRMatrix;
	float _709toPanelPrimaryMatrix[9];

}
-(void)initWithDevice:(id)arg1 ;
-(long long)encodeToCommandBuffer:(id)arg1 video:(IOSurfaceRef)arg2 videoSrcRegion:(SCD_Struct_HD1)arg3 videoDstRegion:(SCD_Struct_HD1)arg4 ui:(IOSurfaceRef)arg5 uiSrcRegion:(SCD_Struct_HD1)arg6 uiDstRegion:(SCD_Struct_HD1)arg7 backgroundColor:(SCD_Struct_HD4*)arg8 output:(IOSurfaceRef)arg9 frameProperties:(id)arg10 ;
-(long long)setAccessibilityMatrix:(SCD_Struct_HD2*)arg1 ;
...
-(void)attatchInfoFrame:(SCD_Struct_HD7*)arg1 toOutputSurface:(IOSurfaceRef)arg2 ;
...
-(void)fillScalingTable_SDR2HDR:(SCD_Struct_HD7*)arg1 target_White:(float)arg2 target_Black:(float)arg3 ;
-(BOOL)updateConfigFromMetadata:(SCD_Struct_HD7*)arg1 uiScaleFactor:(float)arg2 width:(int)arg3 background:(SCD_Struct_HD4*)arg4 hdrVideoOnly:(BOOL)arg5 hdr10TV:(BOOL)arg6 sdrOnly:(BOOL)arg7 ;
-(void)fillScalingTable_YUVTM:(SCD_Struct_HD7*)arg1 targetwhite:(float)arg2 targetblack:(float)arg3 satBoost:(float)arg4 scalingFactor:(BOOL)arg5 sdrOnly:(BOOL)arg6 ;
-(void)fillInverseScalingFactorTableFromDMConfig:(SCD_Struct_HD7*)arg1 ;
-(int)adjustMetaData:(SCD_Struct_HD9*)arg1 HDRUIBlending:(BOOL)arg2 hasLetterbox:(BOOL)arg3 ;
-(void)packetizeMetadata:(SCD_Struct_HD9*)arg1 length:(int)arg2 into:(int)arg3 onSurface:(IOSurfaceRef)arg4 ;
...
-(void)updateVertices:(SCD_Struct_HD1)arg1 videoInput:(IOSurfaceRef)arg2 videoDstRegion:(SCD_Struct_HD1)arg3 videoSrcRegion:(SCD_Struct_HD1)arg4 uiInput:(IOSurfaceRef)arg5 uiDstRegion:(SCD_Struct_HD1)arg6 uiSrcRegion:(SCD_Struct_HD1)arg7 dstWidth:(int)arg8 dstHeight:(int)arg9 videoSrcWidth:(int)arg10 videoSrcHeight:(int)arg11 index:(int)arg12 scale:(int)arg13 ;
...
-(long long)encodeToCommandBuffer:(id)arg1 video:(IOSurfaceRef)arg2 videoSrcRegion:(SCD_Struct_HD1)arg3 videoDstRegion:(SCD_Struct_HD1)arg4 ui:(IOSurfaceRef)arg5 output:(IOSurfaceRef)arg6 frameProperties:(id)arg7 ;
