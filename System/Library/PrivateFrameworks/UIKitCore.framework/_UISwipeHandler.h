...
@interface _UISwipeHandler : NSObject <UIGestureRecognizerDelegate, _UISwipeDismissalGestureRecognizerDelegate> {
	...
	SCD_Struct_UI116 _currentSwipeConfig;
...
@property (nonatomic,readonly) SCD_Struct_UI116 currentSwipeConfig; 
...
-(SCD_Struct_UI116)currentSwipeConfig;
-(void)resetSwipe;
-(BOOL)isInteracting;
...
-(SCD_Struct_UI115)_currentSwipeInfoWithTargetOffset:(double)arg1 animated:(BOOL)arg2 usingSpringWithStiffness:(double)arg3 ;
