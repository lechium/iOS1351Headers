...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, _UINavigationBarDelegatePrivate, _UIScrollViewScrollObserver, UILayoutContainerViewDelegate> {
	...
	SCD_Struct_UI48 _interactiveScrollNavBarIntrinsicHeightRange;
...
-(double)_navigationBar:(id)arg1 preferredHeightForTransitionToHeightRange:(SCD_Struct_UI48)arg2 ;
...
-(SCD_Struct_UI49)_calculateTopLayoutInfoForViewController:(id)arg1 ;
...
-(SCD_Struct_UI48)_intrinsicNavigationBarHeightRangeForNavItem:(id)arg1 ;
...
-(SCD_Struct_UI48)_heightRangeOfTopViews;
