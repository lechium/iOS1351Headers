...
-(SCD_Struct_UI72)_calculateStatisticsOfEdge:(BOOL)arg1 ;
...
-(SCD_Struct_UI72)_calculateStatistics;
-(SCD_Struct_UI72)_calculateEdgeStatistics;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI74)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI74)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)compositeToPoint:(CGPoint)arg1 fromRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI73)arg1 inRect:(CGRect)arg2 fraction:(double)arg3 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI73)arg1 inRect:(CGRect)arg2 operation:(int)arg3 fraction:(double)arg4 ;
...
-(void)draw9PartImageWithSliceRects:(SCD_Struct_UI74)arg1 inRect:(CGRect)arg2 ;
-(void)draw3PartImageWithSliceRects:(SCD_Struct_UI73)arg1 inRect:(CGRect)arg2 ;
