...
@class UIScrollView, UIView, UITableViewRowData, _UITableViewSubviewManager, NSMutableArray, NSMutableDictionary, NSIndexPath, _UITableViewDeleteAnimationSupport, _UITableViewReorderingSupport, UITableViewWrapperView, UITableViewIndex, UITableViewCountView, NSArray, UITableViewIndexOverlayIndicatorView, NSTimer, UITableViewIndexOverlaySelectionView, UIColor, UIVisualEffect, UISwipeActionController, UITableViewCell, UIContextMenuInteraction, _UICursorInteraction, _UICursorRegion, _UIIndexPathIdentityTracker, UILongPressGestureRecognizer, UITapGestureRecognizer, UITouch, NSMutableSet, _UITableViewUpdateSupport, _UITableViewShadowUpdatesController, UIFocusContainerGuide, UISelectionFeedbackGenerator, UIImpactFeedbackGenerator, _UIDragSnappingFeedbackGenerator, _UITableViewPrefetchContext, _UITableViewMultiSelectController, _UITableViewDragController, _UITableViewDropController, NSString;
...
@property (assign,setter=_setSelectionFollowsFocus:,nonatomic) BOOL _selectionFollowsFocus; 
