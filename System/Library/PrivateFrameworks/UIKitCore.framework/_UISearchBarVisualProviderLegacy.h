...
@class _UISearchBarAppearanceStorage, UIBarButtonItem, UINavigationItem, UIView, UISearchBarTextField, UISearchBarBackground, _UIBackdropView, UIVisualEffectView, UIButton, NSString, UINavigationButton, UILabel, UIImageView, UISegmentedControl, _UISearchBarScopeBarBackground, NSArray, UIColor, _UINavigationBarTitleViewOverlayRects, UIImage;
