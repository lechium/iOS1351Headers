...
@class UIScreen, UIColor, _UIStatusBarData, UIGestureRecognizer, NSArray, NSMutableDictionary, UIView, UIPointerInteraction, UIAccessibilityHUDGestureManager, NSDictionary, _UIStatusBarDataAggregator, _UIStatusBarStyleAttributes, _UIStatusBarAction, NSString, NSSet;
