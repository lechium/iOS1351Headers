...
@class VSSpeechRequest, VSInstrumentMetrics, NSError, VSAudioPlaybackService, NSArray, VSDeviceTTSCore, VSAudioData, VSSpeechInternalSettings, VSOspreyTTSCore, VSCachingService, VSServerTTSConfig, NSString;
...
@property (nonatomic,retain) VSServerTTSConfig * serverTTSConfig;                      //@synthesize serverTTSConfig=_serverTTSConfig - In the implementation block
...
-(VSServerTTSConfig *)serverTTSConfig;
...
-(void)setServerTTSConfig:(VSServerTTSConfig *)arg1 ;
@end
