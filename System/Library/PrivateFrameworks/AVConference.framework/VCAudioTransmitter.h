...
@interface VCAudioTransmitter : NSObject <VCAudioIOSink, VCConnectionChangedHandler> {
	...
	SCD_Struct_VC157 _currentChannelMetrics;
	SCD_Struct_VC159 _idsChannelDataFormat;
...
@property (assign,nonatomic) SCD_Struct_VC157 currentChannelMetrics;                          //@synthesize currentChannelMetrics=_currentChannelMetrics - In the implementation block
...
-(SCD_Struct_VC157)currentChannelMetrics;
...
-(void)setCurrentChannelMetrics:(SCD_Struct_VC157)arg1 ;
@end
