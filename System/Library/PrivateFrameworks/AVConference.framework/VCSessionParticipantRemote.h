...
@interface VCSessionParticipantRemote : VCSessionParticipant <VCSessionDownlinkBandwidthAllocatorClient> {
	...
	VCSessionParticipantProminenceInfo _prominenceInfo;
...
-(void)vcMediaStream:(id)arg1 didReceiveFirstVideoFrameWithTime:(SCD_Struct_AV77)arg2 ;
...
-(id)initWithIDSDestination:(id)arg1 idsParticipantID:(unsigned long long)arg2 mediaNegotiator:(id)arg3 opaqueData:(id)arg4 delegate:(id)arg5 processId:(int)arg6 transportSessionID:(unsigned)arg7 sessionUUID:(id)arg8 config:(id)arg9 ;
