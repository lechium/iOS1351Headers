...
-(void)updateVideoBuffer:(CVBufferRef)arg1 withPresentationTime:(SCD_Struct_VC52)arg2 cameraStatusBits:(unsigned char)arg3 timestamp:(unsigned)arg4 ;
...
-(SCD_Struct_VC52)setupStillImageWithTimestamp:(unsigned)arg1 transactionID:(id)arg2 visibleRect:(CGRect*)arg3 cameraStatusBit:(char*)arg4 imageType:(int)arg5 ;
-(void)setupWriterWithTransactionID:(id)arg1 filePath:(id)arg2 stillImageTime:(SCD_Struct_VC52)arg3 visibleRect:(CGRect)arg4 cameraStatusBit:(unsigned char)arg5 ;
