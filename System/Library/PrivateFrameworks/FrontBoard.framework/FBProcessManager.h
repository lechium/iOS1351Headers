...
@class FBApplicationProcess, NSObject, NSMutableDictionary, NSHashTable, NSMutableOrderedSet, BKSHIDEventDeferringToken, FBProcess, RBSProcessMonitor, NSMutableSet, FBApplicationProcessWatchdogPolicy, NSString;
