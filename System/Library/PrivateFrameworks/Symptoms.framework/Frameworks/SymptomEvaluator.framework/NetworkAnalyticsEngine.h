...
@class NSMutableDictionary, NSDate, NSString, NSMutableData, ImpoExpoService, NWPathEvaluator, NSObject, NetworkAnalyticsModel, WiFiShim, SystemSettingsRelay, NSData, NLCRunner, ProxyAnalytics;
...
-(BOOL)_populateLQMJournalRecord:(SCD_Struct_Ne22*)arg1 fromCellFingerprint:(BOOL)arg2 key:(const char*)arg3 atLOI:(long long)arg4 ofInterfaceType:(long long)arg5 lqm:(int)arg6 isFaulty:(unsigned)arg7 ;
-(BOOL)_populateLIMJournalRecord:(SCD_Struct_Ne23*)arg1 fromKernelDict:(id)arg2 ;
...
-(int)_processCTCellInfo:(id)arg1 ;
