...
@class CAMPreviewView, NSString, CAMControlDrawer, CAMDynamicShutterControl, CAMControlStatusBar, CAMBadgeTray, CAMModeDial, CAMModeIndicatorView, CAMFullscreenModeSelector, CAMFlipButton, CAMImageWell, CAMZoomControl, CAMZoomSlider, CAMElapsedTimeView, CAMTimerIndicatorView, CAMPanoramaView, CAMCreativeCameraButton, CAMFilterNameBadge, CEKLightingControl, CEKLightingNameBadge, CAMPortraitModeInstructionLabel, UILongPressGestureRecognizer, CAMQRCodeInstructionLabel, CAMPortraitModeDescriptionOverlayView, CAMCTMDescriptionOverlayView, UIView, CAMViewfinderReticleView, CAMLowLightInstructionLabel, CAMFullscreenViewfinderLayout, AVSpatialOverCaptureVideoPreviewLayer, CAMAdditiveAnimator;
...
@property (assign,setter=_setUsingCreativeCameraControls:,getter=_isUsingCreativeCameraControls,nonatomic) BOOL _usingCreativeCameraControls;                    //@synthesize _usingCreativeCameraControls=__usingCreativeCameraControls - In the implementation block
