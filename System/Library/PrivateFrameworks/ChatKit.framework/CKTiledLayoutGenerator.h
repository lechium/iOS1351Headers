...
@interface CKTiledLayoutGenerator : NSObject {
	...
	SCD_Struct_CK10 _cachedTileInfo[20];
...
-(void)willParseTiles;
-(void)didParseTiles;
-(BOOL)scanAnyTile:(SCD_Struct_CK11*)arg1 ;
-(void)setScanState:(CKTiledLayoutGeneratorScanState *)arg1 ;
-(BOOL)scanTileWithPortraitImage:(SCD_Struct_CK11*)arg1 ;
-(BOOL)scanTileWithLandscapeImage:(SCD_Struct_CK11*)arg1 ;
-(double)valueByRounding:(double)arg1 usingMagneticGuidelines:(BOOL)arg2 ;
-(BOOL)scanTileWithHorizontalPanorama:(SCD_Struct_CK11*)arg1 ;
-(BOOL)scannedBatchHasCaption;
-(BOOL)scanTile:(SCD_Struct_CK11*)arg1 type:(long long*)arg2 ;
-(BOOL)scanTile:(SCD_Struct_CK11*)arg1 ofType:(long long)arg2 ;
-(BOOL)scanTileWithSquareImage:(SCD_Struct_CK11*)arg1 ;
...
-(id)tileBatchIDBlock;
-(BOOL)scanTile:(SCD_Struct_CK11*)arg1 passingTest:(/*^block*/id)arg2 ;
