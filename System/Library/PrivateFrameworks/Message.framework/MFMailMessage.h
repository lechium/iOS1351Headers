...
@class MFMessageInfo, NSURL, EMMessageObjectID, MFMailboxUid, MFMessageHeaders, MailAccount, NSString, ECSubject, NSArray, NSDate, ECMessageFlags, NSDictionary, ECAngleBracketIDHash, NSSet, NSUUID;
