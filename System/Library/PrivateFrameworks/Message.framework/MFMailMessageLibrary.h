...
@protocol OS_dispatch_queue, EFSQLExpressable, EFScheduler;
@class MFWeakObjectCache, NSMutableDictionary, NSObject, NSString, NSMutableSet, _MFMailMessageLibraryStatistics, MFFileCompressionQueue, MFLibrarySearchableIndex, NSCache, EDPersistence, MFPersistenceDatabase_iOS, MFMessageChangeManager_iOS, EDSearchableIndexScheduler, EDMessageQueryParser, EDPersistenceHookRegistry;
...
@property (readonly) MFMessageChangeManager_iOS * messageChangeManager;                          //@synthesize messageChangeManager=_messageChangeManager - In the implementation block
...
-(void)_iterateStatement:(id)arg1 connection:(id)arg2 withProgressMonitor:(id)arg3 andRowHandler:(/*function pointer*/void*)arg4 context:(const SCD_Struct_MF4*)arg5 ;
