...
@class NSMutableDictionary, EFLazyCache, EDMailDropMetadataGeneratorFactory, MFMailMessageLibrary, MFMailMessageLibraryQueryTransformer, MFMessageTransformer, NSObject, NSString;
...
@property (nonatomic,retain) EDMailDropMetadataGeneratorFactory * maildropContentItemGeneratorFactory;              //@synthesize maildropContentItemGeneratorFactory=_maildropContentItemGeneratorFactory - In the implementation block
...
-(EDMailDropMetadataGeneratorFactory *)maildropContentItemGeneratorFactory;
...
-(void)setMaildropContentItemGeneratorFactory:(EDMailDropMetadataGeneratorFactory *)arg1 ;
