...
@class SUClientInterface, NSArray, ISStoreURLOperation, SUSearchFieldConfiguration, UIControl, UISearchBar, SUSearchDisplayController, SUScriptTextFieldDelegate, NSString, NSNumber;
