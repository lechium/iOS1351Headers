...
-(NSObject*<OS_dispatch_queue>)readOnlyWorkloop;
-(NSString *)appSupportDirPath;
-(void)dbBecameCorrupted;
-(NSObject*<OS_dispatch_queue>)serverTruthWorkloop;
-(NSObject*<OS_dispatch_queue>)clientTruthWorkloop;
-(void)openForDumping;
