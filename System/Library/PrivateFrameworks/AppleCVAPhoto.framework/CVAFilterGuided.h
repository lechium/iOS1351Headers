...
@protocol MTLDeviceSPI, MTLLibrary, MTLTexture, MTLSamplerState, MTLResourceGroupSPI, MTLComputePipelineState;
...
-(NSString *)label;
-(id)initWithDevice:(id)arg1 library:(id)arg2 commandQueue:(id)arg3 textureSize:(SCD_Struct_CV32)arg4 alphaSize:(SCD_Struct_CV32)arg5 kernelSize:(int)arg6 infConvolutionDownsampling:(int)arg7 laplacianLimitingDownsampling:(int)arg8 laplacianLimitingBlurSize:(int)arg9 error:(id*)arg10 ;
