...
@property (assign,nonatomic) SCD_Struct_PM5 cachedNaturalDuration;               //@synthesize cachedNaturalDuration=_cachedNaturalDuration - In the implementation block
...
-(SCD_Struct_PM5)cachedNaturalDuration;
-(void)setCachedNaturalDuration:(SCD_Struct_PM5)arg1 ;
@end
