...
@property (nonatomic,retain) NSMutableArray * serviceProviderSupportedNetworks;              //@synthesize serviceProviderSupportedNetworks=_serviceProviderSupportedNetworks - In the implementation block
...
-(NSMutableArray *)serviceProviderSupportedNetworks;
...
-(void)setServiceProviderSupportedNetworks:(NSMutableArray *)arg1 ;
