...
@class BLTRemoteGizmoClient, BBObserver, NSMutableDictionary, NSMutableSet, BLTHashCache, BLTWatchKitAppList, BLTSettingSync, NSDate, BLTClientReplyTimeoutManager, BLTSectionConfiguration, BLTUserNotificationList, BLTBulletinFetcher, BLTPingSubscriberManager, BLTGizmoLegacyMap, BLTBulletinDistributorMRUSectionCache, NSString;
...
@property (nonatomic,retain) BLTBulletinDistributorMRUSectionCache * mruSectionCache;               //@synthesize mruSectionCache=_mruSectionCache - In the implementation block
...
-(BLTBulletinDistributorMRUSectionCache *)mruSectionCache;
-(void)setMruSectionCache:(BLTBulletinDistributorMRUSectionCache *)arg1 ;
@end
