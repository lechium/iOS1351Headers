...
-(id)runParallelPlansWithPlanId:(id)arg1 tracker:(id)arg2 noiseScaleFactors:(SCD_Struct_PM0)arg3 noiseMinimumMagnitude:(float)arg4 weights:(id)arg5 serverIteration:(unsigned long long)arg6 useIntercept:(BOOL)arg7 noiseMechanism:(long long)arg8 usingRandomlySelected:(unsigned long long)arg9 ;
@end
