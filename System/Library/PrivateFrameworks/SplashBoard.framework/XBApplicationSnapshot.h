...
@class XBSnapshotContainerIdentity, NSMutableDictionary, NSString, NSDate, XBStatusBarSettings, XBApplicationSnapshotGenerationContext, UIImage, NSDictionary, XBDisplayEdgeInsetsWrapper;
