...
@class NSObject, CBCentralManager, CBConnectionsObserver, HAPAccessoryServerBrowserWiProxBTLE, NSMapTable, NSMutableSet, NSMutableArray, NSMutableOrderedSet, NSString;
...
@property (retain) NSMutableSet * pairedAccessoryIdentifiers;                                        //@synthesize pairedAccessoryIdentifiers=_pairedAccessoryIdentifiers - In the implementation block
