...
-(void)_readCharacteristicValues:(id)arg1 queue:(id)arg2 logEventSession:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)_readValueForCharacteristic:(id)arg1 options:(long long)arg2 logEventSession:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)_writeValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
-(void)_performTimedWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
-(void)_performWriteValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
-(void)markNotifyingCharacteristicUpdatedforCharacteristic:(id)arg1 ;
-(void)_performTimedWriteExecuteForCharacteristic:(id)arg1 value:(id)arg2 options:(long long)arg3 logEventSession:(id)arg4 completionHandler:(/*^block*/id)arg5 ;
-(void)_performTimedWritePrepareWithValue:(id)arg1 toCharacteristic:(id)arg2 authorizationData:(id)arg3 options:(long long)arg4 logEventSession:(id)arg5 completionHandler:(/*^block*/id)arg6 ;
