...
-(void)_readCharacteristicValues:(id)arg1 completionQueue:(id)arg2 logEventSession:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
...
-(void)_writeCharacteristicValues:(id)arg1 queue:(id)arg2 logEventSession:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
-(void)_writeValue:(id)arg1 forCharacteristic:(id)arg2 authorizationData:(id)arg3 logEventSession:(id)arg4 withCompletionHandler:(/*^block*/id)arg5 queue:(id)arg6 ;
-(BOOL)_shouldEnableSessionSecurity;
-(void)_enqueueWriteCompletionHandler:(/*^block*/id)arg1 forCharacteristic:(id)arg2 ;
-(void)_readValueForCharacteristic:(id)arg1 completionQueue:(id)arg2 logEventSession:(id)arg3 completionHandler:(/*^block*/id)arg4 ;
