...
@property (nonatomic,retain) NSMutableArray * shareRecordsToUpdate;                              //@synthesize shareRecordsToUpdate=_shareRecordsToUpdate - In the implementation block
...
-(NSMutableArray *)shareRecordsToUpdate;
...
-(void)setShareRecordsToUpdate:(NSMutableArray *)arg1 ;
@end
