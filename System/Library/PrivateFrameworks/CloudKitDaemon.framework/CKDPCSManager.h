...
@class CKDAccount, CKContainerID, NSString, CKDPCSIdentityManager, NSDate, NSMutableSet, NSData, NSObject;
...
-(void)_locked_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(BOOL)arg4 completionHandler:(/*^block*/id)arg5 ;
-(void)markUndecryptablePCS:(id)arg1 ;
-(void)_triggerAutobugCaptureForLostManateeIdentityError;
-(void)_createPCSFromData:(id)arg1 ofType:(unsigned long long)arg2 usingPCSServiceType:(unsigned long long)arg3 withSyncKeyRegistryRetry:(BOOL)arg4 completionHandler:(/*^block*/id)arg5 ;
