...
@class MCDPCContainer, UITabBarController, MCDPCModel, NSString, MCDNowPlayingButtonWrapperView, NSObject;
...
@property (nonatomic,retain) MCDNowPlayingButtonWrapperView * nowPlayingButtonView;              //@synthesize nowPlayingButtonView=_nowPlayingButtonView - In the implementation block
...
-(MCDNowPlayingButtonWrapperView *)nowPlayingButtonView;
-(void)setNowPlayingButtonView:(MCDNowPlayingButtonWrapperView *)arg1 ;
-(BOOL)hasCarScreen;
@end
