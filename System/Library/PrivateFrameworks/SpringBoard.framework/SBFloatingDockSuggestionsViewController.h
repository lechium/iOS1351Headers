...
@class SBFloatingDockViewController, SBDockIconListView, NSMutableDictionary, SBIconController, SBApplicationController, SBRecentDisplayItemsDataStore, SBRecentDisplayItemsDefaults, SBAppSuggestionManager, SBIconListModel, SBFloatingDockSuggestionsModel, NSMutableArray, SBLayoutStateTransitionCoordinator, NSString, NSSet;
