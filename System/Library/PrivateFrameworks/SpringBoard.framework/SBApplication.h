...
@class NSDate, FBApplicationProcess, FBSApplicationDataStore, XBApplicationSnapshotManifest, NSUserDefaults, SBApplicationProcessState, FBProcessExitContext, SBApplicationSupportServiceRequestContext, NSHashTable, NSMapTable, NSMutableDictionary, SBApplicationWakeScheduler, NSString, SBApplicationInfo, NSArray;
...
@property (assign,getter=isUninstalled,nonatomic) BOOL uninstalled;                                                                             //@synthesize uninstalled=_uninstalled - In the implementation block
