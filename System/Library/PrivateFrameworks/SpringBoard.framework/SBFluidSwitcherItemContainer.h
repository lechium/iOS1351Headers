...
@property (assign,getter=isCursorInteractionEnabled,nonatomic) BOOL cursorInteractionEnabled;                  //@synthesize cursorInteractionEnabled=_cursorInteractionEnabled - In the implementation block
...
-(void)setCursorInteractionEnabled:(BOOL)arg1 ;
...
-(BOOL)isCursorInteractionEnabled;
