...
@class MCProfileConnection, SBSetupManager, SBAlertItemsController, SBApplicationController, SBAssistantController, SBCommandTabController, SBConferenceManager, SBRemoteTransientOverlaySessionManager, SBLockScreenManager, SBLockStateAggregator, SBTelephonyManager, SBMainWorkspace, SBNotificationBannerDestination, SBLocalDefaults;
...
@property (setter=_setBannerDestination:,getter=_bannerDestination,nonatomic,retain) SBNotificationBannerDestination * bannerDestination;                                                                              //@synthesize override_bannerDestination=_override_bannerDestination - In the implementation block
-(id)init;
...
-(void)_setBannerDestination:(id)arg1 ;
@end
