...
@class NSString, BSAuditToken, NSObject, NSDictionary, NSTimer, NSURL, _SBSUICFUserNotificationContentHostViewController, _SBLegacyRemoteAlertContentHostViewController, NSArray, SBUISound, BKSProcessAssertion, _SBUserNotificationImageDescriptor, UIViewController;
...
-(id)initWithMessage:(id)arg1 replyPort:(unsigned)arg2 requestFlags:(int)arg3 auditToken:(SCD_Struct_SB17)arg4 ;
