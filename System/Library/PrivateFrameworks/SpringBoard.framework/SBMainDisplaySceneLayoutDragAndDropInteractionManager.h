...
@property (nonatomic,__weak,readonly) SBFluidSwitcherViewController * floatingSwitcherContentController;                       //@synthesize floatingSwitcherContentController=_floatingSwitcherContentController - In the implementation block
