...
@class NSArray, NSObject, NSHashTable, NSError, CPLStatus, NSDate, CPLPlatformObject, NSString, NSURL, CPLEngineStore, CPLEngineScheduler, CPLEngineSyncManager, CPLEngineTransport, CPLEngineSystemMonitor, CPLEngineFeedbackManager, CPLConfiguration;
...
-(void)_performBlockOnLibrary:(/*^block*/id)arg1 ;
