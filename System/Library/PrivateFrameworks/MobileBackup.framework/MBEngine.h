...
@property (getter=isDeviceTransferEngine,nonatomic,readonly) BOOL deviceTransferEngine;              //@synthesize deviceTransferEngine=_deviceTransferEngine - In the implementation block
