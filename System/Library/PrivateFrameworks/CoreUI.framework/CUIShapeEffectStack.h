...
@property (nonatomic,readonly) SCD_Struct_CU38* hueSaturation;                     //@synthesize hueSaturation=_hueSaturation - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU39* colorOverlay;                      //@synthesize colorOverlay=_colorOverlay - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU40* innerGradient;                     //@synthesize innerGradient=_innerGradient - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU41* innerGlow;                         //@synthesize innerGlow=_innerGlow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU42* innerShadow;                       //@synthesize innerShadow=_innerShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU43* outerGlow;                         //@synthesize outerGlow=_outerGlow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU36* engraveShadow;                     //@synthesize engraveShadow=_engraveShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU36* extraShadow;                       //@synthesize extraShadow=_extraShadow - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_CU44* emboss;                            //@synthesize emboss=_emboss - In the implementation block
...
+(id)gradientWithParameters:(SCD_Struct_CU40*)arg1 inRect:(CGRect)arg2 ;
...
-(SCD_Struct_CU40*)innerGradient;
-(unsigned long long)colorOverlayCount;
-(SCD_Struct_CU39*)colorOverlay;
...
-(BOOL)hasEffects;
-(id)imageWithInteriorGradientFillOfImage:(id)arg1 effect:(SCD_Struct_CU40)arg2 ;
-(id)imageWithColorOverlayOfImage:(id)arg1 effect:(SCD_Struct_CU39)arg2 ;
-(id)imageWithHueSaturationOfImage:(id)arg1 effect:(SCD_Struct_CU38)arg2 ;
-(id)imageWithInnerGlowOfImage:(id)arg1 effect:(SCD_Struct_CU41)arg2 ;
-(id)imageWithInnerShadowOfImage:(id)arg1 effect:(SCD_Struct_CU42)arg2 ;
-(id)imageWithBevelEmbossOfImage:(id)arg1 effect:(SCD_Struct_CU44)arg2 ;
-(id)imageWithOuterGlowOfImage:(id)arg1 effect:(SCD_Struct_CU43)arg2 ;
-(id)imageWithEngraveShadowOfImage:(id)arg1 effect:(SCD_Struct_CU36)arg2 ;
-(id)imageWithExtraShadowOfImage:(id)arg1 effect:(SCD_Struct_CU36)arg2 ;
