...
@interface CUIShapeEffectPreset : NSObject {
	...
	SCD_Struct_CU28 _parameterList[125];
...
-(void)_insertEffectTuple:(SCD_Struct_CU29)arg1 atEffectIndex:(unsigned long long)arg2 ;
...
-(id)initWithConstantPreset:(const SCD_Struct_CU30*)arg1 ;
@end
