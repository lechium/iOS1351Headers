...
@property (assign,nonatomic) unsigned long long genderMatch;                                                         //@synthesize genderMatch=_genderMatch - In the implementation block
...
-(unsigned long long)genderMatch;
-(void)setGenderMatch:(unsigned long long)arg1 ;
