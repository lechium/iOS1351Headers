...
@interface GEOPDComponentFilter : PBCodable <NSCopying> {
	...
	struct {
		...
		unsigned wrote_groundViewLabelFilter : 1;
		...
		unsigned wrote_storefrontFilter : 1;
		unsigned wrote_storefrontPresentationFilter : 1;
