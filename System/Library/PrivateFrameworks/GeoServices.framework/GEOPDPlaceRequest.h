...
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE32)arg1 includeEntryPoints:(BOOL)arg2 preserveOriginalLocation:(BOOL)arg3 traits:(id)arg4 ;
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE32)arg1 floorOrdinal:(int)arg2 includeEntryPoints:(BOOL)arg3 preserveOriginalLocation:(BOOL)arg4 traits:(id)arg5 ;
...
-(id)initForNearestTransitStationWithLine:(id)arg1 coordinate:(SCD_Struct_GE32)arg2 traits:(id)arg3 ;
...
-(id)initWithMapItemToRefine:(id)arg1 coordinate:(SCD_Struct_GE32)arg2 traits:(id)arg3 ;
