...
@interface GEOPDPlaceRequestParameters : PBCodable <NSCopying> {
	...
	struct {
		...
		unsigned wrote_groundViewLabelParameters : 1;
...
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE32)arg1 preserveOriginalLocation:(BOOL)arg2 ;
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE32)arg1 preserveOriginalLocation:(BOOL)arg2 floorOrdinal:(int)arg3 ;
...
-(id)initWithReverseGeocodeCoordinate:(SCD_Struct_GE32)arg1 ;
