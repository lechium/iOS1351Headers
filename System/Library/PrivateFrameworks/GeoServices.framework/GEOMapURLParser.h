...
@property (nonatomic,readonly) SCD_Struct_GE32 span;                                       //@synthesize span=_span - In the implementation block
...
@property (nonatomic,readonly) SCD_Struct_GE32 searchCoordinate;                           //@synthesize searchCoordinate=_searchCoordinate - In the implementation block
@property (nonatomic,readonly) SCD_Struct_GE40 searchRegion;                               //@synthesize searchRegion=_searchRegion - In the implementation block
