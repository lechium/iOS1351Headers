...
@property (assign,nonatomic) SCD_Struct_GE32 centerCoordinate;                           //@synthesize centerCoordinate=_centerCoordinate - In the implementation block
...
-(void)setCenterCoordinate:(SCD_Struct_GE32)arg1 ;
