...
@interface GEOPlaceSearchRequest : PBRequest <NSCopying> {
	...
	struct {
		...
		unsigned has_businessSortDirection : 1;
		...
		unsigned wrote_businessSortDirection : 1;
...
@property (assign,nonatomic) BOOL hasBusinessSortDirection; 
@property (assign,nonatomic) int businessSortDirection; 
