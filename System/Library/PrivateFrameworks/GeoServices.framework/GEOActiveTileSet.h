...
-(unsigned)largestZoomLevelLEQ:(unsigned)arg1 inRect:(SCD_Struct_GE40)arg2 ;
...
-(unsigned)maximumZoomLevelInRect:(SCD_Struct_GE40)arg1 ;
...
-(unsigned)minimumZoomLevelInRect:(SCD_Struct_GE40)arg1 ;
-(unsigned)maximumZoomLevelForMapPoint:(SCD_Struct_GE32)arg1 ;
