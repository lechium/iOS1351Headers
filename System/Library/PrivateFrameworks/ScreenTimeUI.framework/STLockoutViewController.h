...
@class SBSLockScreenService, UIAlertController, NSObject, UIResponder, STLockoutPolicyController, NSString, NSDictionary, STHourglassView, UIImageView, UILabel, UIButton, UIVisualEffectView;
