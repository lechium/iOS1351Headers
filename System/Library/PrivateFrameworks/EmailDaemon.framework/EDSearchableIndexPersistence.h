...
@property (assign,nonatomic) os_unfair_lock_s lastProcessedAttachmentIDLock;                         //@synthesize lastProcessedAttachmentIDLock=_lastProcessedAttachmentIDLock - In the implementation block
...
-(os_unfair_lock_s)lastProcessedAttachmentIDLock;
-(void)setLastProcessedAttachmentIDLock:(os_unfair_lock_s)arg1 ;
@end
