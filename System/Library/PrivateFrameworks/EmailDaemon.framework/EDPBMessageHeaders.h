...
@interface EDPBMessageHeaders : PBCodable <NSCopying> {
	...
	SCD_Struct_ED11* _bccAddress;
	SCD_Struct_ED11* _bccContactIds;
	SCD_Struct_ED11* _bccDomains;
	SCD_Struct_ED12* _bccIsVips;
	SCD_Struct_ED11* _ccAddress;
	SCD_Struct_ED11* _ccContactIds;
	SCD_Struct_ED11* _ccDomains;
	SCD_Struct_ED12* _ccIsVips;
	SCD_Struct_ED11* _references;
	SCD_Struct_ED11* _subjectWords;
	SCD_Struct_ED11* _toAddress;
	SCD_Struct_ED11* _toContactIds;
	SCD_Struct_ED11* _toDomains;
	SCD_Struct_ED12* _toIsVips;
