...
@class NTPBFeedViewportHeadline, FCSharedStringIndex, NSString, NSDate, NSArray, COMAPPLEFELDSPARPROTOCOLLIVERPOOLCohortList, FCHeadlineThumbnail, NSURL, FCCoverArt, NSSet, FCFeedPersonalizedItemScoreProfile, FCTopStoriesStyleConfiguration, NSData, FCHeadlineExperimentalTitleMetadata, FCIssue;
