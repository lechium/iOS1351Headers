...
@protocol FCAppActivityMonitor, FCPurchaseProviderType, FCPurchaseManagerType, FCBundleSubscriptionManagerType, FCCurrentIssuesChecker, FCPaidAccessCheckerType, FCLocalRegionManager, FCFlintHelper, FCBackgroundTaskable, FCForYouMagazineFeedManaging, FCForYouPluginGroupManaging, FCForYouBridgedConfigurationParser, FCPPTContext, FCContentContext, FCPrivateDataContext;
@class NSString, FCAssetManager, FCArticleController, FCTagController, FCFlintResourceManager, FCNetworkBehaviorMonitor, NSURL, FCIssueReadingHistory, FCPersonalizationData, FCPrivateChannelMembershipController, FCReadingHistory, FCReadingList, FCSubscriptionList, FCUserInfo, FCTagSettings, FCSubscriptionController, FCFeedManager, FCClientEndpointConnection, FCCommandQueue, FCNotificationsEndpointConnection, FCNotificationController, FCPurchaseController, FCTranslationManager, FCLocalAreasManager, FCAccessChecker;
