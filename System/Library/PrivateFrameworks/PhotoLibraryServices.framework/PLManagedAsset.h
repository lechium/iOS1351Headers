...
-(void)generateAndUpdateThumbnailsWithPreviewImage:(id)arg1 thumbnailImage:(id)arg2 fromImageSource:(CGImageSourceRef)arg3 imageData:(id)arg4 updateExistingLargePreview:(BOOL)arg5 forceSRGBConversion:(BOOL)arg6 saveCameraPreviewWellImage:(BOOL)arg7 ;
...
-(id)imageWithFormat:(unsigned short)arg1 outImageProperties:(const _CFDictionary*)arg2 ;
-(id)indexSheetImage;
